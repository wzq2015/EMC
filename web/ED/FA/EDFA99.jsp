...
<body class="bodyBackground" >
	<EF:EFForm formId="EDFA99" >
	 <EF:EFLayout>
  			<EF:EFRegion regionId="ef_region_inqu" title="查询条件" >
			    <EF:EFLayout  col="3"  >
				<EF:EFInput  bindId="inqu_status-0-form_ename" cname="画面英文名"   popup="img" style="text-transform : uppercase;" etc="validateType='string' maxLength='8' size='8'"/>
	        	...
	        	<EF:EFInput bindId="inqu_status-0-rec_create_time_start" cname="记录创建开始日期"   popup="date" etc=" maxLength='8' size='8'" />
			...
			<EF:EFColumn ename="form_cname" cname='页面名称 ' width="180"  />
			<EF:EFColumn ename="form_load_path" cname='页面路径 ' width="200"  />
