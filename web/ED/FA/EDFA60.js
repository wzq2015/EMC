...
{
    if (efvalidateForm(ef.get("EDFA60"))) {
      efgrid.submitInqu( "ef_grid_result", "ED","EDFA60","query");
    }
...
{
	efgrid.submitForm( "ef_grid_result", "ED","EDFA60","update",true );
}

button_f4_onclick = function () 
{
  	efgrid.submitForm( "ef_grid_result", "ED","EDFA60","delete", true );
}

button_f6_onclick = function () 
{
	efgrid.submitForm( "ef_grid_result", "ED","EDFA60","insert",true );
}
