...
<%
		...
		// Save or cancel the edited file
			...
			if (request.getParameter("Submit").equals("Save")) {
				...
				if (new_f.exists() && !new_f.canWrite()) request.setAttribute("error",
				  ...
				  OutputStreamWriter writer = new OutputStreamWriter( new FileOutputStream(new_f), "utf-8" );
					BufferedWriter outs = new BufferedWriter(writer);
		...
		// Delete Files
		else if ( request.getParameter(DELETE_FILES) != null ) {			
