...
FileProgress.prototype.setComplete = function (value,deleteUrl,downloadUrl,callBack) {
    var parentNode = this.fileProgressElement.parentNode;
    var grandNode = this.fileProgressElement.parentNode.parentNode;
    ...
    if(value!=null){
        ...
        grandNode.appendChild(callBack.call(this,settings));
    }
};
