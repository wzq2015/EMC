...
<head>
	...
	<script type="text/javascript" src="./EnergySavingTypeManagement.js"></script>
...
<body>
	<table id="datagrid" class="easyui-datagrid" title="节能量类型列表" data-options="singleSelect:true,pagination:true,toolbar:toolbar,fit:true,fitColumns:true">
        <thead>
            <tr>
                <th data-options="field:'f_energysavingTypeName',width:160,editor:'text'">节能量名称</th>
                <th data-options="field:'f_energysavingTypeDesc',width:160,editor:'text'">节能量描述</th>
                <th data-options="field:'f_energysavingTypeFormula',width:240">节能量计算公式</th>
                <th data-options="field:'f_energysavingTypeCalcstep',width:160">节能量计算过程</th>
                <th data-options="field:'f_energysavingTypeTargetvalue',width:120,editor:'text'">节能量基准值</th>
