...
<head>
	...
	<script type="text/javascript" src="./EL/EL0013.js"></script>
</head>
<body class="bodyBackground">
<form id="EL0013" method="POST" action="<%=actionUrl%>" >
...
<EF:EFGrid blockId="result" sumType="none" ajax="true"  >
	<EF:EFColumn ename="serviceName" cname="服务名" width="200"  />
	<EF:EFColumn ename="methodName" cname="方法名" width="200"  />
	<EF:EFColumn ename="cost" cname="耗时(毫秒)" width="100" />
	<EF:EFColumn ename="time" cname="时间" width="200"  />
</EF:EFGrid>
