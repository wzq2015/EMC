...
<script type="text/javascript" src="./EL/EL01.js"></script>
</head>

<body class = "bodyBackground">
<form id = "EL01" method = "POST" action = "<%=actionUrl%>" >
...
<EF:EFGrid blockId = "result" autoDraw = "yes"  ajax = "true" readonly="true" enable="false" style="navigationBar:false;operationBar:false;">
