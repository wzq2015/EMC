button_query_onclick = function () {
	if (efvalidateDiv("ef_region_inqu")) {
		efgrid.submitForm("ef_grid_result", "el", "EL0003", "query",true);
	}
}

button_dquery_onclick = function () {
	if (efvalidateDiv("ef_region_inqu")) {
		efgrid.submitForm("ef_grid_result", "el", "EL0003", "defaultQuery",true);
	}
}
...
button_chart_onclick = function () {
	...
	efgrid.submitForm("ef_grid_result", "el", "EL0003", "store",true);
