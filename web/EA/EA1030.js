...
{
	efgrid.submitInqu( "ef_grid_result", "ea","EA1030","query");
}
/*
button_insert_onclick = function () 
{
	efgrid.submitForm( "ef_grid_result", "ea","EA1030","insert",true );
}
button_delete_onclick = function () 
{
	if(confirm("\u786e\u5b9a\u5220\u9664\u4e48\uff1f")){
	  	efgrid.submitForm( "ef_grid_result", "ea","EA1030","delete", true );
	}
}
button_update_onclick = function () 
{
  	efgrid.submitForm( "ef_grid_result", "ea","EA1030","update", true );
}
button_handle_onclick = function () 
{
  	efgrid.submitForm( "ef_grid_result", "ea","EA1030","doHandleMessage", true );
}
