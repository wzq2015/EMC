...
<head>
	...
	<script type="text/javascript" src="./EA/EA1040.js"></script>
	
</head>
<body class="bodyBackground" style="overflow:scroll">

<form id="EA1040" method="POST" action="<%=actionUrl%>" >
	...
	<div style="overflow:hidden;width:100%">
		<table>
		  ...
		  <tr>
		    ...
		    <td nowrap width="25%">
		    <EF:EFInput blockId="inqu_status" ename="fd_message_send_time_begin" row="0" popup="date" etc="maxLength='19' size='19'"/>
		    </td>
		    <td nowrap width="15%">
			(发送)写入时间 结束：
		    </td>
		    <td nowrap width="25%">
		    <EF:EFInput blockId="inqu_status" ename="fd_message_send_time_end" row="0" popup="date" etc="maxLength='19' size='19'"/>
		    </td>
		  </tr>
		  <tr>
		    <td nowrap width="15%">
...
<EF:EFGrid blockId="result" autoDraw="false" readonly="false" >
	...
	<EF:EFColumn ename="fd_message_send_time" cname="<font color=red>*</font>（发送）写入时间" fix="no" editType="date" dateFormat="yyyy-mm-dd 00:00:00" nullable="false" readonly="true" width="150"/>
