...
{
	// to validate Form
	if (efvalidateForm(ef.get("EA1020"))) {
		efgrid.submitInqu( "ef_grid_result", "ea","EA1020","query");
	}
}
button_insert_onclick = function () 
{
	efgrid.submitForm( "ef_grid_result", "ea","EA1020","insert",true );
}
...
{
	if(confirm("\u786e\u5b9a\u5220\u9664\u4e48\uff1f")){
	  	efgrid.submitForm( "ef_grid_result", "ea","EA1020","delete", true );
	}
}
*/
...
{
  	efgrid.submitForm( "ef_grid_result", "ea","EA1020","update", true );
}
*/
...
{
  	efgrid.submitForm( "ef_grid_result", "ea","EA1020","doHandleMessage", true );
}
*/
/*
	...
	if(grid_id == "ef_grid_result" )
	{
		...
		if( grid )
		{
			...
			for(var i=0 ; i<count;i++){
				...
				grid.setCellValue(i,6,"重发功能已屏蔽",TYPE_DATA);
			}	
		}
	}
}
