...
<head>
	...
	<script type="text/javascript" src="./EA/EA1010.js"></script>
	
</head>
<body class="bodyBackground" style="overflow:scroll">

<form id="EA1010" method="POST" action="<%=actionUrl%>" >
		...
		<table>
		  ...
		  <tr>
		    ...
		    <EF:EFSelect blockId="inqu_status" ename="fd_message_state" row="0" >
			    ...
			    <EF:EFOption label="-1 执行失败" value="-1" />
...
<EF:EFGrid blockId="result" autoDraw="false" readonly="false" >
	...
	<EF:EFColumn ename="fd_message_receive_time" cname="（接受）写入时间" fix="no" editType="date" dateFormat="yyyy-mm-dd 23:59:59"  enable="false" readonly="true" width="150"/>
