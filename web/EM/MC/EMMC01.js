...
{
	efgrid.submitInqu( "ef_grid_p", "em","EMMC01","query");
}
...
button_authorization_onclick = function() 
{
  ...
  if ( sel == "" ){
    alert( getI18nMessages("label.ESPleaseSelectPagesOrButtonsToAuth","请选中需要授权的消息!") );
    return;
  }
...
efgrid_onCellDisplayReady = function( div_node_html, row_index, col_index, col_value_c, display_value, grid_id ){
  if( grid_id =="ef_grid_p" && col_index == 2){
    ...
    return "\<div align='center'><a href='javascript:void(0)' onclick='showAuthorization(\"TYP_MSG\", \""+ lb +"\" )'>&nbsp;"+getI18nMessages("label.EFShow","查看")+"&nbsp;</a></div>" ;			  
  }
}
...
showAuthorization = function (type, target){
  ...
  efgrid.submitInqu( "ef_grid_c", "em","EMMC01","initQuery");
}
