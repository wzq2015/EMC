...
<head>
	...
	<script type="text/javascript" src="./EC/TM/ECTM03.js"></script>
...
<EF:EFColumn ename="templateInsName" cname="模板实例名称" nullable="false" readonly="true"/>
</EF:EFGrid>
<jsp:include flush="false" page="../../EF/Form/iplat.ef.tail.jsp"></jsp:include>
</form>
<script type='text/javascript'>
document.getElementById('ins_info-0-objId').value=<%=objId%>;
