...
bean.setTableName(FrameworkInfo.getPlatSchema()+".T_RD_D_RULE_ARTIFACT");
bean.setTableKeys("RULE_ARTIFACT_ID="+"'"+request.getParameter("ruleArtifactId")+"'");
...
List list = dao.query("teqRdDRuleArtifact.ruleFlowQuery",map);
