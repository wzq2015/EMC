...
<head>
	...
	<script type="text/javascript" src="./EJ/AC/EJAC02.js"></script>
</head>

<body class="bodyBackground">

<form id="EJAC02" method="POST" action="<%=actionUrl%>" >
      ...
      <table cellpadding=0 cellspacing=0  width=100%>
        <tr>
          <td width=50% valign="top">
            <div id = "ef_region_inqu" title="<%=I18nMessages.getText("label.EJACParamConfig","参数配置") %>" style="overflow:scroll" > 
