...
button_query50_onclick = function () 
{
	...
	efgrid.submitInqu( "ef_grid_result", "ee","EEDM32","query", true );	
...
efgrid.prototype.paint = function() {
	...
	if ( !paintDivElement ) {
		alert( _getResource().getInternationalValue(EF_ERROR_MSG["GRID_DIV_NOT_FOUND"],"欲显示的efgrid对象必须置于有效<Div>元素中！" ) );
		return -1;
	}
