...
<body>
<form id="EEDM7201" method="POST" action="<%=actionUrl%>" >


<EF:EFChartRender blockId="efChartBlock" chartType="<%=chartType%>" width="700" height="500" id="qqq"  queryParam="<%=queryParam%>" ></EF:EFChartRender>
