...
<head>
	...
	<script type="text/javascript" src="./EF/Common/EFModelWindow.js"></script>
	<script type="text/javascript" src="./EE/DM/EEDM16.js"></script>
...
<form id="EEDM16" method="POST" action="<%=actionUrl%>" >
...
<div id = "ef_region_inqu" title="查询条件" efRegionShowClear=true>
	<div style="overflow:hidden;width:100%">
		<table style="width:100%">
		  <tr>
		    <td align="right" nowrap style="width:10%">数据一：</td>
		    <td nowrap >
...
<EF:EFRegion/>
<EF:EFGrid blockId="result" autoDraw="yes"  sumType="page" enable="false" lazyLoad="true"  ajax="false"  style="personalBar:true">

	<EF:EFColumn ename="double1" cname="数据一" sort="true" canPersonal="false" formatString="#,###,##0.000" />
