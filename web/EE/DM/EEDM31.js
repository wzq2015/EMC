...
button_query50_onclick = function () 
{
	...
	efgrid.submitInqu( "ef_grid_result", "ee","EEDM31","query", true );	
...
//	var end =  new Date();
//	var _totalTime = end.getTime()-callDate.getTime();
//	var _serviceTime = start.getTime()-callDate.getTime();
//	var _renderTime = end.getTime()-start.getTime();
//	ef.get( "_eiMsg" ).innerHTML += "<span style='color:red'><b>"+"总时间:"+ _totalTime +
...
efgrid.prototype.paint = function() {
	...
	//var end =  new Date();
	//ef.get( "_eiMsg" ).innerHTML += "<span style='color:red'>"+"渲染时间:<b>"+(end.getTime()-start.getTime())+"</b> 毫秒</span>"; 
	//alert();		
