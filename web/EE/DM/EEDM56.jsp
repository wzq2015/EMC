...
<head>
	...
	<script type="text/javascript" src="./EE/DM/EEDM56.js"></script>
	...
	<div style="overflow:hidden;width:100%">
		<table>
		  <tr>
		    ...
		    <td nowrap width="30%">
		      <EF:EFButton ename="test1" cname="测试1"/>
		      <EF:EFButton ename="test2" cname="测试2"/>
		    </td>
		  </tr>
		</table>
	</div>
...
<div id = "ef_region_result11" title="记录集" style="overflow:scroll">
	<div id = "ef_grid_result" title="页面信息" style="overflow: hidden;height:300px;">
	</div>
</div>

<EF:EFRegion buttonBarPosition="top"/>
<EF:EFGrid blockId="result" buttonBarId="result" autoDraw="yes" toolBarPosition="top" style="personalBar:true">
