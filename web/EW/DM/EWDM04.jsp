...
<head>
	...
	<title>销售合同审批页面</title>
	<link href="framework/css/style.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="./EF/iplat-ui-2.0.js"></script>
	<script type="text/javascript" src="./EW/DM/EWDM04.js"></script>
</head>
<body class="bodyBackground">

<form id="EWDM04" method="POST" action="<%=actionUrl%>">

<jsp:include flush="false" page="../../EF/Form/iplat.ef.head.jsp"></jsp:include>

<div id="ef_region_info" title="销售合同审批信息" style="overflow:scroll">
