...
<head>
	...
	<script type="text/javascript" src="./EW/DM/EWDM01.js"></script>
</head>
<body class="bodyBackground">

<form id="EWDM01" method="POST" action="<%=actionUrl%>">

<jsp:include flush="false" page="../../EF/Form/iplat.ef.head.jsp"></jsp:include>

<div id="ef_region_info" title="报销信息" style="overflow:scroll">
<div id = "ef_div_info" style="overflow:hidden;width:100%">
<input id="taskId" type=hidden name="taskId" type="text" value="${ei.attr.taskId}">
<table width="300">
	<tr>
		<td nowrap width="15%">报销人：</td>
		<td nowrap width="40%"><EF:EFInput blockId="info" ename="person"
			row="0" etc="readonly='readonly' disabled='disabled'" /></td>
	</tr>
	<tr>
		<td nowrap width="15%">金额(元)：</td>
		<td nowrap width="40%"><EF:EFInput blockId="info" ename="money"
			row="0"
			etc="validateType='positive_integer' minLength='1' onblur=efvalidateObj(this)" />
		<font color="red">*必填</font></td>
	</tr>
	<tr>
		<td nowrap width="15%">报销事由：</td>
		<td nowrap width="40%"><EF:EFInput blockId="info" ename="reason"
			row="0" type="textarea" /></td>
	</tr>
</table>
<hr>
<table width="300">
