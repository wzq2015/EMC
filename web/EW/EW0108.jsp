...
<head>
    ...
    <script type="text/javascript" src="./EW/WorkflowDesigner/js/attributeSetting/ForkActivitySetting.js"></script>
    <script type="text/javascript" src="./EW/EW0108.js"></script>		
