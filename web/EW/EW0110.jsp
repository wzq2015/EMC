...
<head>
    ...
    <script type="text/javascript" src="./EW/WorkflowDesigner/js/attributeSetting/EndActivitySetting.js"></script>		
	<script type="text/javascript" src="./EW/EW0110.js"></script>
...
<form id="EW0110" method="POST" action="<%=actionUrl%>" >
