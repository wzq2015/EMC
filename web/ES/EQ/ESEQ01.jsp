...
<head>	
  ...
  <script type="text/javascript" src="./ES/EQ/ESEQ01.js"></script>
</head>
...
<jsp:include flush="false" page="../../EF/Form/iplat.ef.head.jsp"></jsp:include>
  ...
  <div id = "ef_region_inqu" title="<%=I18nMessages.getText("label.EFQueryConditions","查询条件") %>" efRegionShowClear=true>
   <div>	
		<table>		  
		  <tr>
		    <td  nowrap width="30%"><%=I18nMessages.getText("E_Col.userId","用户标识") %></td>
		    <td  width="45%">
			  <EF:EFInput blockId="inqu_status" ename="userId" row="0" />					
		    </td>
		    <td  nowrap width="30%"><%=I18nMessages.getText("E_Col.userCname","用户中文名") %></td>
		    <td  width="45%">
			  <EF:EFInput blockId="inqu_status" ename="userCname" row="0" />					
		    </td>	
		  </tr>
		  <tr>
		  	<td  nowrap width="30%"><%=I18nMessages.getText("E_Col.orgCode","组织机构代码") %></td>
		    <td  width="45%">
			  <EF:EFInput blockId="inqu_status" ename="orgCode" row="0" />					
		    </td>		
		    <td  nowrap width="30%"><%=I18nMessages.getText("E_Col.idcardNo","身份证号码") %></td>
		    <td  width="45%">
			  <EF:EFInput blockId="inqu_status" ename="idcardNo" row="0" />					
		    </td>  
		  </tr>
		</table>
	</div>
