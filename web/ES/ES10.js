...
{
    if (efvalidateForm(ef.get("ES10"))) {
      efgrid.submitInqu( "ef_grid_result", "es","ES10","query");
    }
...
{
	efgrid.submitForm( "ef_grid_result", "es","ES10","update",true );
}

button_f4_onclick = function () 
{
  	efgrid.submitForm( "ef_grid_result", "es","ES10","delete", true );
}

button_f6_onclick = function () 
{
	efgrid.submitForm( "ef_grid_result", "es","ES10","insert",true );
}
