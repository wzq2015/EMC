...
<html>
 <head>	
  ...
  <script type="text/javascript" src="./ES/UT/ESUT21.js"></script>
 </head>
 ...
 <body class="bodyBackground">
  <form method="POST" action="<%=listUrl%>">
    ...
    <table id="mainFrameTable" width="100%"  height="87%">
	  <tr height=100%>
		  <td id="leftTree" vAlign="top" >
                <div id="leftTreeDiv" class="ef-tree-div" style='overflow:none;width:200px;height:100%;'>
		      ...
		      <tr>
               <td>		       
		        <div id = "ef_region_page" title="<%=I18nMessages.getText("label.ESPageInfo","页面信息") %>" efRegionShowClear=false>
                 ...
                 <div id = "ef_grid_p" title="<%=I18nMessages.getText("label.ESPageInfo","页面信息") %>
    ...
    <EF:EFGrid blockId="result" autoDraw="no" enable="true" readonly="false" style="operationBar:false" ajax="true" paintId="ef_grid_p" serviceName = "ESLV11">
	  ...
	  <EF:EFColumn ename="desc" cname='<%=I18nMessages.getText("label.ESPageDesc","页面描述") %>' width="400" enable="false"/>
    </EF:EFGrid>
