...
<script type="text/javascript">    
    ...
    function onFinish(){
      ...
      var _encoding = $(':select#encoding').val();
      var _erropt = $(':select#erropt').val();
      var _expmax = $(':input#expmax').val();
      document.forms[0].action = "upload.jsp?im=" + impT + "&encoding=" + _encoding + "&erropt=" + _erropt + "&expmax=" + _expmax;
...
<body onload="OnLoad()" style="overflow: hidden">
  ...
  <form method="POST" action="upload.jsp" target="iframeUpload" enctype="multipart/form-data">
   <b>* 上传文件的编码必须和选择的编码对应, 否则会有乱码问题</b>
   <br/>
   <b>* 请根据服务器的配置, 酌情设置打印异常的个数</b>
   <p/>
    <table width="80%">      
      	<tr>
      		<td nowrap>上传文件: </td>
