...
<head>
	...
	<script type="text/javascript" src="./ES/DA/ESDA02.js"></script>
	
</head>
<body class="bodyBackground">

<form id="ESDA02" method="POST" action="<%=actionUrl%>" >
...
<div id = "ef_region_inqu" title="<%=I18nMessages.getText("label.EFQueryConditions","查询条件") %>" efRegionShowClear=true>
	<div style="overflow:hidden;width:100%">
		<table>
		  <tr>
		    <td nowrap width="15%">
		     <%=I18nMessages.getText("label.ESSqlId","SQL标识") %>  
		    </td>
		    <td nowrap width="20%">
		    <EF:EFInput blockId="inqu_status" ename="sqlId" row="0"  etc="validateType='string' maxLength='20' size='20'"/>
		    </td>
		    <td nowrap width="15%">
		     <%=I18nMessages.getText("label.ESSqlText","SQL语句的正文") %>  
		    </td>
		    <td nowrap width="20%">
		    <EF:EFInput blockId="inqu_status" ename="sqlText" row="0"/>
		    </td>
		    <td nowrap width="15%">
...
<EF:EFGrid blockId="result" autoDraw="yes" readonly="false" >	
	<EF:EFColumn ename="sqlId" width="100" fix="yes" />
	<EF:EFColumn ename="sqlText" width="500" editType="textarea" />
