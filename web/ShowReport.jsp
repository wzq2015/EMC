...
<head>
    ...
    <script type="text/javascript" src="ShowReport.js"></script>
...
<body>
	<div class="easyui-layout" fit="true">
		<div data-options="region:'north',collapsible:false,split:true" title="报表查询" style="height:90px;">
			<div style="padding:7px">
				...
				<div style="padding:8px">
					...
					<a style="margin-left:10px" href="#" id='downloadXlsButton' class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="doDownloadXls()">保存</a>
		...
		<div data-options="region:'center',split:true" title="报表展示" style="margin:0px">
