...
(function () {
    ...
    var tmp = window.location.pathname;
		...
		URL= window.UEDITOR_HOME_URL|| (tmp.substr(0,tmp.lastIndexOf("\/")+1).concat("EU/ueditor&#47;"));
		URL1= window.UEDITOR_HOME_URL|| tmp.substr(0,tmp.lastIndexOf("\/")+1);
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:URL1                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,imageManagerPath:URL1                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'attachment', 'webapp','|','map', 'gmap', 'insertframe','highlightcode','|',
        ...
        ,labelMap:{
            ...
            'lineheight':'行间距', 'customstyle':'自定义标题','autotypeset': '自动排版','webapp':'flash'
        }
