...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        $G("preview").innerHTML = ' <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" '+
            'codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" '+
            'height="' + 280 +'" width="' + 420 + '"> '+
            '<param name="movie" '+
			'value="http://test.dnschek.net/webpath/video/vcastr22.swf?vcastr_file=' + url + '"> '+
			'<param name="quality" value="high"> '+
			'<param name="allowFullScreen" value="true" /> '+
			'<embed '+
			'src="http://test.dnschek.net/webpath/video/vcastr22.swf?vcastr_file=' + url + '" '+
			'quality="high" '+
			'pluginspage="http://www.macromedia.com/go/getflashplayer" '+
			'type="application/x-shockwave-flash" width="360" height="280"> '+
			'</embed> '+
			'</object>'; 
        /*
