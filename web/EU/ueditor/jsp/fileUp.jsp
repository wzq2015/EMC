...
uploadPath=uploadPath+"attach/";           //绝对路径
uploadRelaPath=uploadRelaPath+"attach/";   //相对路径
...
if(ServletFileUpload.isMultipartContent(request)){
	    ...
	    while(fii.hasNext()){
	        FileItemStream fis = fii.next();
	            ...
	            if(!fis.isFormField() && fis.getName().length()>0){
	                ...
	                Pattern reg=Pattern.compile("[.]rar|zip|doc|docx|pdf|mp3|xls|chm|ppt|pptx|avi|rmvb|wmv|wmv|flv|swf|rm|exe|psd|txt$");
        		    ...
        		    map.put("fileDes"," ");
        		    map.put("typeId","0000000000000104");
	...
	response.getWriter().print("{'url':'"+filePath+"','fileType':'"+contentType+"','state':'"+state+"'}");
}
%>
