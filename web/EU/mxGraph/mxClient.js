var mxClient = {
	...
	NO_FO : 0 <= navigator.userAgent.indexOf("Firefox/1.")
			|| 0 <= navigator.userAgent.indexOf("Iceweasel/1.")
			|| 0 <= navigator.userAgent.indexOf("Firefox/2.")
			|| 0 <= navigator.userAgent.indexOf("Iceweasel/2.")
			|| 0 <= navigator.userAgent.indexOf("SeaMonkey/1.")
			|| 0 <= navigator.userAgent.indexOf("Iceape/1.")
			|| 0 <= navigator.userAgent.indexOf("Camino/1.")
			|| 0 <= navigator.userAgent.indexOf("Epiphany/2.")
			|| 0 <= navigator.userAgent.indexOf("Opera/")
			|| 0 <= navigator.userAgent.indexOf("MSIE")
			|| 0 <= navigator.userAgent.indexOf("Mozilla/2."),
	...
	IS_TOUCH : 0 < navigator.userAgent.toUpperCase().indexOf("IPAD")
			|| 0 < navigator.userAgent.toUpperCase().indexOf("IPOD")
			|| 0 < navigator.userAgent.toUpperCase().indexOf("IPHONE")
			|| 0 < navigator.userAgent.toUpperCase().indexOf("ANDROID"),
...
mxClient.language = "undefined" != typeof mxLanguage
		? mxLanguage
...
if (mxClient.IS_IE) {
	if (9 <= document.documentMode)
		mxClient.IS_VML = !1, mxClient.IS_SVG = !0;
	else {
		8 == document.documentMode
				? (document.namespaces.add("v",
						"urn:schemas-microsoft-com:vml", "#default#VML"), document.namespaces
						.add("o", "urn:schemas-microsoft-com:office:office",
								"#default#VML"))
				: (document.namespaces
						.add("v", "urn:schemas-microsoft-com:vml"), document.namespaces
						.add("o", "urn:schemas-microsoft-com:office:office"));
	...
	init : function() {
		if (mxLog.window == null && document.body != null) {
			...
			mxLog.textarea.style.width = mxClient.IS_NS
					&& document.compatMode != "BackCompat" ? "99%" : "100%";
			...
			mxLog.window = new mxWindow(a, b, Math.max(0,
							document.body.clientWidth - 320), Math.max(0, c
									- 210), 300, 160);
...
var mxResources = {
	...
	isLanguageSupported : function(a) {
		return mxClient.languages != null ? mxUtils.indexOf(mxClient.languages,
				a) >= 0 : true
	},
...
mxRectangle.prototype.add = function(a) {
	if (a != null) {
		var b = Math.min(this.x, a.x), c = Math.min(this.y, a.y), d = Math.max(
				this.x + this.width, a.x + a.width), a = Math.max(this.y
						+ this.height, a.y + a.height);
		this.x = b;
		this.y = c;
		this.width = d - b;
		this.height = a - c
...
mxRectangle.prototype.equals = function(a) {
	return a.x == this.x && a.y == this.y && a.width == this.width
...
var mxEffects = {
		...
		var d = 0, e = function() {
			for (var g = false, h = 0; h < b.length; h++) {
				...
				if (k instanceof mxGeometryChange
					...
					if (i != null) {
						g = true;
						if (k.constructor != mxGeometryChange
								|| a.model.isEdge(k.cell))
							mxUtils.setOpacity(i.shape.node, 100 * d / 10);
						else {
							var l = a.getView().scale, m = (k.geometry.x - k.previous.x)
									* l, n = (k.geometry.y - k.previous.y) * l, o = (k.geometry.width - k.previous.width)
									* l, l = (k.geometry.height - k.previous.height)
									* l;
							if (d == 0) {
								i.x = i.x - m;
								i.y = i.y - n;
	...
	removeCursors : function(a) {
		...
		a = a.childNodes;
		if (a != null)
			for (var b = a.length, c = 0; c < b; c = c + 1)
	...
	findNodeByAttribute : function() {
		return document.documentMode >= 9 ? function(a, b, c) {
			...
			if (a.nodeType == mxConstants.NODETYPE_ELEMENT
				...
				for (a = a.firstChild; a != null && d == null;) {
			...
			return a.ownerDocument.evaluate("//*[@" + b + "='" + c + "']",
					a.ownerDocument, null, XPathResult.ANY_TYPE, null)
					.iterateNext()
		}
	}(),
	...
	remove : function(a, b) {
		var c = null;
		if (typeof b == "object")
			for (var d = mxUtils.indexOf(b, a); d >= 0;) {
				b.splice(d, 1);
				c = a;
	...
	getPrettyXml : function(a, b, c) {
		...
		if (a != null) {
			b = b || "  ";
			c = c || "";
			if (a.nodeType == mxConstants.NODETYPE_TEXT)
				d.push(a.nodeValue);
			else {
				d.push(c + "<" + a.nodeName);
				var e = a.attributes;
	...
	removeWhitespace : function(a, b) {
		for (var c = b ? a.previousSibling : a.nextSibling; c != null
	...
	getXml : function(a, b) {
		...
		if (a != null) {
			c = a.xml;
			c = c == null ? a.innerHTML ? a.innerHTML : (new XMLSerializer)
					.serializeToString(a) : c.replace(/\r\n\t[\t]*/g, "")
					.replace(/>\r\n/g, ">").replace(/\r\n/g, "\n")
		}
		return c = c.replace(/\n/g, b || "&#xa;")
	},
	...
	br : function(a, b) {
		for (var b = b || 1, c = null, d = 0; d < b; d++)
			if (a != null) {
		...
		if (a != null && typeof a.constructor == "function") {
			...
			for (e in a)
				if (e != mxObjectIdentity.FIELD_NAME
						&& (b == null || mxUtils.indexOf(b, e) < 0))
					d[e] = !c && typeof a[e] == "object"
							? mxUtils.clone(a[e])
							: a[e]
		}
		return d
	...
	equalPoints : function(a, b) {
		if (a == null && b != null || a != null && b == null || a != null
				&& b != null && a.length != b.length)
			return false;
		if (a != null && b != null)
			for (var c = 0; c < a.length; c++)
				if (a[c] == b[c] || a[c] != null && !a[c].equals(b[c]))
					return false;
		return true
	},
	...
	arcToCurves : function(a, b, c, d, e, f, g, h, k) {
		...
		if (c === 0 || d === 0)
			return n;
		var c = Math.abs(c), d = Math.abs(d), i = -h / 2, l = -k / 2, m = Math
				.cos(e * Math.PI / 180), n = Math.sin(e * Math.PI / 180), e = m
				* i + n * l, i = -1 * n * i + m * l, l = e * e, o = i * i, p = c
				* c, q = d * d, t = l / p + o / q;
		if (t > 1) {
			c = Math.sqrt(t) * c;
			d = Math.sqrt(t) * d;
		...
		f = p >= 0 ? p : 2 * Math.PI + p;
		p = Math.atan2((-i - o) / d, (-e - l) / c)
				- Math.atan2((i - o) / d, (e - l) / c);
		e = p >= 0 ? p : 2 * Math.PI + p;
		g == 0 && e > 0 ? e = e - 2 * Math.PI : g != 0 && e < 0
				&& (e = e + 2 * Math.PI);
		for (var g = e * 2 / Math.PI, g = Math.ceil(g < 0 ? -1 * g : g), e = e
				/ g, i = 8 / 3 * Math.sin(e / 4) * Math.sin(e / 4)
				/ Math.sin(e / 2), l = m * c, m = m * d, c = n * c, d = n * d, u = Math
				.cos(f), v = Math.sin(f), o = -i * (l * v + d * u), p = -i
				* (c * v - m * u), t = q = 0, n = [], w = 0; w < g; ++w) {
			var f = f + e, u = Math.cos(f), v = Math.sin(f), q = l * u - d * v
					+ h, t = c * u + m * v + k, r = -i * (l * v + d * u), u = -i
					* (c * v - m * u), v = w * 6;
			n[v] = Number(o + a);
			n[v + 1] = Number(p + b);
			n[v + 2] = Number(q - r + a);
	...
	getPortConstraints : function(a, b, c, d) {
		...
		d.indexOf(mxConstants.DIRECTION_NORTH) >= 0
				&& (a = a | mxConstants.DIRECTION_MASK_NORTH);
		d.indexOf(mxConstants.DIRECTION_WEST) >= 0
				&& (a = a | mxConstants.DIRECTION_MASK_WEST);
		d.indexOf(mxConstants.DIRECTION_SOUTH) >= 0
				&& (a = a | mxConstants.DIRECTION_MASK_SOUTH);
		d.indexOf(mxConstants.DIRECTION_EAST) >= 0
				&& (a = a | mxConstants.DIRECTION_MASK_EAST);
		return a
	},
	...
	intersects : function(a, b) {
		...
		if (e <= 0 || f <= 0 || c <= 0 || d <= 0)
			return false;
		var g = a.x, h = a.y, k = b.x, i = b.y, e = e + k, f = f + i, c = c + g, d = d
				+ h;
		return (e < k || e > g) && (f < i || f > h) && (c < g || c > k)
				&& (d < h || d > i)
	},
	intersectsHotspot : function(a, b, c, d, e, f) {
		...
		f = f != null ? f : 0;
		if (d > 0) {
			var g = a.getCenterX(), h = a.getCenterY(), k = a.width, i = a.height, l = mxUtils
					.getValue(a.style, mxConstants.STYLE_STARTSIZE);
			if (l > 0)
				if (mxUtils.getValue(a.style, mxConstants.STYLE_HORIZONTAL,
						true)) {
					h = a.y + l / 2;
					i = l
				} else {
	...
	getScrollOrigin : function(a) {
		for (var b = document.body, c = document.documentElement, d = new mxPoint(
				b.scrollLeft || c.scrollLeft, b.scrollTop || c.scrollTop); a != null
				&& a != b && a != c;) {
	...
	intersection : function(a, b, c, d, e, f, g, h) {
		var k = (h - f) * (c - a) - (g - e) * (d - b), g = ((g - e) * (b - f) - (h - f)
				* (a - e))
				/ k, e = ((c - a) * (b - f) - (d - b) * (a - e)) / k;
		return g >= 0 && g <= 1 && e >= 0 && e <= 1 ? new mxPoint(a + g
						* (c - a), b + g * (d - b)) : null
	},
	...
	setOpacity : function(a, b) {
		mxUtils.isVml(a)
				? a.style.filter = b >= 100 ? null : "alpha(opacity=" + b / 5
						+ ")"
				: mxClient.IS_IE
						&& (typeof document.documentMode === "undefined" || document.documentMode < 9)
						? a.style.filter = b >= 100 ? null : "alpha(opacity="
								+ b + ")"
	...
	addStylename : function(a, b) {
		if (mxUtils.indexOfStylename(a, b) < 0) {
			a == null ? a = "" : a.length > 0 && a.charAt(a.length - 1) != ";"
					&& (a = a + ";");
			a = a + b
		}
		return a
	...
	setStyleFlag : function(a, b, c, d) {
		if (a == null || a.length == 0)
			...
			if (e < 0) {
				...
				var f = a.indexOf(";", e), g = "", g = f < 0 ? a.substring(e
						+ b.length + 1) : a.substring(e + b.length + 1, f), g = d == null
						? parseInt(g) ^ c
						: d ? parseInt(g) | c : parseInt(g) & ~c, a = a
						.substring(0, e)
						+ b + "=" + g + (f >= 0 ? a.substring(f) : "")
		}
		return a
	},
	...
	getScaleForPageCount : function(a, b, c, d) {
		if (a < 1)
			return 1;
		var c = c != null ? c : mxConstants.PAGE_FORMAT_A4_PORTRAIT, d = d != null
				? d
				: 0, e = c.width - d * 2, c = c.height - d * 2, d = b
				.getGraphBounds().clone(), b = b.getView().getScale();
		d.width = d.width / b;
		d.height = d.height / b;
		var b = d.width, c = b / d.height / (e / c), d = Math.sqrt(a), f = Math
				.sqrt(c), c = d * f, d = d / f;
		if (c < 1 && d > a)
			var g = d / a, d = a, c = c / g;
		if (d < 1 && c > a) {
	...
	show : function(a, b, c, d) {
		...
		if (mxClient.IS_IE) {
			for (var e = "<html><head>", f = document
					.getElementsByTagName("base"), g = 0; g < f.length; g++)
				e = e + f[g].outerHTML;
			e = e + "<style>";
			...
			for (g = 0; g < f.length; g++)
				b.writeln(mxUtils.getOuterHtml(f[g]));
			...
			b.close();
			b.body == null
					&& b.documentElement.appendChild(b.createElement("body"));
	...
	error : function(a, b, c, d) {
		...
		e.appendChild(document.createTextNode("\u00a0"));
		mxUtils.write(e, a);
		var a = document.body.clientWidth, d = document.body.clientHeight
				|| document.documentElement.clientHeight, g = new mxWindow(
				mxResources.get(mxUtils.errorResource) || mxUtils.errorResource,
				e, (a - b) / 2, d / 4, b, null, false, true);
		if (c) {
			mxUtils.br(e);
			b = document.createElement("p");
			c = document.createElement("button");
			mxClient.IS_IE ? c.style.cssText = "float:right" : c.setAttribute(
					"style", "float:right");
			mxEvent.addListener(c, "click", function() {
						g.destroy()
					});
			mxUtils.write(c, mxResources.get(mxUtils.closeResource)
	...
	makeDraggable : function(a, b, c, d, e, f, g, h, k, i) {
		...
		a.dragOffset = new mxPoint(e != null ? e : 0, f != null
						? f
						: mxConstants.TOOLTIP_VERTICAL_OFFSET);
		a.autoscroll = g;
		a.setGuidesEnabled(false);
		if (k != null)
			a.highlightDropTargets = k;
		if (i != null)
			a.getDropTarget = i;
...
function mxEventObject(a) {
	this.name = a;
	this.properties = [];
	for (var b = 1; b < arguments.length; b = b + 2)
		arguments[b + 1] != null
...
mxMouseEvent.prototype.isSource = function(a) {
	if (a != null)
		for (var b = this.getSource(); b != null;) {
			if (b == a.node)
				return true;
			b = b.parentNode
		}
...
var mxEvent = {
	...
	removeListener : function() {
		var a = function(a, c, d) {
			if (a.mxListenerList != null) {
				for (var c = a.mxListenerList.length, e = 0; e < c; e++)
					if (a.mxListenerList[e].f == d) {
						a.mxListenerList.splice(e, 1);
						break
					}
				if (a.mxListenerList.length == 0)
					a.mxListenerList = null
			}
		};
	...
	addMouseWheelListener : function(a) {
		if (a != null) {
			var b = function(b) {
				if (b == null)
					b = window.event;
				var d = 0, d = mxClient.IS_NS && !mxClient.IS_SF
						&& !mxClient.IS_GC ? -b.detail / 2 : b.wheelDelta / 120;
				d != 0 && a(b, d > 0)
			};
	...
	getMainEvent : function(a) {
		(a.type == "touchstart" || a.type == "touchmove") && a.touches != null
				&& a.touches[0] != null
				? a = a.touches[0]
				: a.type == "touchend"
						&& (a.changedTouches != null && a.changedTouches[0] != null)
...
mxXmlRequest.prototype.simulate = function(a, b) {
	...
	d.style.visibility = "hidden";
	for (var e = this.params.indexOf("&") > 0
			? this.params.split("&")
...
function mxWindow(a, b, c, d, e, f, g, h, k, i) {
	if (b != null) {
		...
		k != null && k.parentNode != null ? k.parentNode.replaceChild(this.div,
				k) : document.body.appendChild(this.div)
	}
}
...
mxWindow.prototype.activate = function() {
	if (mxWindow.activeWindow != this) {
		var a = mxUtils.getCurrentStyle(this.getElement()), a = a != null
				? a.zIndex
				: 3;
...
mxWindow.prototype.setResizable = function(a) {
	if (a)
		if (this.resize == null) {
			...
			var b = mxClient.IS_TOUCH ? "touchmove" : "mousemove", c = mxClient.IS_TOUCH
					? "touchend"
					: "mouseup";
			mxEvent.addListener(this.resize, mxClient.IS_TOUCH
							? "touchstart"
							: "mousedown", mxUtils.bind(this, function(a) {
						this.activate();
						var e = mxEvent.getClientX(a), f = mxEvent
								.getClientY(a), g = this.div.offsetWidth, h = this.div.offsetHeight, k = mxUtils
								.bind(this, function(a) {
									var b = mxEvent.getClientX(a) - e, c = mxEvent
											.getClientY(a)
											- f;
									this.setSize(g + b, h + c);
									this.fireEvent(new mxEventObject(
											mxEvent.RESIZE, "event", a));
									mxEvent.consume(a)
								}), i = mxUtils.bind(this, function(a) {
									mxEvent.removeListener(document, b, k);
									mxEvent.removeListener(document, c, i);
									this.fireEvent(new mxEventObject(
											mxEvent.RESIZE_END, "event", a));
									mxEvent.consume(a)
								});
...
mxWindow.prototype.installMinimizeHandler = function() {
	...
	var a = false, b = null, c = null, d = mxUtils.bind(this, function(d) {
				...
				if (a) {
					...
					if (f.height > 0) {
						if (!mxClient.IS_IE)
							this.div.style.height = f.height + "px";
						this.table.style.height = f.height + "px"
					}
					if (f.width > 0) {
						if (!mxClient.IS_IE)
							this.div.style.width = f.width + "px";
	...
	mxEvent.addListener(this.minimize, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", d)
};
...
mxWindow.prototype.installMaximizeHandler = function() {
	...
	var a = false, b = null, c = null, d = null, e = null, f = mxUtils.bind(
			this, function(f) {
				this.activate();
				if (this.maximize.style.display != "none") {
					if (a) {
						...
						if (!mxClient.IS_IE) {
							...
							if (h.overflow == "auto" || this.resize != null)
								this.contentWrapper.style.height = this.div.offsetHeight
										- this.title.offsetHeight - 2 + "px"
						}
						...
						if (!mxClient.IS_IE) {
							this.div.style.height = document.body.clientHeight
									- 2 + "px";
						...
						this.table.style.width = document.body.clientWidth - 2
								+ "px";
						this.table.style.height = document.body.clientHeight
								- 2 + "px";
						if (this.resize != null)
							this.resize.style.visibility = "hidden";
						if (!mxClient.IS_IE) {
	...
	mxEvent.addListener(this.maximize, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", f);
...
mxWindow.prototype.installMoveHandler = function() {
	...
	var a = mxClient.IS_TOUCH ? "touchmove" : "mousemove", b = mxClient.IS_TOUCH
			? "touchend"
			: "mouseup";
	mxEvent.addListener(this.title, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", mxUtils.bind(this, function(c) {
				var d = mxEvent.getClientX(c), e = mxEvent.getClientY(c), f = this
						.getX(), g = this.getY(), h = mxUtils.bind(this,
						function(a) {
							var b = mxEvent.getClientX(a) - d, c = mxEvent
									.getClientY(a)
									- e;
							...
							mxEvent.removeListener(document, b, k);
							this.fireEvent(new mxEventObject(mxEvent.MOVE_END,
									"event", c));
							mxEvent.consume(c)
						});
				...
				mxEvent.addListener(document, b, k);
				this
						.fireEvent(new mxEventObject(mxEvent.MOVE_START,
								"event", c));
				mxEvent.consume(c)
			}))
};
...
mxWindow.prototype.installCloseHandler = function() {
	...
	mxEvent.addListener(this.closeImg, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", mxUtils.bind(this, function(a) {
...
mxWindow.prototype.setVisible = function(a) {
	this.div != null && this.isVisible() != a
...
mxDivResizer.prototype.resize = function() {
	...
	if (this.resizeWidth && !isNaN(c) && !isNaN(d) && c >= 0 && d >= 0
			&& a - d - c > 0)
		this.div.style.width = a - d - c + "px";
	if (this.resizeHeight && !isNaN(e) && !isNaN(f) && e >= 0 && f >= 0
			&& b - e - f > 0)
...
function mxDragSource(a, b) {
	...
	this.dropHandler = b;
	mxEvent.addListener(a, mxClient.IS_TOUCH ? "touchstart" : "mousedown",
			mxUtils.bind(this, this.mouseDown))
}
...
mxDragSource.prototype.stopDrag = function() {
	if (this.dragElement != null) {
		this.dragElement.parentNode != null
	...
	if (this.previewElement != null) {
		this.previewElement.parentNode != null
				&& this.previewElement.parentNode
						.removeChild(this.previewElement);
...
mxDragSource.prototype.dragOver = function(a, b) {
	...
	a.autoScroll && (this.autoscroll == null || this.autoscroll)
	...
	if (this.currentHighlight != null && a.isDropEnabled()) {
		...
		this.currentHighlight.highlight(a.getView()
				.getState(this.currentDropTarget))
	}
	if (this.previewElement != null) {
		...
		if (this.currentGuide != null && this.currentGuide.isEnabledForEvent(b))
			var f = parseInt(this.previewElement.style.width), g = parseInt(this.previewElement.style.height), f = new mxRectangle(
					...
					.move(f, c, d), f = false, e = c.x, c = c.y;
		else if (d)
...
mxToolbar.prototype.addItem = function(a, b, c, d, e, f) {
	var g = document.createElement(b != null ? "img" : "button"), h = e
			|| (f != null ? "mxToolbarMode" : "mxToolbarItem");
	g.className = h;
	g.setAttribute("src", b);
	a != null && (b != null ? g.setAttribute("title", a) : mxUtils.write(g, a));
	this.container.appendChild(g);
	c != null
			&& mxEvent.addListener(g, mxClient.IS_TOUCH ? "touchend" : "click",
					c);
	a = mxClient.IS_TOUCH ? "touchend" : "mouseup";
	mxEvent.addListener(g, mxClient.IS_TOUCH ? "touchstart" : "mousedown",
			mxUtils.bind(this, function(a) {
						...
						if (f != null) {
							...
							if (b != g) {
								...
								b = new mxPoint(g.offsetLeft, g.offsetTop
												+ g.offsetHeight);
...
mxToolbar.prototype.addSwitchMode = function(a, b, c, d, e) {
	...
	mxEvent.addListener(f, "click", mxUtils.bind(this, function() {
				...
				if (a != null) {
					...
					f.className = f.initialClassName + "Selected";
...
mxToolbar.prototype.addMode = function(a, b, c, d, e, f) {
	var f = f != null ? f : true, g = document.createElement(b != null
			? "img"
			: "button");
...
function mxSession(a, b, c, d) {
	...
	a.addListener(mxEvent.NOTIFY, mxUtils.bind(this, function(a, b) {
						...
						(c != null && this.debug || this.connected
								&& !this.suspended)
								&& this.notify("<edit>"
...
mxSession.prototype.start = function() {
	if (this.debug) {
		...
		this.connected || this.get(this.urlInit, mxUtils.bind(this, function() {
							this.connected = true;
							this.fireEvent(new mxEventObject(mxEvent.CONNECT));
							this.poll()
						}))
	...
	if (a != null && a.length > 0) {
		if (this.urlNotify != null)
			if (this.debug) {
				mxLog.show();
				mxLog
						.debug("mxSession.notify: " + this.urlNotify + " xml="
								+ a)
			} else {
...
mxSession.prototype.encodeChanges = function(a, b) {
	for (var c = "", d = b ? -1 : 1, e = b ? a.length - 1 : 0; e >= 0
			&& e < a.length; e = e + d)
...
mxSession.prototype.receive = function(a) {
	if (a != null && a.nodeType == mxConstants.NODETYPE_ELEMENT) {
		...
		for (b = a.firstChild; b != null;) {
			...
			c == "state" ? this.processState(b) : c == "delta"
					&& this.processDelta(b);
			b = b.nextSibling
		}
...
mxSession.prototype.decodeChange = function(a) {
	var b = null;
	if (a.nodeType == mxConstants.NODETYPE_ELEMENT) {
		b = a.nodeName == "mxRootChange" ? (new mxCodec(a.ownerDocument))
				.decode(a) : this.codec.decode(a);
		if (b != null) {
			b.model = this.model;
			b.execute();
			a.nodeName == "mxChildChange" && b.parent == null
					&& this.cellRemoved(b.child)
		}
	}
	return b
};
...
var mxUrlConverter = function() {
	...
	return {
		...
		convert : function(d) {
			if (a && d.indexOf("http://") != 0 && d.indexOf("https://") != 0
...
function mxPanningManager(a) {
	...
	this.panTo = function(c, d, e, f) {
		...
		this.dx = this.dx < 0 && Math.abs(this.dx) < this.border ? this.border
				+ this.dx : this.handleMouseOut ? Math.max(this.dx, 0) : 0;
		if (this.dx == 0) {
			this.dx = c - g.scrollLeft;
			this.dx = this.dx > 0 && this.dx < this.border ? this.dx
					- this.border : this.handleMouseOut
					? Math.min(0, this.dx)
					: 0
		}
		this.dy = d + f - g.scrollTop - g.clientHeight;
		this.dy = this.dy < 0 && Math.abs(this.dy) < this.border ? this.border
				+ this.dy : this.handleMouseOut ? Math.max(this.dy, 0) : 0;
		if (this.dy == 0) {
			this.dy = d - g.scrollTop;
			this.dy = this.dy > 0 && this.dy < this.border ? this.dy
					- this.border : this.handleMouseOut
					? Math.min(0, this.dy)
					: 0
		}
	...
	this.stop = function() {
		if (this.active) {
			...
			if (this.scrollbars) {
				...
				if (b != 0 || d != 0) {
					a.panGraph(0, 0);
					a.view.setTranslate(this.t0x + b / a.view.scale, this.t0y
									+ d / a.view.scale)
				}
			}
		}
...
mxPath.prototype.moveTo = function(a, b) {
	...
	b = b * this.scale;
	this.isVml()
			? this.path.push("m ", Math.round(a), " ", Math.round(b), " ")
...
mxPath.prototype.lineTo = function(a, b) {
	...
	b = b * this.scale;
	this.isVml()
			? this.path.push("l ", Math.round(a), " ", Math.round(b), " ")
...
mxPath.prototype.quadTo = function(a, b, c, d) {
	...
	c = c * this.scale;
	d = d * this.scale;
	this.isVml() ? this.path.push("c ", Math.round(a), " ", Math.round(b), " ",
			Math.round(c), " ", Math.round(d), " ", Math.round(c), " ", Math
					.round(d), " ") : this.path.push("Q ", a, " ", b, " ", c,
			" ", d, " ")
};
mxPath.prototype.curveTo = function(a, b, c, d, e, f) {
	...
	f = f * this.scale;
	this.isVml() ? this.path.push("c ", Math.round(a), " ", Math.round(b), " ",
			Math.round(c), " ", Math.round(d), " ", Math.round(e), " ", Math
					.round(f), " ") : this.path.push("C ", a, " ", b, " ", c,
			" ", d, " ", e, " ", f, " ")
};
mxPath.prototype.ellipse = function(a, b, c, d) {
	...
	b = b * this.scale;
	if (this.isVml())
		this.path.push("at ", Math.round(a), " ", Math.round(b), " ", Math
						.round(a + c), " ", Math.round(b + d), " ", Math
						.round(a), " ", Math.round(b + d / 2), " ", Math
						.round(a), " ", Math.round(b + d / 2));
	else {
		var e = a, f = b + d / 2, a = a + c, b = b + d / 2, c = c / 2, d = d
				/ 2;
		...
		mxEvent.addListener(g, mxClient.IS_TOUCH ? "touchstart" : "mousedown",
				mxUtils.bind(this, function(a) {
							...
							if (d.activeRow != g && d.activeRow != d) {
								d.activeRow != null
										&& d.activeRow.div.parentNode != null
										&& this.hideSubmenu(d);
								if (g.div != null) {
...
mxPopupMenu.prototype.hideSubmenu = function(a) {
	if (a.activeRow != null) {
		...
		a.activeRow.div.parentNode != null
...
mxAutoSaveManager.prototype.graphModelChanged = function() {
	...
	if (a > this.autoSaveDelay || this.ignoredChanges >= this.autoSaveThreshold
...
mxMorphing.prototype.animateCell = function(a, b, c) {
	...
	if (d != null) {
		...
		if (this.graph.getModel().isVertex(a) && (e.x != 0 || e.y != 0)) {
			var f = this.graph.view.getTranslate(), g = this.graph.view
					.getScale();
			e.x = e.x + f.x * g;
			e.y = e.y + f.y * g;
...
mxMorphing.prototype.getDelta = function(a) {
	var b = this.getOriginForCell(a.cell), c = this.graph.getView()
			.getTranslate(), d = this.graph.getView().getScale(), a = new mxPoint(
			a.x / d - c.x, a.y / d - c.y);
...
mxImageExport.prototype.drawState = function(a, b) {
	if (a != null) {
		if (a.shape != null) {
			var c = a.shape.stencil != null
					? a.shape.stencil
					: this.shapes[a.style[mxConstants.STYLE_SHAPE]];
			c == null
					&& (typeof a.shape.redrawPath == "function" ? c = this
							.createShape(a, b) : a.view.graph.getModel()
							.isVertex(a.cell)
							&& (c = this.shapes.rectangle));
			if (c != null) {
				this.drawShape(a, b, c);
				this.includeOverlays && this.drawOverlays(a, b)
			}
		}
		for (var c = a.view.graph, d = c.model.getChildCount(a.cell), e = 0; e < d; e++)
			this.drawState(c.view.getState(c.model.getChildAt(a.cell, e)), b)
	}
};
		...
		drawShape : function(a, b, c, d) {
			var e = {
				...
				quadTo : function(b, c, d, e) {
					a.quadTo(this.translate.x + b, this.translate.y + c,
							this.translate.x + d, this.translate.y + e)
				},
				curveTo : function(b, c, d, e, i, l) {
					a.curveTo(this.translate.x + b, this.translate.y + c,
							this.translate.x + d, this.translate.y + e,
							this.translate.x + i, this.translate.y + l)
				},
				end : function() {
				},
				close : function() {
			...
			a.begin();
			b.shape.redrawPath
					.call(b.shape, e, c.x, c.y, c.width, c.height, !d);
			d || a.fillAndStroke();
			return true
		}
	}
...
mxImageExport.prototype.drawShape = function(a, b, c) {
	var d = mxUtils.getNumber(a.style, mxConstants.STYLE_ROTATION, 0), e = mxUtils
			.getValue(a.style, mxConstants.STYLE_DIRECTION, null), f = a.style[mxConstants.STYLE_STENCIL_FLIPH], g = a.style[mxConstants.STYLE_STENCIL_FLIPV];
	if (f ? !g : g)
		d = d * -1;
	e != null
			&& (e == "north" ? d = d + 270 : e == "west"
					? d = d + 180
					: e == "south" && (d = d + 90));
	if (f && g) {
		d = d + 180;
	...
	var h = a.view.scale, k = mxUtils.getNumber(a.style,
	...
	var l = new mxRectangle(h.x - i, h.y - i, h.width + k, h.height + k), m = mxUtils
			.getValue(a.style, mxConstants.STYLE_OPACITY, 100)
			/ 100, k = a.style[mxConstants.STYLE_SHAPE], n = (i = k == mxConstants.SHAPE_IMAGE)
			? null
			: mxUtils.getValue(a.style, mxConstants.STYLE_GRADIENTCOLOR);
	n == mxConstants.NONE && (n = null);
	var o = mxUtils.getValue(a.style, i
					? mxConstants.STYLE_IMAGE_BACKGROUND
					: mxConstants.STYLE_FILLCOLOR, null);
	o == mxConstants.NONE && (o = null);
	var p = mxUtils.getValue(a.style, i
					? mxConstants.STYLE_IMAGE_BORDER
					: mxConstants.STYLE_STROKECOLOR, null);
	p == mxConstants.NONE && (p = null);
	var q = o != null
			&& (k == mxConstants.SHAPE_LABEL || k == mxConstants.SHAPE_RECTANGLE);
	mxUtils.getValue(a.style, mxConstants.STYLE_SHADOW, false)
			&& this.drawShadow(b, a, c, d, f, g, h, m, o != null);
	b.setAlpha(m);
	...
	if (p != null || o != null) {
		...
		o != null
				&& (n != null && n != "transparent" ? b.setGradient(o, n, h.x,
						h.y, h.width, h.height, e) : b.setFillColor(o));
		q = c.drawShape(b, a, h, true, false) && q;
		c.drawShape(b, a, h, false, false)
	}
	q && mxUtils.getValue(a.style, mxConstants.STYLE_GLASS, 0) == 1
			&& this.drawGlass(a, b, l, c, this.glassSize);
	...
	if (f != null && c != null && c.length > 0) {
		b.save();
		b.setAlpha(mxUtils.getValue(a.style, mxConstants.STYLE_TEXT_OPACITY,
				100)
				/ 100);
		e = new mxRectangle(f.boundingBox.x, f.boundingBox.y,
				f.boundingBox.width, f.boundingBox.height);
		d = mxUtils.getValue(a.style, mxConstants.STYLE_HORIZONTAL, 1) == 0;
		e.y = e.y + 2;
		if (d)
			if (f.dialect != mxConstants.DIALECT_SVG) {
				g = e.x + e.width / 2;
				f = e.y + e.height / 2;
				l = e.width;
				e.width = e.height;
...
mxImageExport.prototype.drawShadow = function(a, b, c, d, e, f, g, h, k) {
	var i = d * Math.PI / 180, d = Math.cos(-i), i = Math.sin(-i), d = mxUtils
			.getRotatedPoint(new mxPoint(mxConstants.SHADOW_OFFSET_X,
							mxConstants.SHADOW_OFFSET_Y), d, i);
	if (e)
		d.x = d.x * -1;
	if (f)
		d.y = d.y * -1;
...
mxImageExport.prototype.drawGlass = function(a, b, c, d, e) {
	if (d.drawShape(b, a, c, true, false)) {
		...
		b.quadTo(c.x + c.width * 0.5, c.y + c.height * 0.7, c.x + c.width, c.y
						+ c.height * e);
...
mxImageExport.prototype.drawImage = function(a, b, c, d) {
	var e = mxUtils.getValue(a.style, mxConstants.STYLE_IMAGE_ASPECT, 1) == 1, f = mxUtils
			.getValue(a.style, mxConstants.STYLE_IMAGE_FLIPH, 0) == 1, a = mxUtils
			.getValue(a.style, mxConstants.STYLE_IMAGE_FLIPV, 0) == 1;
	b.image(c.x, c.y, c.width, c.height, d, e, f, a)
};
mxImageExport.prototype.drawLabelBackground = function(a, b, c, d) {
	var e = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_BORDERCOLOR), f = mxUtils
			.getValue(a.style, mxConstants.STYLE_LABEL_BACKGROUNDCOLOR);
	e == mxConstants.NONE && (e = null);
	f == mxConstants.NONE && (f = null);
	if (e != null || f != null) {
		var g = c.x, a = c.y
				- mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_PADDING, 0), h = c.width, c = c.height;
		if (d) {
			g = g + (h - c) / 2;
			a = a + (c - h) / 2;
			d = h;
		...
		b.rect(g, a, h, c);
		f != null && e != null ? b.fillAndStroke() : f != null
				? b.fill()
				: e != null && b.stroke()
	}
};
mxImageExport.prototype.drawLabel = function(a, b, c, d, e) {
	var f = a.view.scale;
	b.setFontColor(mxUtils.getValue(a.style, mxConstants.STYLE_FONTCOLOR,
			"#000000"));
	b.setFontFamily(mxUtils.getValue(a.style, mxConstants.STYLE_FONTFAMILY,
			mxConstants.DEFAULT_FONTFAMILY));
	b.setFontStyle(mxUtils.getValue(a.style, mxConstants.STYLE_FONTSTYLE, 0));
	b.setFontSize(mxUtils.getValue(a.style, mxConstants.STYLE_FONTSIZE,
			mxConstants.DEFAULT_FONTSIZE)
			* f);
	f = mxUtils.getValue(a.style, mxConstants.STYLE_ALIGN,
			mxConstants.ALIGN_LEFT);
	f == "left" && (f = null);
	var g = c.y - mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_PADDING, 0), h = a.view.graph
			.isWrapping(a.cell);
	(a = a.view.graph.isHtmlLabel(a.cell)) && mxText.prototype.replaceLinefeeds
			&& (e = e.replace(/\n/g, "<br/>"));
...
mxImageExport.prototype.getBackgroundBounds = function(a) {
	if (a.style[mxConstants.STYLE_SHAPE] == mxConstants.SHAPE_SWIMLANE) {
		var b = a.view.scale, b = mxUtils.getValue(a.style,
				mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE)
				* b, c = a.width, d = a.height;
		mxUtils.getValue(a.style, mxConstants.STYLE_HORIZONTAL, true)
				? d = b
				: c = b;
		return new mxRectangle(a.x, a.y, Math.min(a.width, c), Math.min(
						a.height, d))
	}
...
mxImageExport.prototype.getImageBounds = function(a) {
	...
	if (mxUtils.getValue(c, mxConstants.STYLE_SHAPE) != mxConstants.SHAPE_IMAGE) {
		var a = mxUtils.getValue(c, mxConstants.STYLE_IMAGE_ALIGN,
				mxConstants.ALIGN_LEFT), d = mxUtils.getValue(c,
				mxConstants.STYLE_IMAGE_VERTICAL_ALIGN,
				mxConstants.ALIGN_MIDDLE), e = mxUtils.getValue(c,
				mxConstants.STYLE_IMAGE_WIDTH, mxConstants.DEFAULT_IMAGESIZE), f = mxUtils
				.getValue(c, mxConstants.STYLE_IMAGE_HEIGHT,
						mxConstants.DEFAULT_IMAGESIZE), c = mxUtils.getValue(c,
				mxConstants.STYLE_SPACING, 2);
		b.x = a == mxConstants.ALIGN_CENTER
				? b.x + (b.width - e) / 2
				: a == mxConstants.ALIGN_RIGHT
						? b.x + (b.width - e - c - 2)
						: b.x + (c + 4);
		b.y = d == mxConstants.ALIGN_TOP
				? b.y + c
...
mxImageExport.prototype.drawMarker = function(a, b, c) {
	var d = null, e = b.absolutePoints, f = e.length, g = c ? e[1] : e[f - 2], e = c
			? e[0]
			: e[f - 1], f = e.x - g.x, h = e.y - g.y, k = Math.max(1, Math
					.sqrt(f * f + h * h)), g = f / k, f = h / k, h = mxUtils
			.getValue(b.style, c
							? mxConstants.STYLE_STARTSIZE
							: mxConstants.STYLE_ENDSIZE,
					mxConstants.DEFAULT_MARKERSIZE), k = mxUtils.getValue(
			b.style, mxConstants.STYLE_STROKEWIDTH, 1), e = e.clone(), i = mxUtils
			.getValue(b.style, c
							? mxConstants.STYLE_STARTARROW
							: mxConstants.STYLE_ENDARROW), l = this.markers[i];
...
mxImageExport.prototype.initShapes = function() {
		...
		drawShape : function(a, c, d, e) {
			if (e) {
				if (mxUtils.getValue(c.style, mxConstants.STYLE_ROUNDED, false)) {
					c = mxUtils.getValue(c.style, mxConstants.STYLE_ARCSIZE,
			...
			if (e) {
				if (mxUtils.getValue(c.style, mxConstants.STYLE_ROUNDED, false)) {
					c = Math.min(d.width
							...
							d.height * mxConstants.RECTANGLE_ROUNDING_FACTOR);
					a.roundrect(d.x, d.y, d.width, d.height, c, c)
				} else
					a.rect(d.x, d.y, d.width, d.height);
				return true
	...
	this.shapes.connector = {
		...
		drawShape : function(b, c, d, e, f) {
			if (e) {
				...
				b.setFillColor(f ? mxConstants.NONE : mxUtils.getValue(c.style,
				...
				b.setDashed(mxUtils.getValue(c.style, mxConstants.STYLE_DASHED,
						"0") == "1");
				...
				for (var h = 1; h < f.length - 1; h++) {
					...
					if (d && h < f.length - 1 && (i != 0 || g != 0)) {
						var l = Math.sqrt(i * i + g * g), i = i
								* Math.min(e, l / 2) / l, g = g
								* Math.min(e, l / 2) / l;
	...
	this.shapes.arrow = {
		drawShape : function(a, c, d, e) {
			if (e) {
				var d = mxConstants.ARROW_SPACING, f = mxConstants.ARROW_WIDTH, e = mxConstants.ARROW_SIZE, c = c.absolutePoints, g = c[0], c = c[c.length
						- 1], h = c.x - g.x, k = c.y - g.y, i = Math.sqrt(h * h
						+ k * k), l = i - 2 * d - e, e = h / i, k = k / i, i = f
						* k / 3, f = -f * e / 3, h = g.x - i / 2 + d * e, g = g.y
						- f / 2 + d * k, m = h + i, n = g + f, o = m + l * e, l = n
						+ l * k, p = o + i, q = l + f, t = p - 3 * i, u = q - 3
						* f;
				a.begin();
				a.moveTo(h, g);
				a.lineTo(m, n);
	...
	this.shapes.cylinder = {
		drawShape : function(a, c, d, e) {
			if (e)
				return false;
			var c = d.x, e = d.y, f = d.width, d = d.height, g = Math.min(
					mxCylinder.prototype.maxHeight, Math.floor(d / 5));
			a.begin();
			a.moveTo(c, e + g);
	...
	this.shapes.rhombus = {
		drawShape : function(a, c, d, e) {
			if (e) {
				var c = d.x, e = d.y, f = d.width, d = d.height, g = f / 2, h = d
						/ 2;
				a.begin();
				a.moveTo(c + g, e);
				a.lineTo(c + f, e + h);
	...
	this.shapes.actor = {
		drawShape : function(a, c, d, e) {
			if (e) {
				...
				a.begin();
				a.moveTo(c, e + d);
				a.curveTo(c, e + 3 * d / 5, c, e + 2 * d / 5, c + f / 2, e + 2
								* d / 5);
				a.curveTo(c + f / 2 - g, e + 2 * d / 5, c + f / 2 - g, e, c + f
								/ 2, e);
				a.curveTo(c + f / 2 + g, e, c + f / 2 + g, e + 2 * d / 5, c + f
								/ 2, e + 2 * d / 5);
				a.curveTo(c + f, e + 2 * d / 5, c + f, e + 3 * d / 5, c + f, e
								+ d);
				a.close();
				return true
			}
	...
	this.shapes.cloud = {
		drawShape : function(a, c, d, e) {
			if (e) {
				...
				a.curveTo(c + 0.05 * f, e + 0.25 * d, c, e + 0.5 * d, c + 0.16
								* f, e + 0.55 * d);
				a.curveTo(c, e + 0.66 * d, c + 0.18 * f, e + 0.9 * d, c + 0.31
								* f, e + 0.8 * d);
				a.curveTo(c + 0.4 * f, e + d, c + 0.7 * f, e + d, c + 0.8 * f,
						e + 0.8 * d);
				a.curveTo(c + f, e + 0.8 * d, c + f, e + 0.6 * d,
						c + 0.875 * f, e + 0.5 * d);
				a.curveTo(c + f, e + 0.3 * d, c + 0.8 * f, e + 0.1 * d, c
								+ 0.625 * f, e + 0.2 * d);
				a.curveTo(c + 0.5 * f, e + 0.05 * d, c + 0.3 * f, e + 0.05 * d,
						c + 0.25 * f, e + 0.25 * d);
				a.close();
				return true
			}
...
mxImageExport.prototype.initMarkers = function() {
	...
	var a = function(a, c, d, e, f, g, h, k, i) {
		...
		d == mxConstants.ARROW_CLASSIC
				&& a.lineTo(e.x - f * 3 / 4, e.y - g * 3 / 4);
		a.lineTo(e.x + g / 2 - f, e.y - g - f / 2);
		a.close();
		c.style[k ? mxConstants.STYLE_STARTFILL : mxConstants.STYLE_ENDFILL] == 0
				? a.stroke()
				: a.fillAndStroke();
	...
	a = function(a, c, d, e, f, g, h, k, i) {
		var l = d == mxConstants.ARROW_DIAMOND ? 0.7071 : 0.9862, m = f * i * l, l = g
				* i * l, f = f * (h + i), g = g * (h + i);
		e.x = e.x - m;
		e.y = e.y - l;
...
var mxXmlCanvas2D = function(a) {
	...
	var b = b != null ? b : false, c = new mxUrlConverter, d = true, e = true, f = true, g = function(
			b, c) {
		var d = a.ownerDocument || document;
		if (d.createElementNS != null)
			return d.createElementNS(c || mxConstants.NS_SVG, b);
		d = d.createElement(b);
	...
	if (b) {
		...
		mxUtils.write(k, "svg{font-family:" + mxConstants.DEFAULT_FONTFAMILY
	...
	var i = {
		...
		fontFamily : mxConstants.DEFAULT_FONTFAMILY,
		fontStyle : 0
	}, l = true, m = null, n = null, o = null, p = null, q = [], t = 0, u = [], v = function(
			a, b) {
		var c = "margin:0px;font-size:" + Math.floor(i.fontSize)
				+ "px;font-family:" + i.fontFamily + ";color:" + i.fontColor
				+ ";";
		(i.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD
				&& (c = c + "font-weight:bold;");
		(i.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC
				&& (c = c + "font-style:italic;");
		(i.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE
				&& (c = c + "font-decoration:underline;");
		b == mxConstants.ALIGN_CENTER
				? c = c + "text-align:center;"
				: b == mxConstants.ALIGN_RIGHT && (c = c + "text-align:right;");
		a = a.replace(/&nbsp;/g, "&#160;");
		return mxUtils
				.parseXml('<div xmlns="http://www.w3.org/1999/xhtml" style="'
		...
		if (c != null) {
			...
			f && (e.fill != null || e.gradient != null) ? e.gradient != null
					? c.setAttribute("fill", "url(#" + e.gradient + ")")
					: c.setAttribute("fill", e.fill.toLowerCase()) : b
					|| c.setAttribute("fill", "none");
			if (g && e.stroke != null) {
				c.setAttribute("stroke", e.stroke.toLowerCase());
				if (e.strokeWidth != 1) {
					if (c.nodeName == "rect" && d)
						e.strokeWidth = Math.max(1, e.strokeWidth);
					c.setAttribute("stroke-width", e.strokeWidth)
				}
				if (c.nodeName == "path") {
					e.linejoin != null && e.linejoin != "miter"
							&& c.setAttribute("stroke-linejoin", e.linejoin);
					if (e.linecap != null) {
						f = e.linecap;
						f == "flat" && (f = "butt");
	...
	return {
		...
		rotate : function(a, b, c, d, e) {
			...
			e = e * i.scale;
			if (b ^ c) {
				var f = b ? d : 0, b = b ? -1 : 1, g = c ? e : 0, c = c
						? -1
						: 1;
		...
		setGradient : function(a, b, c, d, e, f, k) {
			if (a != null && b != null) {
				...
				if (k == null || k == mxConstants.DIRECTION_SOUTH)
					f = "s";
				else if (k == mxConstants.DIRECTION_EAST)
					f = "e";
				else {
					var l = d, d = e, e = l;
					k == mxConstants.DIRECTION_NORTH
							? f = "s"
							: k == mxConstants.DIRECTION_WEST && (f = "e")
				}
				d = d + "-" + e + "-" + f;
				e = q[d];
				if (e == null) {
					...
					e.setAttribute("x2", "0%");
					e.setAttribute("y2", "0%");
					k == null || k == mxConstants.DIRECTION_SOUTH
							? e.setAttribute("y2", "100%")
							: k == mxConstants.DIRECTION_EAST
									? e.setAttribute("x2", "100%")
									: k == mxConstants.DIRECTION_NORTH
											? e.setAttribute("y1", "100%")
											: k == mxConstants.DIRECTION_WEST
													&& e.setAttribute("x1",
															"100%");
					k = g("stop");
		...
		setGlassGradient : function() {
			if (m == null) {
				...
				m.appendChild(a);
				h.firstChild.nextSibling != null ? h.insertBefore(m,
						h.firstChild.nextSibling) : h.appendChild(m)
			}
			i.gradient = "0"
		},
		...
		image : function(b, d, e, f, h, k, l, m) {
			var h = c.convert(h), k = k != null ? k : true, l = l != null
					? l
					: false, m = m != null ? m : false, b = b + i.dx, d = d
					+ i.dy, n = g("image");
			n.setAttribute("x", r(b * i.scale));
			n.setAttribute("y", r(d * i.scale));
			n.setAttribute("width", r(e * i.scale));
			n.setAttribute("height", r(f * i.scale));
			mxClient.IS_VML ? n.setAttribute("xlink:href", h) : n
					.setAttributeNS(mxConstants.NS_XLINK, "xlink:href", h);
		...
		text : function(c, d, h, k, l, m, n, o, p, q) {
			if (e) {
				...
				if (f && q == "html") {
					p = g("g");
					p.setAttribute("transform", i.transform + "scale("
									+ i.scale + "," + i.scale + ")");
					...
					if (o) {
						o = d + k / 2;
						t = t
								+ ("rotate(-90," + r((c + h / 2) * i.scale)
										+ "," + r(o * i.scale) + ")")
					}
					t.length > 0 && p.setAttribute("transform", t);
					i.alpha < 1 && p.setAttribute("opacity", i.alpha);
					m = m == mxConstants.ALIGN_RIGHT
							? "end"
							: m == mxConstants.ALIGN_CENTER
									? "middle"
									: "start";
					c = m == "end" ? c + Math.max(0, h - 2) : m == "middle" ? c
							+ h / 2 : c + (h > 0 ? 2 : 0);
					(i.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD
					...
					(!b || q != mxConstants.DEFAULT_FONTSIZE)
							&& p.setAttribute("font-size", Math.floor(q
											* i.scale)
											+ "px");
					...
					n == null || n == mxConstants.ALIGN_TOP
							? d = Math.max(d - 3 * i.scale, d + m / 2
											+ (k > 0 ? l / 2 - 8 : 0))
							: n == mxConstants.ALIGN_MIDDLE
									? d = d + m / 2
									: n == mxConstants.ALIGN_BOTTOM
											&& (d = Math.min(d, d + m + 2
															* i.scale));
					d = d + q;
		...
		quadTo : function(a, b, c, d) {
			if (o != null) {
				...
				c = c + i.dx;
				d = d + i.dy;
				o.push("Q " + r(a * i.scale) + " " + r(b * i.scale) + " "
						+ r(c * i.scale) + " " + r(d * i.scale));
				l = false
			}
		},
		curveTo : function(a, b, c, d, e, f) {
			if (o != null) {
				...
				e = e + i.dx;
				f = f + i.dy;
				o.push("C " + r(a * i.scale) + " " + r(b * i.scale) + " "
						+ r(c * i.scale) + " " + r(d * i.scale) + " "
						+ r(e * i.scale) + " " + r(f * i.scale));
				l = false
			}
		},
		close : function() {
...
mxGuide.prototype.createGuideShape = function() {
	var a = new mxPolyline([], mxConstants.GUIDE_COLOR,
...
mxGuide.prototype.move = function(a, b, c) {
	if (this.states != null && (this.horizontal || this.vertical) && a != null
			&& b != null) {
		var d = this.graph.getView().translate, e = this.graph.getView().scale, f = b.x, g = b.y, h = false, k = false, i = this
				.getGuideTolerance(), l = i, m = i, i = a.clone();
		i.x = i.x + b.x;
		i.y = i.y + b.y;
		for (var n = i.x, o = i.x + i.width, p = i.getCenterX(), q = i.y, t = i.y
				+ i.height, u = i.getCenterY(), b = function(b) {
			...
			if (c) {
				...
				var d = this.graph.container, b = b - this.graph.panDx;
		...
		if (!h && this.guideX != null)
			this.guideX.node.style.visibility = "hidden";
		else if (this.guideX != null) {
			this.guideX.node.style.visibility = "visible";
			this.guideX.redraw()
		}
		if (!k && this.guideY != null)
...
mxShape.prototype.init = function(a) {
	if (this.node == null) {
		...
		if (a != null) {
			...
			document.documentMode == 8 && mxUtils.isVml(this.node)
					&& this.reparseVml()
		}
	}
...
mxShape.prototype.reparseVml = function() {
	for (var a = 0; a < this.vmlNodes.length; a++)
		this[this.vmlNodes[a]] != null
				&& this[this.vmlNodes[a]].setAttribute("id",
						"mxTemporaryReference-" + this.vmlNodes[a]);
	this.node.outerHTML = this.node.outerHTML;
	for (a = 0; a < this.vmlNodes.length; a++)
		if (this[this.vmlNodes[a]] != null) {
			this[this.vmlNodes[a]] = this.node.ownerDocument
					.getElementById("mxTemporaryReference-" + this.vmlNodes[a]);
			this[this.vmlNodes[a]].removeAttribute("id")
		}
};
mxShape.prototype.insertGradient = function(a) {
	if (a != null) {
		for (var b = 0, c = a.getAttribute("id"), d = document
				.getElementById(c); d != null
				&& d.ownerSVGElement != this.node.ownerSVGElement;) {
			b++;
...
mxShape.prototype.create = function() {
	var a = null;
	return a = this.dialect == mxConstants.DIALECT_SVG
			? this.createSvg()
			: this.dialect == mxConstants.DIALECT_STRICTHTML
					|| this.preferModeHtml
					&& this.dialect == mxConstants.DIALECT_PREFERHTML
					|| this.isMixedModeHtml()
					&& this.dialect == mxConstants.DIALECT_MIXEDHTML ? this
					.createHtml() : this.createVml()
};
...
mxShape.prototype.apply = function(a) {
	...
	if (a != null) {
		...
		this.gradient = mxUtils.getValue(a, mxConstants.STYLE_GRADIENTCOLOR,
				this.gradient);
		this.gradientDirection = mxUtils.getValue(a,
				mxConstants.STYLE_GRADIENT_DIRECTION, this.gradientDirection);
		this.opacity = mxUtils.getValue(a, mxConstants.STYLE_OPACITY,
				this.opacity);
		this.stroke = mxUtils.getValue(a, mxConstants.STYLE_STROKECOLOR,
				this.stroke);
		this.strokewidth = mxUtils.getNumber(a, mxConstants.STYLE_STROKEWIDTH,
				this.strokewidth);
		this.isShadow = mxUtils.getValue(a, mxConstants.STYLE_SHADOW,
				this.isShadow);
		this.isDashed = mxUtils.getValue(a, mxConstants.STYLE_DASHED,
				this.isDashed);
		this.spacing = mxUtils.getValue(a, mxConstants.STYLE_SPACING,
				this.spacing);
		this.startSize = mxUtils.getNumber(a, mxConstants.STYLE_STARTSIZE,
				this.startSize);
		this.endSize = mxUtils.getNumber(a, mxConstants.STYLE_ENDSIZE,
				this.endSize);
		this.isRounded = mxUtils.getValue(a, mxConstants.STYLE_ROUNDED,
				this.isRounded);
		this.startArrow = mxUtils.getValue(a, mxConstants.STYLE_STARTARROW,
				this.startArrow);
		this.endArrow = mxUtils.getValue(a, mxConstants.STYLE_ENDARROW,
				this.endArrow);
		this.rotation = mxUtils.getValue(a, mxConstants.STYLE_ROTATION,
				this.rotation);
		this.direction = mxUtils.getValue(a, mxConstants.STYLE_DIRECTION,
				this.direction);
		if (this.fill == "none")
			this.fill = null;
...
mxShape.prototype.createSvgGroup = function(a) {
	...
	a == "rect" && (this.strokewidth * this.scale >= 1 && !this.isRounded)
...
mxShape.prototype.createSvgShadow = function(a) {
	if (this.isShadow) {
		...
		this.fill != null && this.fill != mxConstants.NONE
				&& a.setAttribute("fill", mxConstants.SHADOWCOLOR);
		this.stroke != null && this.stroke != mxConstants.NONE
				&& a.setAttribute("stroke", mxConstants.SHADOWCOLOR);
		return a
	}
	return null
};
mxShape.prototype.configureHtmlShape = function(a) {
	if (mxUtils.isVml(a))
		...
		if (b != null && b != mxConstants.NONE) {
			...
			a.style.borderWidth = Math.ceil(this.strokewidth * this.scale)
					+ "px"
		} else
			a.style.borderWidth = "0px";
		b = this.fill;
		a.style.background = "";
		b != null && b != mxConstants.NONE
...
mxShape.prototype.updateVmlFill = function(a, b, c, d, e) {
	...
	if (c != null) {
		...
		a.color2 = c;
		b = "180";
		this.gradientDirection == mxConstants.DIRECTION_EAST
				? b = "270"
				: this.gradientDirection == mxConstants.DIRECTION_WEST
						? b = "90"
						: this.gradientDirection == mxConstants.DIRECTION_NORTH
								&& (b = "0");
		a.angle = b
	}
};
...
mxShape.prototype.configureVmlShape = function(a) {
	...
	if (b != null && b != mxConstants.NONE) {
		...
		this.updateVmlFill(this.fillNode, b, this.gradient,
	...
	if (a.nodeName == "roundrect")
		try {
			var c = mxConstants.RECTANGLE_ROUNDING_FACTOR * 100;
			this.style != null
					&& (c = mxUtils.getValue(this.style,
							mxConstants.STYLE_ARCSIZE, c));
...
mxShape.prototype.configureTransparentBackground = function(a) {
	a.style.background = "url('" + mxClient.imageBasePath
			+ "/transparent.gif')"
};
mxShape.prototype.configureSvgShape = function(a) {
	var b = this.stroke;
	b != null && b != mxConstants.NONE ? a.setAttribute("stroke", b) : a
	...
	if (b != null && b != mxConstants.NONE)
		if (this.gradient != null) {
			...
			if (this.gradientNode != null
					&& this.gradientNode.getAttribute("id") != c) {
				this.gradientNode = null;
				a.setAttribute("fill", "")
			}
			if (this.gradientNode == null) {
				this.gradientNode = this.createSvgGradient(c, b, this.gradient,
						a);
...
mxShape.prototype.createPoints = function(a, b, c, d) {
	var e = d ? this.bounds.x : 0, d = d ? this.bounds.y : 0, f = this.crisp
			&& this.dialect == mxConstants.DIALECT_SVG && mxClient.IS_IE
			? 0.5
			: 0;
	...
	for (var a = a + " " + (Math.round(h.x - e) + f) + " "
			+ (Math.round(h.y - d) + f) + " ", k = 1; k < this.points.length; k++) {
		var h = this.points[k - 1], i = this.points[k];
		...
		if (this.isRounded && k < this.points.length - 1 && (l != 0 || h != 0)
				&& this.scale > 0.3) {
			var m = Math.sqrt(l * l + h * h), l = l * Math.min(g, m / 2) / m, h = h
					* Math.min(g, m / 2) / m, a = a
					+ (b + " " + (Math.round(i.x + l - e) + f) + " "
							+ (Math.round(i.y + h - d) + f) + " "), h = this.points[k
					+ 1], l = h.x - i.x, h = h.y - i.y, m = Math.max(1, Math
							.sqrt(l * l + h * h));
			if (m != 0) {
				...
				a = a
						+ (c + " " + Math.round(i.x - e) + " "
								...
								+ Math.round(i.x - e) + ","
								+ Math.round(i.y - d) + " "
								+ (Math.round(i.x + l - e) + f) + " "
								+ (Math.round(i.y + h - d) + f) + " ")
			}
		} else
			a = a
					+ (b + " " + (Math.round(i.x - e) + f) + " "
							+ (Math.round(i.y - d) + f) + " ")
	}
	return a
};
	...
	if (a != null) {
		if (mxUtils.isVml(a))
			...
			if (this.bounds != null && !isNaN(this.bounds.x)
				...
				a.style.width = Math.round(Math.max(0, this.bounds.width + b))
						+ "px";
				a.style.height = Math
						.round(Math.max(0, this.bounds.height + b))
						+ "px";
				a.style.visibility = this.bounds.width == 0
						|| this.bounds.height == 0 ? "hidden" : "visible"
			}
		}
		if (this.points != null && this.bounds != null && !mxUtils.isVml(a)) {
			...
			if (this.points.length == 2) {
				var c = this.points[0], b = this.points[1], d = b.x - c.x, e = b.y
						- c.y;
				if (d == 0 || e == 0)
					a.style.borderStyle = "solid";
				else {
					...
					for (var b = 1 + Math.sqrt(d * d + e * e)
							/ (8 * this.scale), f = d / b, g = e / b, a = c.x
							- this.bounds.x, c = c.y - this.bounds.y, d = 0; d < b; d++) {
...
mxShape.prototype.updateVmlShape = function(a) {
	...
	if (this.shadowNode != null) {
		var b = Math.round(mxConstants.SHADOW_OFFSET_X * this.scale), c = Math
				.round(mxConstants.SHADOW_OFFSET_Y * this.scale);
		this.shadowNode.offset = b + "px," + c + "px"
	}
	if (this.bounds != null && !isNaN(this.bounds.x) && !isNaN(this.bounds.y)
			&& !isNaN(this.bounds.width) && !isNaN(this.bounds.height)) {
		var b = 1, c = Math.max(0, Math.round(this.bounds.width)), d = Math
				.max(0, Math.round(this.bounds.height));
		if (this.points != null || a.nodeName == "shape"
				|| a.nodeName == "group") {
			var e = a.parentNode.nodeName == "group" ? 1 : this.vmlScale;
			a.coordsize = c * e + "," + d * e
		} else if (a.parentNode.nodeName == "group")
			b = this.vmlScale;
		if (a.parentNode != this.node) {
			...
			if (this.points == null)
				...
				else if (a.style.rotation != null)
					a.style.rotation = ""
		}
		a.style.width = c * b + "px";
		a.style.height = d * b + "px"
	}
	if (this.points != null && a.nodeName != "group")
		if (a.nodeName == "polyline" && a.points != null) {
			b = "";
			for (c = 0; c < this.points.length; c++)
				b = b + (this.points[c].x + "," + this.points[c].y + " ");
			a.points.value = b;
			a.style.left = null;
			a.style.top = null;
			a.style.width = null;
			...
			if (this.style != null && this.style[mxConstants.STYLE_SMOOTH]) {
				...
				e = d.length;
				if (e > 3) {
					for (var f = this.bounds.x, g = this.bounds.y, b = "m "
							+ Math.round(d[0].x - f) + " "
							+ Math.round(d[0].y - g) + " qb", c = 1; c < e - 1; c++)
						b = b
								+ (" " + Math.round(d[c].x - f) + " " + Math
										.round(d[c].y - g));
					b = b
							+ (" nf l " + Math.round(d[e - 1].x - f) + " " + Math
									.round(d[e - 1].y - g))
				}
			}
			a.path = b + " e"
...
mxShape.prototype.updateSvgBounds = function(a) {
	...
	if (this.isRounded) {
		...
		this.style != null
				&& (d = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE,
						d)
						/ 100);
		b = Math.min(b * d, c * d);
		a.setAttribute("rx", b);
...
mxShape.prototype.updateSvgPath = function(a) {
	...
	if (b != null) {
		...
		if (this.style != null && this.style[mxConstants.STYLE_SMOOTH]) {
			...
			if (c > 3) {
				for (var d = "M " + b[0].x + " " + b[0].y + " ", d = d
						+ (" Q " + b[1].x + " " + b[1].y + "  " + b[2].x + " " + b[2].y), e = 3; e < c; e++)
					d = d + (" T " + b[e].x + " " + b[e].y);
				a.setAttribute("d", d)
			}
		}
...
mxShape.prototype.updateSvgScale = function(a) {
	a.setAttribute("stroke-width", Math.round(Math.max(1, this.strokewidth
							* this.scale)));
	if (this.isDashed) {
		var b = Math.max(1, Math.round(3 * this.scale * this.strokewidth));
		a.setAttribute("stroke-dasharray", b + " " + b)
	}
	this.crisp && (this.roundedCrispSvg || this.isRounded != true)
			&& (this.rotation == null || this.rotation == 0) ? a.setAttribute(
			"shape-rendering", "crispEdges") : a
			.removeAttribute("shape-rendering")
};
mxShape.prototype.updateSvgShape = function(a) {
	this.points != null && this.points[0] != null
			? this.updateSvgPath(a)
			: this.bounds != null && this.updateSvgBounds(a);
	this.updateSvgScale(a)
};
mxShape.prototype.getSvgShadowTransform = function() {
	return "translate(" + mxConstants.SHADOW_OFFSET_X * this.scale + " "
			+ mxConstants.SHADOW_OFFSET_Y * this.scale + ")"
};
mxShape.prototype.updateSvgTransform = function(a, b) {
	var c = b ? this.getSvgShadowTransform() : "";
	this.rotation != null && this.rotation != 0 ? a.setAttribute("transform",
			"rotate(" + this.rotation + ","
					+ (this.bounds.x + this.bounds.width / 2) + ","
					+ (this.bounds.y + this.bounds.height / 2) + ") " + c) : b
			? a.setAttribute("transform", c)
			: a.removeAttribute("transform")
};
mxShape.prototype.reconfigure = function() {
	if (this.dialect == mxConstants.DIALECT_SVG) {
		this.innerNode != null ? this.configureSvgShape(this.innerNode) : this
				.configureSvgShape(this.node);
		if (this.insertGradientNode != null) {
			this.insertGradient(this.insertGradientNode);
			this.insertGradientNode = null
		}
...
mxShape.prototype.updateBoundingBox = function() {
	if (this.bounds != null) {
		...
		var b = Number(mxUtils.getValue(this.style, mxConstants.STYLE_ROTATION,
				0));
...
mxShape.prototype.augmentBoundingBox = function(a) {
	if (this.isShadow) {
		...
		a.height = a.height
				+ Math.ceil(mxConstants.SHADOW_OFFSET_Y * this.scale)
	}
	var b = Math.ceil(this.strokewidth * this.scale);
...
mxShape.prototype.redrawSvg = function() {
	if (this.innerNode != null) {
		...
		this.shadowNode != null
				&& this.shadowNode.setAttribute("transform", this
...
mxShape.prototype.updateVmlGlassPane = function() {
	if (this.bounds != null && this.node.nodeName == "group"
		...
		var a = this.bounds, b = Math.ceil(this.strokewidth * this.scale / 2
				+ 1), b = "m " + -b + " " + -b + " l " + -b + " "
				+ Math.round(a.height * 0.4) + " c "
				+ Math.round(a.width * 0.3) + " " + Math.round(a.height * 0.6)
				+ " " + Math.round(a.width * 0.7) + " "
				+ Math.round(a.height * 0.6) + " " + Math.round(a.width + b)
				+ " " + Math.round(a.height * 0.4) + " l "
				+ Math.round(a.width + b) + " " + -b + " x e";
	...
	if (this.node.nodeName == "g" && this.style != null
		...
		if (this.node.glassOverlay == null) {
			if (this.node.ownerSVGElement.glassGradient == null) {
				var a = document.createElementNS(mxConstants.NS_SVG,
						"linearGradient");
				a.setAttribute("x1", "0%");
				a.setAttribute("y1", "0%");
				a.setAttribute("x2", "0%");
				...
				a.appendChild(b);
				for (b = 0; document.getElementById("mx-glass-gradient-" + b) != null;)
					b++;
			...
			this.node.glassOverlay.setAttribute("style", "fill:url(#"
							+ this.node.ownerSVGElement.glassGradient
									.getAttribute("id") + ");");
			this.node.appendChild(this.node.glassOverlay)
		}
		a = this.bounds;
		b = Math.ceil(this.strokewidth * this.scale / 2);
		this.node.glassOverlay.setAttribute("d", "m " + (a.x - b) + ","
						+ (a.y - b) + " L " + (a.x - b) + ","
						+ (a.y + a.height * 0.4) + " Q "
						+ (a.x + a.width * 0.5) + "," + (a.y + a.height * 0.7)
						+ " " + (a.x + a.width + b) + ","
...
mxShape.prototype.createPath = function(a) {
	...
	if (this.direction == "north" || this.direction == "south")
		var f = (d - e) / 2, b = b + f, c = c + (e - d) / 2, g = d, d = e, e = g;
	var h = this.getRotation(), g = null;
	if (this.dialect == mxConstants.DIALECT_SVG) {
		g = new mxPath("svg");
		g.setTranslate(b, c);
		if (h != 0) {
			var f = this.bounds.getCenterX(), k = this.bounds.getCenterY(), h = "rotate("
					+ h + " " + f + " " + k + ")";
			this.innerNode != null
					&& this.innerNode.setAttribute("transform", h);
			this.foreground != null
					&& this.foreground.setAttribute("transform", h);
			this.shadowNode != null
					&& this.shadowNode.setAttribute("transform", this
									.getSvgShadowTransform()
									+ " " + h)
...
mxStencil.prototype.parseConstraint = function(a) {
	var b = Number(a.getAttribute("x")), c = Number(a.getAttribute("y")), a = a
			.getAttribute("perimeter") == "1";
...
mxStencil.prototype.renderDom = function(a, b, c, d) {
	var e = a.dialect != mxConstants.DIALECT_SVG, f = document.documentMode == 8
			? 1
			: a.vmlScale, g = a.rotation || 0, h = false, k = a.style[mxConstants.STYLE_STENCIL_FLIPH], i = a.style[mxConstants.STYLE_STENCIL_FLIPV];
	if (k ? !i : i)
		g = g * -1;
	if (a.direction != null) {
		a.direction == "north" ? g = g + 270 : a.direction == "west" ? g = g
				+ 180 : a.direction == "south" && (g = g + 90);
	...
	if (this.bgNode != null || this.fgNode != null) {
		var t = e && d == null ? 0 : b.x, u = e && d == null ? 0 : b.y, m = b.width
				/ this.w0, n = b.height / this.h0;
		...
		var v = Math.min(m, n), w = [], r = d != null ? d : {
			...
			fill : a.fill,
			stroke : a.stroke,
			strokeWidth : this.strokewidth == "inherit" ? Number(a.strokewidth)
					* a.scale : Number(this.strokewidth) * v / (e ? f : 1),
			dashed : a.isDashed,
			dashpattern : [3, 3],
			alpha : a.opacity,
			linejoin : "miter",
			...
			if (e) {
				...
				if (c.fill != null) {
					var d = !c.fillColorAssigned ? a.gradient : null, f = document
				...
				c.fill != null && c.fillColorAssigned
						&& b.setAttribute("fill", c.fill);
			...
			if (g == "save") {
				...
				if (e) {
					var h = this.lastMoveX, o = this.lastMoveY, i = t
							+ Number(d.getAttribute("x1")) * m, g = u
							+ Number(d.getAttribute("y1")) * n, k = t
							+ Number(d.getAttribute("x2")) * m, d = u
							+ Number(d.getAttribute("y2")) * n, o = o + 2 / 3
							* (g - o), p = k + 2 / 3 * (i - k), g = d + 2 / 3
							* (g - d);
					z("c " + Math.round(h + 2 / 3 * (i - h)) + " "
							+ Math.round(o) + " " + Math.round(p) + " "
							+ Math.round(g) + " " + Math.round(k) + " "
							+ Math.round(d));
					this.lastMoveX = k;
					this.lastMoveY = d
				} else {
					...
					z("Q " + (t + Number(d.getAttribute("x1")) * m) + " "
							+ (u + Number(d.getAttribute("y1")) * n) + " "
				...
				z(h + " " + x(t + Number(d.getAttribute("x1")) * m) + " "
						+ x(u + Number(d.getAttribute("y1")) * n) + " "
						+ x(t + Number(d.getAttribute("x2")) * m) + " "
						+ x(u + Number(d.getAttribute("y2")) * n) + " "
						+ this.lastMoveX + " " + this.lastMoveY)
			} else if (g == "close")
				z(e ? "x" : "Z");
				...
				var k = Number(d.getAttribute("rx")) * m, g = Number(d
						.getAttribute("ry"))
						* n, o = Number(d.getAttribute("x-axis-rotation")), p = Number(d
						.getAttribute("large-arc-flag")), A = Number(d
						.getAttribute("sweep-flag")), i = t
						+ Number(d.getAttribute("x")) * m, h = u
						+ Number(d.getAttribute("y")) * n;
				if (e) {
					h = mxUtils.arcToCurves(this.lastMoveX, this.lastMoveY, k,
							g, o, p, A, i, h);
					for (d = 0; d < h.length; d = d + 6) {
						z("c " + Math.round(h[d]) + " " + Math.round(h[d + 1])
								+ " " + Math.round(h[d + 2]) + " "
								+ Math.round(h[d + 3]) + " "
								+ Math.round(h[d + 4]) + " "
								+ Math.round(h[d + 5]));
				...
				if (o != null) {
					...
					if (e) {
						...
						if (p || A) {
							...
							s.setAttribute("transform", l + "scale(" + D + " "
											+ E + ") translate(" + d + " " + o
											+ ") ")
						} else
							s.setAttribute("transform", l)
					}
					c.appendChild(s)
				}
				...
				if (k != null) {
					...
					if (e) {
						...
						d.string = k;
						d.on = "true";
						if ((r.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD)
							d.style.fontWeight = "bold";
						if ((r.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC)
							d.style.fontStyle = "italic";
						if ((r.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE)
							d.style.textDecoration = "underline";
						if (o == "top")
							s.style.top = h + r.fontSize / 2 + "px";
						else if (o == "bottom")
							s.style.top = h - r.fontSize / 3 + "px";
						s.appendChild(d)
					} else {
						s = document
								.createElementNS(mxConstants.NS_SVG, "text");
						...
						(r.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD
								&& s.setAttribute("font-weight", "bold");
						(r.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC
								&& s.setAttribute("font-style", "italic");
						(r.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE
								&& s.setAttribute("text-decoration", uline);
						g == "left" ? g = "start" : g == "center"
								? g = "middle"
								: g == "right" && (g = "end");
				...
				if (s != null) {
					...
					if (r.dashed) {
						...
						o = [];
						for (d = 0; d < r.dashpattern.length; d++)
							o.push(Math.max(1,
									Math.round(Number(r.dashpattern[d]) * g)));
						g = o.join(" ")
					}
					if (i || k)
						if (e) {
							...
							r.linejoin != null
									&& s.setAttribute("stroke-linejoin",
											r.linejoin);
							if (r.linecap != null) {
								d = r.linecap;
								d == "flat" && (d = "butt");
							...
							r.miterlimit != null
									&& s.setAttribute("stroke-miterlimit",
											r.miterlimit);
					...
					if (q && a.isShadow) {
						...
						if (e) {
							...
							p.setAttribute("offset", Math.round(d) + "px,"
											+ Math.round(o) + "px");
							...
							r.fill != null && (h || k) ? p.setAttribute("fill",
									mxConstants.SHADOWCOLOR) : p.setAttribute(
									"fill", "none");
							p
									.setAttribute(
											"transform",
					...
					if (h)
						e ? s.stroked = "false" : s.setAttribute("stroke",
								"none");
					else if (i)
						e ? s.filled = "false" : s.setAttribute("fill", "none");
					c.appendChild(s)
				}
				q && (q = false)
			} else if (g == "linecap")
				r.linecap = d.getAttribute("cap");
			else if (g == "linejoin")
				r.linejoin = d.getAttribute("join");
			else if (g == "miterlimit")
				r.miterlimit = d.getAttribute("limit");
			else if (g == "dashed")
				r.dashed = d.getAttribute("dashed") == "1";
			else if (g == "dashpattern") {
				d = d.getAttribute("pattern");
				if (d != null && d.length > 0)
					r.dashpattern = d.split(" ")
			} else if (g == "strokewidth") {
				r.strokeWidth = d.getAttribute("width") * v;
				if (e)
					r.strokeWidth = r.strokeWidth / f
			} else if (g == "strokecolor")
				r.stroke = d.getAttribute("color");
			else if (g == "fillcolor") {
				r.fill = d.getAttribute("color");
				r.fillColorAssigned = true
			} else if (g == "alpha")
				r.alpha = Number(d.getAttribute("alpha"));
			else if (g == "fontcolor")
				r.fontColor = d.getAttribute("color");
			else if (g == "fontsize")
				r.fontSize = Number(d.getAttribute("size")) * v;
			else if (g == "fontfamily")
				r.fontFamily = d.getAttribute("family");
			else if (g == "fontstyle")
				r.fontStyle = Number(d.getAttribute("style"))
		};
		if (!e) {
		...
		if (this.bgNode != null)
			for (d = this.bgNode.firstChild; d != null;) {
			...
			q = false;
		if (this.fgNode != null)
			for (d = this.fgNode.firstChild; d != null;) {
				d.nodeType == mxConstants.NODETYPE_ELEMENT && C.call(this, d);
				d = d.nextSibling
			}
	}
...
mxStencil.prototype.drawShape = function(a, b, c, d) {
	...
	if (d != null) {
		var e = mxUtils.getValue(b.style, mxConstants.STYLE_DIRECTION, null), c = this
				.computeAspect(b, c, e), e = Math.min(c.width, c.height), e = this.strokewidth == "inherit"
				? Number(mxUtils.getNumber(b.style,
						mxConstants.STYLE_STROKEWIDTH, 1))
						* b.view.scale
				: Number(this.strokewidth) * e;
		this.lastMoveY = this.lastMoveX = 0;
		a.setStrokeWidth(e);
		for (d = d.firstChild; d != null;) {
			d.nodeType == mxConstants.NODETYPE_ELEMENT
					&& this.drawNode(a, b, d, c);
			d = d.nextSibling
		}
		return true
	}
...
mxStencil.prototype.computeAspect = function(a, b, c) {
	...
	if (c = c == "north" || c == "south")
		var f = b.width / this.h0, e = b.height / this.w0, g = (b.width - b.height)
				/ 2, a = a + g, d = d - g;
	if (this.aspect == "fixed") {
		e = f = Math.min(e, f);
		if (c) {
...
mxStencil.prototype.drawNode = function(a, b, c, d) {
	var e = c.nodeName, f = d.x, g = d.y, h = d.width, k = d.height, i = Math
			.min(h, k);
	if (e == "save")
		a.save();
	else if (e == "restore")
		...
		a.quadTo(f + Number(c.getAttribute("x1")) * h, g
						+ Number(c.getAttribute("y1")) * k, this.lastMoveX,
				this.lastMoveY)
	} else if (e == "curve") {
		this.lastMoveX = f + Number(c.getAttribute("x3")) * h;
		this.lastMoveY = g + Number(c.getAttribute("y3")) * k;
		a.curveTo(f + Number(c.getAttribute("x1")) * h, g
						+ Number(c.getAttribute("y1")) * k, f
						+ Number(c.getAttribute("x2")) * h, g
						+ Number(c.getAttribute("y2")) * k, this.lastMoveX,
				this.lastMoveY)
	} else if (e == "arc")
		for (var b = Number(c.getAttribute("rx")) * h, i = Number(c
				.getAttribute("ry"))
				* k, d = Number(c.getAttribute("x-axis-rotation")), e = Number(c
				.getAttribute("large-arc-flag")), l = Number(c
				.getAttribute("sweep-flag")), f = f
				+ Number(c.getAttribute("x")) * h, g = g
				+ Number(c.getAttribute("y")) * k, c = mxUtils.arcToCurves(
				this.lastMoveX, this.lastMoveY, b, i, d, e, l, f, g), h = 0; h < c.length; h = h
				+ 6) {
		...
		a.rect(f + Number(c.getAttribute("x")) * h, g
						+ Number(c.getAttribute("y")) * k, Number(c
						.getAttribute("w"))
						* h, Number(c.getAttribute("h")) * k);
	else if (e == "roundrect") {
		...
		b = Number(b) / 100;
		b = Math.min(i * b, d * b);
		a.roundrect(f + Number(c.getAttribute("x")) * h, g
						+ Number(c.getAttribute("y")) * k, i, d, b, b)
	} else if (e == "ellipse")
		a.ellipse(f + Number(c.getAttribute("x")) * h, g
						+ Number(c.getAttribute("y")) * k, Number(c
						.getAttribute("w"))
						* h, Number(c.getAttribute("h")) * k);
	else if (e == "image") {
		b = this.evaluateAttribute(c, "src", b);
		a.image(f + Number(c.getAttribute("x")) * h, g
						+ Number(c.getAttribute("y")) * k, Number(c
						.getAttribute("w"))
						* h, Number(c.getAttribute("h")) * k, b, false, c
						.getAttribute("flipH") == "1",
				c.getAttribute("flipV") == "1")
	} else if (e == "text") {
		b = this.evaluateAttribute(c, "str", b);
		a.text(f + Number(c.getAttribute("x")) * h, g
						+ Number(c.getAttribute("y")) * k, 0, 0, b, c
						.getAttribute("align"), c.getAttribute("valign"), c
		...
		a.setStrokeWidth(Number(c.getAttribute("width")) * i);
	else if (e == "dashed")
		a.setDashed(c.getAttribute("dashed") == "1");
		...
		if (c != null) {
			...
			for (h = 0; h < c.length; h++)
				c[h].length > 0 && k.push(Number(c[h]) * i);
			c = k.join(" ");
			a.setDashPattern(c)
		}
	} else
...
mxStencilShape.prototype.redrawShape = function() {
	if (this.dialect != mxConstants.DIALECT_SVG) {
		...
		var a = Math.round(this.bounds.width), b = Math
		...
		if (this.node != c)
			this.node.innerHTML = c.outerHTML
	} else {
		for (; this.node.firstChild != null;)
...
var mxMarker = {
	...
	paintMarker : function(a, b, c, d, e, f, g, h, k, i, l, m) {
		...
		if (n != null) {
			...
			if (isNaN(p) || isNaN(c))
				return;
			var q = Math.max(1, Math.sqrt(p * p + c * c)), p = p * h / q, c = c
					* h / q, d = d.clone();
			if (o) {
				d.x = d.x - k;
				d.y = d.y - i
			...
			k = true;
			if (m[l ? mxConstants.STYLE_STARTFILL : mxConstants.STYLE_ENDFILL] == 0)
				k = false;
			if (o) {
				a.strokecolor = e;
	...
	var a = function(a, c, d, e, f, g, h, k, i) {
		...
		if (i) {
			a.path = "m"
					...
					+ Math.round(d.y)
					+ " l"
					+ Math.round(d.x - e - f / 2)
					+ " "
					+ Math.round(d.y - f + e / 2)
					+ (c != mxConstants.ARROW_CLASSIC ? "" : " "
							+ Math.round(d.x - e * 3 / 4) + " "
							+ Math.round(d.y - f * 3 / 4)) + " "
					+ Math.round(d.x + f / 2 - e) + " "
					+ Math.round(d.y - f - e / 2) + " x e";
...
mxMarker.markers[mxConstants.ARROW_OPEN] = function(a, b, c, d, e, f, g, h, k) {
	...
	e = e * (g + f);
	if (k) {
		a.path = "m" + Math.round(c.x - d - e / 2) + " "
				+ Math.round(c.y - e + d / 2) + " l" + Math.round(c.x) + " "
				+ Math.round(c.y) + " " + Math.round(c.x + e / 2 - d) + " "
				+ Math.round(c.y - e - d / 2) + " e nf";
		a.setAttribute("strokeweight", f * h + "px")
	} else {
		a.setAttribute("d", "M " + (c.x - d - e / 2) + " " + (c.y - e + d / 2)
						+ " L " + c.x + " " + c.y + " L " + (c.x + e / 2 - d)
						+ " " + (c.y - e - d / 2));
...
mxMarker.markers[mxConstants.ARROW_OVAL] = function(a, b, c, d, e, f, g, h, k) {
	...
	g = b / 2;
	if (k) {
		a.path = "m" + Math.round(c.x + g) + " " + Math.round(c.y) + " at "
				+ Math.round(c.x - g) + " " + Math.round(c.y - g) + " "
				+ Math.round(c.x + g) + " " + Math.round(c.y + g) + " "
				+ Math.round(c.x + g) + " " + Math.round(c.y) + " "
				+ Math.round(c.x + g) + " " + Math.round(c.y) + " x e";
		a.setAttribute("strokeweight", f * h + "px")
	} else {
		a.setAttribute("d", "M " + (c.x - g) + " " + c.y + " a " + g + " " + g
						+ " 0  1,1 " + b + " 0 a " + g + " " + g + " 0  1,1 "
						+ -b + " 0 z");
		a.setAttribute("stroke-width", f * h)
	}
...
(function() {
	var a = function(a, c, d, e, f, g, h, k, i) {
		var l = c == mxConstants.ARROW_DIAMOND ? 0.7071 : 0.9862, m = e * g * l, l = f
				* g * l, e = e * (h + g), f = f * (h + g);
		d.x = d.x - (m + e / 2);
		d.y = d.y - (l + f / 2);
		c = c == mxConstants.ARROW_DIAMOND ? 2 : 3.4;
		if (i) {
			a.path = "m" + Math.round(d.x + e / 2) + " "
					+ Math.round(d.y + f / 2) + " l" + Math.round(d.x - f / c)
					+ " " + Math.round(d.y + e / c) + " "
					+ Math.round(d.x - e / 2) + " " + Math.round(d.y - f / 2)
					+ " " + Math.round(d.x + f / c) + " "
					+ Math.round(d.y - e / c) + " x e";
			a.setAttribute("strokeweight", g * k + "px")
		} else {
			a.setAttribute("d", "M " + (d.x + e / 2) + " " + (d.y + f / 2)
							+ " L " + (d.x - f / c) + " " + (d.y + e / c)
							+ " L " + (d.x - e / 2) + " " + (d.y - f / 2)
							+ " L " + (d.x + f / c) + " " + (d.y - e / c)
							+ " z");
...
mxActor.prototype.redrawSvg = function() {
	...
	this.crisp && (this.rotation == null || this.rotation == 0)
...
mxDoubleEllipse.prototype.redrawVml = function() {
	...
	var a = Math.round((this.strokewidth + 3) * this.scale) * this.vmlScale, b = Math
			.round(this.bounds.width * this.vmlScale), c = Math
			.round(this.bounds.height * this.vmlScale);
...
mxRhombus.prototype.redrawVml = function() {
	...
	this.node.path = "m " + Math.round(0 + a / 2) + " 0 l " + (0 + a) + " "
			+ Math.round(0 + b / 2) + " l " + Math.round(0 + a / 2) + " "
			+ (0 + b) + " l 0 " + Math.round(0 + b / 2) + " x e"
};
...
mxRhombus.prototype.updateSvgNode = function(a) {
	var b = Math.round(Math.max(1, this.strokewidth * this.scale));
	a.setAttribute("stroke-width", b);
	var b = this.bounds.x, c = this.bounds.y, d = this.bounds.width, e = this.bounds.height, b = "M "
			+ Math.round(b + d / 2)
			+ " "
			+ Math.round(c)
			+ " L "
			...
			+ Math.round(c + e)
			+ " L "
			+ Math.round(b) + " " + Math.round(c + e / 2) + " Z ";
	a.setAttribute("d", b);
	this.updateSvgTransform(a, a == this.shadowNode);
	if (this.isDashed) {
		b = Math.max(1, Math.round(3 * this.scale * this.strokewidth));
...
mxPolyline.prototype.redrawVml = function() {
	if (this.points != null && this.points.length > 0 && this.points[0] != null) {
		...
		for (var a = 1; a < this.points.length; a++)
			this.bounds.add(new mxRectangle(this.points[a].x, this.points[a].y,
					0, 0))
	}
...
mxPolyline.prototype.redrawSvg = function() {
	...
	if (a != null && this.pipe != null) {
		...
		this.pipe.setAttribute("stroke-width", Math.round(Math.max(1,
...
mxArrow.prototype.redrawSvg = function() {
	...
	if (this.pipe != null && this.innerNode.getAttribute("d") != null) {
		...
		this.pipe.setAttribute("stroke-width", Math.round(this.strokewidth
						* this.scale)
						+ mxShape.prototype.SVG_STROKE_TOLERANCE)
	}
};
mxArrow.prototype.redrawPath = function(a, b, c) {
	...
	var b = this.spacing * this.scale, d = this.arrowWidth * this.scale, e = this.endSize
			* this.scale, f = this.points[0], c = this.points[this.points.length
			- 1], g = c.x - f.x, h = c.y - f.y, k = Math.sqrt(g * g + h * h), i = k
			- 2 * b - e, g = g / k, h = h / k, k = d * h / 3, d = -d * g / 3, e = f.x
			- k / 2 + b * g, f = f.y - d / 2 + b * h, l = e + k, m = f + d, n = l
			+ i * g, i = m + i * h, o = n + k, p = i + d, q = o - 3 * k, t = p
			- 3 * d;
	a.moveTo(e, f);
	a.lineTo(l, m);
	a.lineTo(n, i);
...
mxText.prototype.create = function(a) {
	var b = null;
	return b = this.dialect == mxConstants.DIALECT_SVG
			? this.createSvg()
			: this.dialect == mxConstants.DIALECT_STRICTHTML
					|| this.dialect == mxConstants.DIALECT_PREFERHTML
					|| !mxUtils.isVml(a) ? mxClient.IS_SVG && !mxClient.NO_FO
					? this.createForeignObject()
					: this.createHtml() : this.createVml()
};
mxText.prototype.updateBoundingBox = function() {
};
mxText.prototype.createForeignObject = function() {
	var a = document.createElementNS(mxConstants.NS_SVG, "g"), b = document
...
mxText.prototype.getOffset = function(a, b, c, d, e) {
	var f = (e = e != null ? e : this.horizontal) ? this.align : this.valign, g = e
			? this.valign
			: this.align, h = c - a, k = d - b;
	f == mxConstants.ALIGN_CENTER || f == mxConstants.ALIGN_MIDDLE ? h = Math
			.round(h / 2) : f == mxConstants.ALIGN_LEFT
			|| f === mxConstants.ALIGN_TOP ? h = e ? 0 : (c - d) / 2 : e
			|| (h = (c + d) / 2 - a);
	g == mxConstants.ALIGN_MIDDLE || g == mxConstants.ALIGN_CENTER ? k = Math
			.round(k / 2) : g == mxConstants.ALIGN_TOP
			|| g == mxConstants.ALIGN_LEFT ? k = e ? 0 : (d + c) / 2 - b : e
			|| (k = (d - c) / 2);
	return new mxPoint(h, k)
};
mxText.prototype.getSpacing = function(a) {
	var a = a != null ? a : this.horizontal, b = 0, c = 0, b = this.align == mxConstants.ALIGN_CENTER
			? (this.spacingLeft - this.spacingRight) / 2
			: this.align == mxConstants.ALIGN_RIGHT
					? -this.spacingRight
					: this.spacingLeft, c = this.valign == mxConstants.ALIGN_MIDDLE
...
mxText.prototype.createHtmlTable = function() {
	...
	var b = document.createElement("tbody"), c = document.createElement("tr"), d = document
			.createElement("td");
	if (document.documentMode >= 9)
		d.style.height = "100%";
	c.appendChild(d);
...
mxText.prototype.updateHtmlTable = function(a, b) {
	...
	if (mxUtils.isNode(this.value)) {
		...
		c.innerHTML = this.replaceLinefeeds ? this.value
				.replace(/\n/g, "<br/>") : this.value;
	...
	a.style.fontWeight = this.isStyleSet(mxConstants.FONT_BOLD)
			? "bold"
			: "normal";
	a.style.fontStyle = this.isStyleSet(mxConstants.FONT_ITALIC)
			? "italic"
			: "";
	a.style.textDecoration = this.isStyleSet(mxConstants.FONT_UNDERLINE)
			? "underline"
			: "";
	if (mxClient.IS_IE)
		this.isStyleSet(mxConstants.FONT_SHADOW)
				? c.style.filter = "Shadow(Color=#666666,Direction=135,Strength=%)"
				: c.style.removeAttribute("filter");
	c.style.textAlign = this.align == mxConstants.ALIGN_RIGHT
			? "right"
			: this.align == mxConstants.ALIGN_CENTER ? "center" : "left";
	c.style.verticalAlign = this.valign == mxConstants.ALIGN_BOTTOM
			? "bottom"
			: this.valign == mxConstants.ALIGN_MIDDLE ? "middle" : "top";
	c.style.background = this.value.length > 0 && this.background != null
			? this.background
			: "";
...
mxText.prototype.updateTableWidth = function(a) {
	...
	if (this.wrap && this.bounds.width > 0
		...
		var c = this.getTableSize(a), c = Math.min(c.width, (this.horizontal
						|| mxUtils.isVml(this.node)
						? this.bounds.width
						: this.bounds.height)
						/ this.scale);
...
mxText.prototype.redrawVml = function() {
	this.node.nodeName == "g" ? this.redrawForeignObject() : mxUtils
			.isVml(this.node) ? this.redrawTextbox() : this.redrawHtmlTable()
};
mxText.prototype.redrawTextbox = function() {
	...
	if (this.overflow != "fill") {
		var c = this.getTableSize(b), d = c.width * this.scale, c = c.height
				* this.scale, e = this.getOffset(this.bounds.width,
				this.bounds.height, d, c);
		if (!this.horizontal)
			b.style.filter = this.ieVerticalFilter;
		var f = this.getSpacing(), b = this.bounds.x - e.x + f.x * this.scale, e = this.bounds.y
				- e.y + f.y * this.scale, g = this.bounds.x, f = this.bounds.y, h = this.bounds.width, k = this.bounds.height;
		if (this.horizontal) {
			var i = Math.round(b - g), l = Math.round(e - f), m = Math.min(0,
					Math.round(g + h - b - d - 1)), n = Math.min(0, Math
							.round(f + k - e - c - 1));
			...
			if (this.align == mxConstants.ALIGN_CENTER)
				...
				this.align == mxConstants.ALIGN_LEFT ? i = k - d : n = k - d;
			if (this.valign == mxConstants.ALIGN_MIDDLE)
				m = l = (h - c) / 2;
			else
				this.valign == mxConstants.ALIGN_BOTTOM ? l = h - c : m = h - c;
		...
		if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
			...
			d = Math.round(g - b);
			c = Math.round(f - e);
			a.style.clip = "rect(" + c / this.scale + " "
					+ (d + this.bounds.width) / this.scale + " "
					+ (c + this.bounds.height) / this.scale + " " + d
					/ this.scale + ")"
		} else
			this.boundingBox = new mxRectangle(b, e, d, c)
	} else
		this.boundingBox = this.bounds.clone()
};
mxText.prototype.redrawHtmlTable = function() {
	if (!isNaN(this.bounds.x) && !isNaN(this.bounds.y)
		...
		if (!this.forceIgnoreStringSize
				&& !(this.overflow == "fill" || this.align == mxConstants.ALIGN_LEFT
						&& this.background == null && this.border == null)) {
			f = this.getTableSize(a);
			d = f.width / e;
			f = f.height / e
		}
		var e = this.getOffset(this.bounds.width / this.scale,
				this.bounds.height / this.scale, d, f, c || this.horizontal), g = this
				.getSpacing(c || this.horizontal), h = this.bounds.x
				/ this.scale - e.x + g.x, k = this.bounds.y / this.scale - e.y
				+ g.y, i = this.scale, g = 1, l = 0, m = 0;
		if (!this.horizontal)
			if (mxClient.IS_IE && mxClient.IS_SVG)
				a.style.msTransform = "rotate(" + this.verticalTextDegree
						+ "deg)";
				...
				a.style.WebkitTransform = "rotate(" + this.verticalTextDegree
						+ "deg)";
			else if (mxClient.IS_OT)
				a.style.OTransform = "rotate(" + this.verticalTextDegree
						+ "deg)";
			else if (mxClient.IS_MT) {
				a.style.MozTransform = "rotate(" + this.verticalTextDegree
						+ "deg)";
		...
		if (mxClient.IS_MT || c)
			if (mxClient.IS_MT) {
				a.style.MozTransform = a.style.MozTransform
						+ (" scale(" + this.scale + ")");
				g = 1 / this.scale
			} else {
				if (mxClient.IS_OT) {
					b.style.OTransform = "scale(" + this.scale + ")";
					a.style.borderWidth = Math.round(this.scale
							* parseInt(a.style.borderWidth))
							+ "px"
				}
			}
		else if (!c)
			if (document.documentMode >= 9)
				b.style.msTransform = "scale(" + this.scale + ")";
			else if (mxClient.IS_SF || mxClient.IS_GC)
				b.style.WebkitTransform = "scale(" + this.scale + ")";
			else {
				b.style.zoom = this.scale;
				if (a.style.borderWidth != "" && document.documentMode != 8)
					a.style.borderWidth = Math.round(this.scale
							* parseInt(a.style.borderWidth))
							+ "px";
		...
		if (this.overflow != "fill") {
			h = new mxRectangle(Math.round((h + l) * this.scale), Math
							.round((k + m) * this.scale), Math.round(d * i),
					Math.round(f * i));
			a.style.left = h.x + "px";
			a.style.top = h.y + "px";
			...
			if ((this.background != null || this.border != null)
				...
				k = this.replaceLinefeeds
						? this.value.replace(/\n/g, "<br/>")
						: this.value;
				b.innerHTML = '<div style="padding:' + this.labelPadding
						+ "px;background:" + b.style.background + ";border:"
						+ a.style.border + '">' + k + "</div>";
				b.style.padding = "0px";
				b.style.background = "";
				a.style.border = ""
			}
			if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
				...
				if (this.horizontal || c && !mxClient.IS_OT) {
					...
					a.style.clip = "rect(" + c + "px "
							+ (b + this.bounds.width * g) + "px "
							+ (c + this.bounds.height * g) + "px " + b + "px)"
				} else if (mxClient.IS_IE) {
					e = this.bounds.width;
					g = this.bounds.height;
					c = b = 0;
					this.align == mxConstants.ALIGN_LEFT
							? b = Math.max(0, d - g / this.scale) * this.scale
							: this.align == mxConstants.ALIGN_CENTER
									&& (b = Math.max(0, d - g / this.scale)
											* this.scale / 2);
					this.valign == mxConstants.ALIGN_BOTTOM
							? c = Math.max(0, f - e / this.scale) * this.scale
							: this.valign == mxConstants.ALIGN_MIDDLE
									&& (c = Math.max(0, f - e / this.scale)
											* this.scale / 2);
					a.style.clip = "rect(" + b + "px " + (c + e - 1) + "px "
							+ (b + g - 1) + "px " + c + "px)"
				} else {
			...
			if (document.documentMode >= 9 || mxClient.IS_SVG) {
				a.style.left = Math.round(this.bounds.x + this.scale / 2 + l)
						+ "px";
				a.style.top = Math.round(this.bounds.y + this.scale / 2 + m)
						+ "px";
				a.style.width = Math.round((this.bounds.width - this.scale)
						/ this.scale)
						+ "px";
				a.style.height = Math.round((this.bounds.height - this.scale)
						/ this.scale)
						+ "px"
			} else {
				i = document.documentMode == 8 ? this.scale : 1;
				a.style.left = Math.round(this.bounds.x + this.scale / 2)
						+ "px";
				a.style.top = Math.round(this.bounds.y + this.scale / 2) + "px";
				a.style.width = Math
						.round((this.bounds.width - this.scale) / i)
						+ "px";
				a.style.height = Math.round((this.bounds.height - this.scale)
						/ i)
						+ "px"
...
mxText.prototype.redrawForeignObject = function() {
	for (var a = this.node, b = a.firstChild; b == this.backgroundNode;)
		b = b.nextSibling;
	var c = b.firstChild;
	...
	if (mxClient.IS_SF) {
		...
		if (this.backgroundNode != null) {
			this.background != null ? this.backgroundNode.setAttribute("fill",
					this.background) : this.backgroundNode.setAttribute("fill",
					"none");
			this.border != null ? this.backgroundNode.setAttribute("stroke",
					this.border) : this.backgroundNode.setAttribute("stroke",
					"none")
		}
	}
	var e = "";
	if (this.overflow != "fill") {
		...
		b.style.height = "";
		b.style.clip = "";
		(this.wrap || !mxClient.IS_GC && !mxClient.IS_SF)
				&& document.body.appendChild(d);
		this.updateTableWidth(d);
		var f = this.getTableSize(d), g = f.width, f = f.height;
		d.parentNode != c && c.appendChild(d);
		var e = this.getSpacing(), h = this.bounds.x / this.scale + e.x, k = this.bounds.y
				/ this.scale + e.y, d = this.bounds.width / this.scale, c = this.bounds.height
				/ this.scale, i = this.getOffset(d, c, g, f);
		if (this.horizontal) {
			h = h - i.x;
			k = k - i.y;
			e = "scale(" + this.scale + ")"
		} else
			var e = "scale(" + this.scale + ") rotate("
					+ this.verticalTextDegree + " " + (h + g / 2) + " "
					+ (k + f / 2) + ")", l = this.getVerticalOffset(i), h = h
					+ l.x, k = k + l.y;
		e = e + (" translate(" + h + " " + k + ")");
		if (this.backgroundNode != null) {
		...
		if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
			...
			i = Math.max(0, i.y);
			if (this.horizontal)
				b.style.clip = "rect(" + i + "px," + (h + d) + "px," + (i + c)
						+ "px," + h + "px)";
			else {
				i = h = 0;
				this.align == mxConstants.ALIGN_RIGHT
				...
				this.valign == mxConstants.ALIGN_BOTTOM
						...
						: this.valign == mxConstants.ALIGN_MIDDLE
								&& (i = Math.max(0, f - d) / 2);
				b.style.clip = "rect(" + i + "px," + (h + c) + "px," + (i + d)
						+ "px," + h + "px)"
			}
			if (this.backgroundNode != null) {
			...
			this.boundingBox = this.horizontal ? new mxRectangle(
					h * this.scale, k * this.scale, g * this.scale, f
							* this.scale) : new mxRectangle(h * this.scale, k
							* this.scale, f * this.scale, g * this.scale)
		}
	} else {
		this.boundingBox = this.bounds.clone();
		e = this.scale;
		...
		e = "scale(" + e + ") translate(" + this.bounds.x / e + " "
				+ this.bounds.y / e + ")";
		if (!this.wrap)
			d.firstChild.firstChild.firstChild.style.whiteSpace = "nowrap"
	}
	a.setAttribute("transform", e)
};
mxText.prototype.createSvg = function() {
	var a = document.createElementNS(mxConstants.NS_SVG, "g"), b = this
			.isStyleSet(mxConstants.FONT_UNDERLINE) ? "underline" : "none", c = this
			.isStyleSet(mxConstants.FONT_BOLD) ? "bold" : "normal", d = this
			.isStyleSet(mxConstants.FONT_ITALIC) ? "italic" : null;
	...
	a.setAttribute("text-anchor", this.align == mxConstants.ALIGN_RIGHT
					? "end"
					: this.align == mxConstants.ALIGN_CENTER
							? "middle"
							: "start");
...
mxText.prototype.updateSvgValue = function(a) {
	if (this.currentValue != this.value) {
		for (; a.firstChild != null;)
			a.removeChild(a.firstChild);
		if (this.value != null) {
			var b = this.isStyleSet(mxConstants.FONT_UNDERLINE)
					? "underline"
					: "none", c = this.value.split("\n");
			this.textNodes = Array(c.length);
			for (var d = 0; d < c.length; d++)
				if (this.isEmptyString(c[d]))
					this.textNodes[d] = null;
				else {
...
mxText.prototype.redrawSvg = function() {
	if (this.node.nodeName == "foreignObject")
		...
		a <= 0 ? this.node.setAttribute("visibility", "hidden") : this.node
		...
		this.align == mxConstants.ALIGN_CENTER
				? b = b + d / 2
				: this.align == mxConstants.ALIGN_RIGHT && (b = b + d);
		var c = Math.round(a * 1.3), f = this.textNodes != null
				? this.textNodes.length
				: 0, g = this.bounds.x, h = this.bounds.y, g = g
				+ (this.align == mxConstants.ALIGN_RIGHT
						? (this.horizontal
								? this.bounds.width
								: this.bounds.height)
								...
								? this.spacingLeft
										* this.scale
										+ ((this.horizontal
												? this.bounds.width
												: this.bounds.height)
												- this.spacingLeft * this.scale - this.spacingRight
												* this.scale) / 2
								: this.spacingLeft * this.scale + 1), h = h
				+ (this.valign == mxConstants.ALIGN_BOTTOM
						? (this.horizontal
								? this.bounds.height
								: this.bounds.width)
								...
								? (this.spacingTop
										* this.scale
										+ (this.horizontal
												? this.bounds.height
												: this.bounds.width)
										- this.spacingBottom * this.scale - (f - 1.5)
										* c)
										/ 2
								: this.spacingTop * this.scale + c);
		if (this.overflow == "fill") {
			this.align == mxConstants.ALIGN_CENTER
					&& (g = Math.max(this.bounds.x + d / 2, g));
			h = Math.max(this.bounds.y + a, h);
			this.boundingBox = new mxRectangle(g - b, h - c,
					d + 4 * this.scale, e + 1 * this.scale);
			this.boundingBox.x = Math.min(this.bounds.x, this.boundingBox.x);
			this.boundingBox.y = Math.min(this.bounds.y, this.boundingBox.y);
			this.boundingBox.width = Math.max(this.bounds.width,
						...
						.setAttribute(
								...
								"rotate("
										...
										+ (this.bounds.y + this.bounds.height
												/ 2)
										+ ") translate("
										+ -((this.bounds.height - this.bounds.width) / 2)
										+ " "
										+ -((this.bounds.width - this.bounds.height) / 2)
										+ ")");
		this.redrawSvgTextNodes(g, h, c);
		if (this.value.length > 0 && this.backgroundNode != null
				&& this.node.firstChild != null) {
			this.node.firstChild != this.backgroundNode
					&& this.node.insertBefore(this.backgroundNode,
							this.node.firstChild);
			this.backgroundNode.setAttribute("x", this.boundingBox.x
							+ this.scale / 2 + 1 * this.scale);
			this.backgroundNode.setAttribute("y", this.boundingBox.y
							+ this.scale / 2 + 2 * this.scale
							- this.labelPadding);
			...
			this.backgroundNode.setAttribute("height", this.boundingBox.height
							- this.scale);
			this.backgroundNode.setAttribute("stroke-width", Math.round(Math
							.max(1, this.scale)))
		}
		if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
			this.boundingBox = this.bounds.clone();
...
mxText.prototype.redrawSvgTextNodes = function(a, b, c) {
	if (this.textNodes != null)
		for (var d = 0; d < this.textNodes.length; d++) {
...
mxText.prototype.getSvgClip = function(a, b, c, d, e) {
	var b = Math.round(b), c = Math.round(c), d = Math.round(d), e = Math
			.round(e), f = "mx-clip-" + b + "-" + c + "-" + d + "-" + e;
	if (this.clip != null && this.clip.ident == f)
		return this.clip;
	var g = 0, h;
	for (h = document.getElementById(f + "-" + g); h != null;) {
		if (h.ownerSVGElement == a)
			return h;
		g++;
		h = f + "-" + g;
...
mxLine.prototype.redrawVml = function() {
	...
	this.innerNode.path = this.direction == mxConstants.DIRECTION_NORTH
			|| this.direction == mxConstants.DIRECTION_SOUTH ? "m "
			+ Math.round(a / 2) + " 0 l " + Math.round(a / 2) + " "
			+ Math.round(b) + " e" : "m 0 " + Math.round(b / 2) + " l "
			+ Math.round(a) + " " + Math.round(b / 2) + " e"
};
...
mxLine.prototype.redrawSvg = function() {
	this.innerNode.setAttribute("stroke-width", Math.round(Math.max(1,
					this.strokewidth * this.scale)));
	if (this.bounds != null) {
		var a = this.bounds.x, b = this.bounds.y, c = this.bounds.width, d = this.bounds.height, e = null, e = this.direction == mxConstants.DIRECTION_NORTH
				|| this.direction == mxConstants.DIRECTION_SOUTH ? "M "
				+ Math.round(a + c / 2) + " " + Math.round(b) + " L "
				+ Math.round(a + c / 2) + " " + Math.round(b + d) : "M "
				+ Math.round(a) + " " + Math.round(b + d / 2) + " L "
				+ Math.round(a + c) + " " + Math.round(b + d / 2);
		...
		this.crisp ? this.innerNode.setAttribute("shape-rendering",
				"crispEdges") : this.innerNode
				.removeAttribute("shape-rendering");
		if (this.isDashed) {
			a = Math.max(1, Math.round(3 * this.scale * this.strokewidth));
			this.innerNode.setAttribute("stroke-dasharray", a + " " + a)
...
mxImageShape.prototype.apply = function(a) {
	...
	if (this.style != null) {
		...
		this.stroke = mxUtils.getValue(this.style,
				mxConstants.STYLE_IMAGE_BORDER);
		this.preserveImageAspect = mxUtils.getNumber(this.style,
				mxConstants.STYLE_IMAGE_ASPECT, 1) == 1;
		this.gradient = null
	}
};
mxImageShape.prototype.create = function() {
	...
	if (this.dialect == mxConstants.DIALECT_SVG) {
		...
		var a = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPH, 0) == 1, b = mxUtils
				.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPV, 0) == 1, c = this.image
				.toUpperCase();
		if (mxClient.IS_IE && !a && !b && c.substring(0, 6) == "MHTML:") {
			this.imageNode = document.createElement("DIV");
			this.imageNode.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader (src='"
					+ this.image + "', sizingMethod='scale')";
			a = document.createElement("DIV");
			this.configureHtmlShape(a)
		} else if (!mxClient.IS_IE || c.substring(0, 5) == "DATA:"
...
mxImageShape.prototype.updateAspect = function(a, b) {
	var c = Math.min(this.bounds.width / a, this.bounds.height / b), a = Math
			.max(0, Math.round(a * c)), b = Math.max(0, Math.round(b * c)), c = Math
			.max(0, Math.round((this.bounds.width - a) / 2)), d = Math.max(0,
			Math.round((this.bounds.height - b) / 2)), e = this.imageNode.style;
...
mxImageShape.prototype.scheduleUpdateAspect = function() {
	...
	a.onload = mxUtils.bind(this, function() {
				mxImageShape.prototype.updateAspect.call(this, a.width,
						a.height)
			});
	a.src = this.image
};
mxImageShape.prototype.redraw = function() {
	...
	if (this.imageNode != null && this.bounds != null) {
		var a = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPH, 0) == 1, b = mxUtils
				.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPV, 0) == 1;
		if (this.dialect == mxConstants.DIALECT_SVG) {
			var c = 1, d = 1, e = 0, f = 0;
			if (a) {
				c = -1;
			...
			this.imageNode.setAttribute("transform", (this.imageNode
							.getAttribute("transform") || "")
							+ " scale("
							+ c
							+ " "
			...
			if (this.imageNode.nodeName != "DIV") {
				this.imageNode.style.width = Math.max(0, Math
								.round(this.bounds.width))
						+ "px";
				this.imageNode.style.height = Math.max(0, Math
								.round(this.bounds.height))
						+ "px"
			}
			...
			if (a || b)
				if (mxUtils.isVml(this.imageNode))
					a && b
							...
							: this.imageNode.style.flip = a ? "x" : "y";
				else {
					c = this.imageNode.nodeName == "DIV"
					...
					if (this.imageNode.style.filter != c)
						this.imageNode.style.filter = c
				}
		}
	}
};
...
mxImageShape.prototype.redrawSvg = function() {
	...
	if (this.bg != null) {
		...
		this.fill != null ? this.bg.setAttribute("fill", this.fill) : this.bg
...
mxImageShape.prototype.configureSvgShape = function(a) {
	...
	this.imageNode != null
			&& (this.opacity != null ? this.imageNode.setAttribute("opacity",
					this.opacity / 100) : this.imageNode
...
mxLabel.prototype.createVml = function() {
	var a = document.createElement("v:group");
	this.rectNode = document.createElement(this.isRounded
			? "v:roundrect"
			: "v:rect");
	...
	if (this.image != null) {
		this.imageNode = this.createVmlImage(this.image, this.opaqueVmlImages
						? null
						: this.opacity);
		a.appendChild(this.imageNode)
	}
...
mxLabel.prototype.createSvg = function() {
	...
	if (this.indicatorImage != null) {
		...
		a.appendChild(this.indicatorImageNode);
		this.opacity != null
				&& this.indicatorImageNode.setAttribute("opacity", this.opacity
								/ 100)
	}
	if (this.image != null) {
		this.imageNode = document.createElementNS(mxConstants.NS_SVG, "image");
...
mxLabel.prototype.redraw = function() {
	this.updateBoundingBox();
	var a = this.dialect == mxConstants.DIALECT_SVG, b = mxUtils
			.isVml(this.node);
	if (a) {
		this.updateSvgShape(this.innerNode);
		this.shadowNode != null && this.updateSvgShape(this.shadowNode);
	...
	if (this.imageNode != null) {
		b = (this.style[mxConstants.STYLE_IMAGE_WIDTH] || this.imageSize)
				* this.scale;
		c = (this.style[mxConstants.STYLE_IMAGE_HEIGHT] || this.imageSize)
				* this.scale
	}
	var d = 0, e = 0, f = 0;
	if (this.indicator != null || this.indicatorImageNode != null) {
		d = (this.style[mxConstants.STYLE_INDICATOR_SPACING] || this.indicatorSpacing)
				* this.scale;
		e = (this.style[mxConstants.STYLE_INDICATOR_WIDTH] || this.indicatorSize)
				* this.scale;
		f = (this.style[mxConstants.STYLE_INDICATOR_HEIGHT] || this.indicatorSize)
				* this.scale
	}
	var g = this.style[mxConstants.STYLE_IMAGE_ALIGN], h = this.style[mxConstants.STYLE_IMAGE_VERTICAL_ALIGN], k = this.spacing
			* this.scale + 5, i = Math.max(b, e), l = c + d + f, m = a
			? this.bounds.x
			: 0, m = g == mxConstants.ALIGN_RIGHT ? m
			+ (this.bounds.width - i - k) : g == mxConstants.ALIGN_CENTER ? m
			+ (this.bounds.width - i) / 2 : m + k, g = a ? this.bounds.y : 0, g = h == mxConstants.ALIGN_BOTTOM
			? g + (this.bounds.height - l - k)
			: h == mxConstants.ALIGN_TOP ? g + k : g + (this.bounds.height - l)
					/ 2;
	if (this.imageNode != null)
		if (a) {
	...
	if (this.indicator != null) {
		this.indicator.bounds = new mxRectangle(m + (i - e) / 2, g + c + d, e,
				f);
...
mxCylinder.prototype.vmlNodes = mxCylinder.prototype.vmlNodes.concat([
...
mxCylinder.prototype.createSvg = function() {
	...
	this.stroke != null && this.stroke != mxConstants.NONE ? this.foreground
			.setAttribute("stroke", this.stroke) : this.foreground
			.setAttribute("stroke", "none");
	this.foreground.setAttribute("fill", "none");
	a.appendChild(this.foreground);
	if (this.addPipe) {
...
mxCylinder.prototype.redrawSvg = function() {
	...
	if (b.length > 0) {
		...
		if (this.pipe != null) {
			...
			this.pipe.setAttribute("stroke-width", a
							+ mxShape.prototype.SVG_STROKE_TOLERANCE);
			this.pipe.setAttribute("transform", this.innerNode
							.getAttribute("transform")
							|| "")
		}
	} else {
...
mxConnector.prototype.vmlNodes = mxConnector.prototype.vmlNodes
		.concat("shapeNode start end startStroke endStroke startFill endFill"
				.split(" "));
...
mxConnector.prototype.redrawVml = function() {
	if (this.node != null && this.points != null && this.bounds != null
			...
			&& !isNaN(this.bounds.width) && !isNaN(this.bounds.height)) {
		var a = Math.max(0, Math.round(this.bounds.width)), b = Math.max(0,
				Math.round(this.bounds.height)), c = a + "," + b, a = a + "px", b = b
				+ "px";
		if (this.start != null) {
			this.start.style.width = a;
			this.start.style.height = b;
			this.start.coordsize = c;
			var d = this.points[1], e = this.points[0], f = mxUtils.getNumber(
					this.style, mxConstants.STYLE_STARTSIZE,
		...
		if (this.end != null) {
			...
			d = this.points[a - 2];
			e = this.points[a - 1];
			f = mxUtils.getNumber(this.style, mxConstants.STYLE_ENDSIZE,
					mxConstants.DEFAULT_MARKERSIZE);
			this.endOffset = this.redrawMarker(this.end, this.endArrow, d, e,
					this.stroke, f)
		}
		this.updateVmlShape(this.node);
...
mxConnector.prototype.redrawSvg = function() {
	if (this.points != null && this.points[0] != null) {
		...
		if (this.start != null) {
			var b = this.points[1], c = this.points[0], d = mxUtils.getNumber(
					this.style, mxConstants.STYLE_STARTSIZE,
					mxConstants.DEFAULT_MARKERSIZE);
			this.startOffset = this.redrawMarker(this.start, this.startArrow,
					b, c, a, d);
			this.allowCrispMarkers && this.crisp ? this.start.setAttribute(
					"shape-rendering", "crispEdges") : this.start
					.removeAttribute("shape-rendering")
		}
		if (this.end != null) {
			...
			b = this.points[c - 2];
			c = this.points[c - 1];
			d = mxUtils.getNumber(this.style, mxConstants.STYLE_ENDSIZE,
					mxConstants.DEFAULT_MARKERSIZE);
			this.endOffset = this.redrawMarker(this.end, this.endArrow, b, c,
					a, d);
			this.allowCrispMarkers && this.crisp ? this.end.setAttribute(
					"shape-rendering", "crispEdges") : this.end
					.removeAttribute("shape-rendering")
		}
	}
	this.updateSvgShape(this.innerNode);
	...
	if (a != null) {
		...
		if (this.pipe != null) {
			this.pipe.setAttribute("d", this.innerNode.getAttribute("d"));
			this.pipe.setAttribute("stroke-width", b
							+ mxShape.prototype.SVG_STROKE_TOLERANCE)
		}
		if (this.shadowNode != null) {
			this.shadowNode.setAttribute("transform", this
...
mxConnector.prototype.createDashPattern = function(a) {
	...
	if (b != null) {
		for (var b = b.split(" "), c = [], d = 0; d < b.length; d++)
			b[d].length > 0 && c.push(Math.round(Number(b[d]) * a));
		return c.join(" ")
	}
	return null
};
mxConnector.prototype.redrawMarker = function(a, b, c, d, e, f) {
	return mxMarker.paintMarker(a, b, c, d, e, this.strokewidth, f, this.scale,
			this.bounds.x, this.bounds.y, this.start == a, this.style)
};
...
mxSwimlane.prototype.vmlNodes = mxSwimlane.prototype.vmlNodes.concat(["label",
		"content", "imageNode", "separator"]);
...
mxSwimlane.prototype.createHtml = function() {
	...
	mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true)
...
mxSwimlane.prototype.redrawHtml = function() {
	...
	if (mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true)) {
		...
		if (this.separator != null) {
			...
			this.separator.style.top = Math.round(this.startSize * this.scale)
					+ "px";
		...
		if (this.imageNode != null) {
			...
			this.imageNode.style.width = Math
					.round(this.imageSize * this.scale)
					+ "px";
			this.imageNode.style.height = Math.round(this.imageSize
					* this.scale)
					+ "px"
		}
	} else {
		...
		if (this.separator != null) {
			this.separator.style.left = Math.round(this.startSize * this.scale)
					+ "px";
...
mxSwimlane.prototype.createVml = function() {
	var a = document.createElement("v:group"), b = this.isRounded
			? "v:roundrect"
			: "v:rect";
...
mxSwimlane.prototype.redrawVml = function() {
	var a = Math.round(this.bounds.x), b = Math.round(this.bounds.y), c = Math
			.round(this.bounds.width), d = Math.round(this.bounds.height);
	this.updateVmlShape(this.node);
	...
	if (mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true)) {
		...
		if (this.separator != null)
			this.separator.path = "m " + (c - a) + " " + (e - b) + " l "
					+ (c - a) + " " + (d - b) + " e"
	} else {
		...
		if (this.separator != null)
			this.separator.path = "m " + (e - a) + " " + (d - b) + " l "
					+ (c - a) + " " + (d - b) + " e"
	}
	if (this.imageNode != null) {
...
mxSwimlane.prototype.redrawSvg = function() {
	...
	if (this.shadowNode != null) {
		this.updateSvgShape(this.shadowNode);
		b ? this.shadowNode.setAttribute("height", c) : this.shadowNode
				.setAttribute("width", c)
	}
	this.isRounded = a;
	...
	var d = this.crisp && mxClient.IS_IE ? 0.5 : 0, a = Math
			.round(this.bounds.x)
			+ d, d = Math.round(this.bounds.y) + d, e = Math
			.round(this.bounds.width), f = Math.round(this.bounds.height);
	if (b) {
		c = Math.min(c, f);
		this.innerNode.setAttribute("height", c);
		this.content.setAttribute("d", "M " + a + " " + (d + c) + " l 0 "
						+ (f - c) + " l " + e + " 0 l 0 " + (c - f));
		if (this.separator != null) {
		...
		this.content.setAttribute("d", "M " + (a + c) + " " + d + " l "
						+ (e - c) + " 0 l 0 " + f + " l " + (c - e) + " 0");
		if (this.separator != null) {
	...
	if (this.imageNode != null) {
		...
		this.imageNode
				.setAttribute("width", this.imageSize * this.scale + "px");
...
mxGraphLayout.prototype.getConstraint = function(a, b) {
	var c = this.graph.view.getState(b), c = c != null ? c.style : this.graph
			.getCellStyle(b);
				...
				if (d > 0)
					for (f = 0; f < d; f++) {
						var g = this.graph.model.getEdgeAt(a, f), h = this.graph.model
								.getTerminal(g, true) == a;
						(!b || h)
								&& this.traverse(this.graph.view
												.getVisibleTerminal(g, !h), b,
										c, g, e)
					}
			}
		}
...
mxGraphLayout.prototype.isEdgeIgnored = function(a) {
	...
	return !b.isEdge(a) || !this.graph.isCellVisible(a)
			|| b.getTerminal(a, true) == null
			|| b.getTerminal(a, false) == null
};
...
mxGraphLayout.prototype.setEdgePoints = function(a, b) {
	if (a != null) {
		...
		if (this.parent != null && b != null)
			for (var e = this.getParentOffset(c.getParent(a)), f = 0; f < b.length; f++) {
				b[f].x = b[f].x - e.x;
				b[f].y = b[f].y - e.y
			}
		d.points = b;
...
mxGraphLayout.prototype.getVertexBounds = function(a) {
	...
	if (this.useBoundingBox) {
		...
		if (c != null && c.text != null && c.text.boundingBox != null)
	...
	try {
		for (var c = a.length - 1; c >= 0; c--) {
			...
			if (this.graph.isSwimlane(d))
				var i = this.graph.getStartSize(d), h = i.width, k = i.height;
			if (f != null && g != null) {
				g = g.clone();
				g.x = g.x + f.x - b - h;
				g.y = g.y + f.y - b - k;
...
mxStackLayout.prototype.moveCell = function(a, b, c) {
	...
	if (a != null && e != null) {
		var g = 0, h = 0, k = d.getChildCount(e), b = f ? b : c, g = this.graph
				.getView().getState(e);
...
mxStackLayout.prototype.getParentSize = function(a) {
	...
	if (this.graph.container != null
			&& (c == null && b.isLayer(a) || a == this.graph.getView().currentRoot))
...
mxStackLayout.prototype.execute = function(a) {
	if (a != null) {
		var b = this.isHorizontal(), c = this.graph.getModel(), d = this
				.getParentSize(a), e = 0;
		d != null && (e = b ? d.height : d.width);
		var e = e - (2 * this.spacing + 2 * this.border), f = this.graph
				.isSwimlane(a) ? this.graph.getStartSize(a) : new mxRectangle, e = e
				- (b ? f.height : f.width), g = this.x0 + f.width + this.border, f = this.y0
				+ f.height + this.border;
		c.beginUpdate();
		try {
				...
				if (!this.isVertexIgnored(m) && this.isVertexMovable(m)) {
					...
					if (n != null) {
						...
						if (this.wrap != null
								&& k != null
								&& (b
										&& k.x + k.width + n.width + 2
												* this.spacing > this.wrap || !b
										&& k.y + k.height + n.height + 2
												* this.spacing > this.wrap)) {
							k = null;
							b ? f = f + (h + this.spacing) : g = g
									+ (h + this.spacing);
							h = 0
						}
						h = Math.max(h, b ? n.height : n.width);
						if (k != null)
							b ? n.x = k.x + k.width + this.spacing : n.y = k.y
									+ k.height + this.spacing;
						else if (!this.keepFirstLocation)
							b ? n.x = g : n.y = f;
						b ? n.y = f : n.x = g;
						if (this.fill && e > 0)
							b ? n.height = e : n.width = e;
						c.setGeometry(m, n);
						k = n
					}
				}
			}
			if (this.resizeParent && d != null && k != null
					&& !this.graph.isCellCollapsed(a)) {
				d = d.clone();
				b ? d.width = k.x + k.width + this.spacing : d.height = k.y
						+ k.height + this.spacing;
				c.setGeometry(a, d)
			} else if (this.resizeLast && d != null && k != null)
				b
						? k.width = d.width - k.x - this.spacing
						: k.height = d.height - k.y - this.spacing
		} finally {
			c.endUpdate()
		}
	}
...
mxPartitionLayout.prototype.execute = function(a) {
	var b = this.isHorizontal(), c = this.graph.getModel(), d = c
			.getGeometry(a);
	if (this.graph.container != null
			&& (d == null && c.isLayer(a) || a == this.graph.getView().currentRoot))
	...
	if (d != null) {
		...
		f = e.length;
		if (f > 0) {
			var k = this.border, i = this.border, l = b ? d.height : d.width, l = l
					- 2 * this.border, a = this.graph.isSwimlane(a)
					? this.graph.getStartSize(a)
					: new mxRectangle, l = l - (b ? a.height : a.width), k = k
					+ a.width, i = i + a.height, a = this.border + (f - 1)
					* this.spacing, d = b ? (d.width - k - a) / f : (d.height
					- i - a)
					/ f;
			if (d > 0) {
				c.beginUpdate();
...
mxCompactTreeLayout.prototype.isVertexIgnored = function(a) {
	return mxGraphLayout.prototype.isVertexIgnored.apply(this, arguments)
			|| this.graph.getConnections(a).length == 0
};
...
mxCompactTreeLayout.prototype.execute = function(a, b) {
	...
	var c = this.graph.getModel();
	if (b == null)
		if (this.graph.getEdges(a, c.getParent(a), this.invert, !this.invert,
				false).length > 0)
			b = a;
		else {
			...
			if (d.length > 0)
				for (var e = 0; e < d.length; e++)
					if (!this.isVertexIgnored(d[e])
							&& this.graph.getEdges(d[e], null, this.invert,
...
mxCompactTreeLayout.prototype.dfs = function(a, b, c) {
	...
	if (a != null && c[d] == null && !this.isVertexIgnored(a)) {
		c[d] = a;
		for (var e = this.createNode(a), d = this.graph.getModel(), f = null, a = this.graph
				.getEdges(a, b, this.invert, !this.invert, false, true), g = this.graph
				.getView(), h = 0; h < a.length; h++) {
			var k = a[h];
			if (!this.isEdgeIgnored(k)) {
				...
				var i = g.getState(k), k = i != null ? i
						.getVisibleTerminal(this.invert) : g
						.getVisibleTerminal(k, this.invert), i = this.dfs(k, b,
						c);
...
mxCompactTreeLayout.prototype.layout = function(a) {
	if (a != null) {
		...
		a.child != null ? this.attachParent(a, this.join(a)) : this
				.layoutLeaf(a)
	}
};
mxCompactTreeLayout.prototype.horizontalLayout = function(a, b, c, d) {
	...
	b = a.child;
	if (b != null)
		for (var d = this.horizontalLayout(b, a.x, a.y, d), c = a.y + b.offsetY, e = b.next; e != null;) {
...
mxCompactTreeLayout.prototype.merge = function(a, b) {
	for (var c = 0, d = 0, e = 0, f = a.lowerHead, g = b.upperHead; g != null
			&& f != null;) {
...
mxCompactTreeLayout.prototype.apply = function(a, b) {
	...
	if (d != null && e != null) {
		...
		b = b == null
				...
				: new mxRectangle(Math.min(b.x, e.x), Math.min(b.y, e.y), Math
								.max(b.x + b.width, e.x + e.width), Math.max(
...
mxCompactTreeLayout.prototype.processNodeOutgoing = function(a) {
	...
	for (var f = this.minEdgeJetty - this.prefVertEdgeOff, g = 0, h = this
		...
		for (var i = e[k].cell.cell, l = this.getVertexBounds(i), i = this.graph
				.getEdgesBetween(c, i, false), m = [], n = 0, o = 0, p = 0; p < i.length; p++) {
			if (this.horizontal) {
				n = h.x + h.width;
				o = h.y + b;
		...
		k < d / 2 ? f = f + this.prefVertEdgeOff : k > d / 2
				&& (f = f - this.prefVertEdgeOff);
		b = b + a;
		g = Math.max(g, f)
	}
};
...
WeightedCellSorter.prototype.compare = function(a, b) {
	return a != null && b != null ? b.weightedValue > a.weightedValue
			? 1
...
mxFastOrganicLayout.prototype.execute = function(a) {
	...
	var e = this.useInputOrigin
			? this.graph.view.getBounds(this.vertexArray)
			: null, f = this.vertexArray.length;
	this.indices = [];
	this.dispX = [];
	this.dispY = [];
	this.cellLocation = [];
	...
	this.radius = [];
	this.radiusSquared = [];
	if (this.forceConstant < 0.0010)
		this.forceConstant = 0.0010;
	...
	try {
		for (d = 0; d < f; d++) {
			...
			var o = this.graph.getConnections(this.vertexArray[d], a), c = this.graph
					.getOpposites(o, this.vertexArray[d]);
			this.neighbours[d] = [];
		...
		for (d = 0; d < this.vertexArray.length; d++) {
			...
			if (this.isVertexMovable(g)) {
				...
				if (k != null) {
					this.cellLocation[d][0] = this.cellLocation[d][0] - k.width
							/ 2;
					this.cellLocation[d][1] = this.cellLocation[d][1]
							- k.height / 2;
	...
	for (var a = 0; a < this.vertexArray.length; a++)
		for (var b = 0; b < this.neighbours[a].length; b++) {
			...
			if (a != c && this.isMoveable[a] && this.isMoveable[c]) {
				...
				if (f < this.minDistanceLimitSquared)
	...
	try {
		for (var c = 0, d = null, e = null, f = [], g = b.getChildCount(a), h = 0; h < g; h++) {
			...
			if (this.isVertexIgnored(k)) {
				...
				f.push(k);
				var i = this.getVertexBounds(k), d = d == null ? i.y : Math
						.min(d, i.y), e = e == null ? i.x : Math.min(e, i.x), c = Math
						.max(c, Math.max(i.width, i.height))
			}
		}
...
mxParallelEdgeLayout.prototype.getEdgeId = function(a) {
	var b = this.graph.getView(), c = b.getState(a), d = c != null ? c
			.getVisibleTerminal(true) : b.getVisibleTerminal(a, true), a = c != null
			? c.getVisibleTerminal(false)
			: b.getVisibleTerminal(a, false);
	if (d != null && a != null) {
...
mxParallelEdgeLayout.prototype.layout = function(a) {
	var b = a[0], c = this.graph.getModel(), d = c.getGeometry(c.getTerminal(b,
			true)), e = c.getGeometry(c.getTerminal(b, false));
	if (d == e)
		for (var b = d.x + d.width + this.spacing, c = d.y + d.height / 2, f = 0; f < a.length; f++) {
			this.route(a[f], b, c);
			b = b + this.spacing
		}
	else if (d != null && e != null)
		for (var b = d.x + d.width / 2, c = d.y + d.height / 2, f = e.x
				+ e.width / 2 - b, g = e.y + e.height / 2 - c, e = Math.sqrt(f
				* f + g * g), d = g * this.spacing / e, e = f * this.spacing
				/ e, b = b + f / 2 + d * (a.length - 1) / 2, c = c + g / 2 - e
				* (a.length - 1) / 2, f = 0; f < a.length; f++) {
			this.route(a[f], b, c);
			b = b - d;
			c = c + e
		}
...
mxGraphHierarchyNode.prototype.isAncestor = function(a) {
	if (a != null && this.hashCode != null && a.hashCode != null
...
mxGraphHierarchyEdge.prototype.getNextLayerConnectedCells = function(a) {
	if (this.nextLayerConnectedCells == null) {
		...
		for (var b = 0; b < this.temp.length; b++) {
			...
			b == this.temp.length - 1 ? this.nextLayerConnectedCells[b]
					.push(this.source) : this.nextLayerConnectedCells[b]
					.push(this)
		}
	}
	...
	for (a = 0; a < b.length; a++) {
		...
		for (e = 0; e < d.length; e++) {
			...
			if (g != null && g.length > 0) {
				var g = g[0], k = h.getView().getVisibleTerminal(g, false), k = mxCellPath
				...
				if (k != null && c[a] != k) {
					f.target = k;
					if (k.connectsAsTarget.length == 0)
						k.connectsAsTarget = [];
					mxUtils.indexOf(k.connectsAsTarget, f) < 0
							&& k.connectsAsTarget.push(f)
				}
			}
		}
		c[a].temp[0] = 1
	...
	for (var d = a.getGraph(), e = 0; e < b.length; e++) {
		...
		for (var g = 0; g < f.length; g++) {
			...
			if (h != b[e] && a.graph.model.isVertex(h) && !a.isVertexIgnored(h)) {
				var k = d.getEdgesBetween(b[e], h, false), i = d
						.getEdgesBetween(b[e], h, true), h = mxCellPath
						.create(k[0]);
				if (k != null && k.length > 0 && this.edgeMapper[h] == null
						&& i.length * 2 >= k.length) {
					...
					i.source = c[e];
					mxUtils.indexOf(c[e].connectsAsSource, i) < 0
							&& c[e].connectsAsSource.push(i)
				}
			}
		}
		c[e].temp[0] = 0
...
mxGraphHierarchyModel.prototype.initialRank = function() {
	...
	if (this.scanRanksFromSinks)
		for (var d in this.vertexMapper) {
			...
			(c.connectsAsSource == null || c.connectsAsSource.length == 0)
					&& a.push(c)
		}
	if (a.length == 0)
	...
	for (var e = a.slice(); a.length > 0;) {
		...
		for (b = 0; b < f.length; b++) {
			...
			if (i.temp[0] == 5270620) {
				...
				k = this.scanRanksFromSinks ? Math.max(k, i.temp[0] + 1) : Math
						.min(k, i.temp[0] - 1)
			} else {
				h = false;
				break
		...
		if (h) {
			c.temp[0] = k;
			this.maxRank = this.scanRanksFromSinks
					? Math.max(this.maxRank, k)
					: Math.min(this.maxRank, k);
			if (g != null)
...
mxMedianHybridCrossingReduction.prototype.calculateCrossings = function(a) {
	for (var b = a.ranks.length, c = 0, d = 1; d < b; d++)
		c = c + this.calculateRankCrossing(d, a);
	return c
};
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function(a, b) {
	...
	for (h = 0; h < d.length; h++)
		for (var k = d[h], i = k.getGeneralPurposeVariable(a), l = k
				.getPreviousLayerConnectedCells(a), k = 0; k < l.length; k++) {
...
mxMedianHybridCrossingReduction.prototype.transpose = function(a, b) {
	for (var c = true, d = 0; c && d++ < 10;)
		for (var e = a % 2 == 1 && d % 2 == 1, c = false, f = 0; f < b.ranks.length; f++) {
			for (var g = b.ranks[f], h = [], k = 0; k < g.length; k++) {
				var i = g[k], l = i.getGeneralPurposeVariable(f);
				l < 0 && (l = k);
				h[l] = i
			}
			for (var m = l = i = null, n = null, o = null, p = null, q = null, t = null, u = null, v = null, k = 0; k < g.length
					- 1; k++) {
				if (k == 0) {
					for (var u = h[k], i = u.getNextLayerConnectedCells(f), l = u
							.getPreviousLayerConnectedCells(f), o = [], p = [], w = 0; w < i.length; w++)
						o[w] = i[w].getGeneralPurposeVariable(f + 1);
					for (w = 0; w < l.length; w++)
						p[w] = l[w].getGeneralPurposeVariable(f - 1)
				} else {
					i = m;
					l = n;
					o = q;
				...
				for (w = 0; w < m.length; w++)
					q[w] = m[w].getGeneralPurposeVariable(f + 1);
				for (w = 0; w < n.length; w++)
					t[w] = n[w].getGeneralPurposeVariable(f - 1);
				for (var r = 0, s = 0, w = 0; w < o.length; w++)
				...
				if (s < r || s == r && e) {
					...
					u.setGeneralPurposeVariable(f, v
...
mxMedianHybridCrossingReduction.prototype.medianRank = function(a, b) {
	for (var c = this.nestedBestRanks[a].length, d = [], e = [], f = 0; f < c; f++) {
		...
		if (k != null && k.length != 0) {
			...
			e[g.getGeneralPurposeVariable(a)] = true
	}
...
MedianCellSorter.prototype.compare = function(a, b) {
	return a != null && b != null ? b.medianValue > a.medianValue
			? -1
...
mxMinimumCycleRemover.prototype.execute = function() {
	var a = this.layout.getModel(), b = {}, c = mxUtils.clone(a.vertexMapper,
			null, true), d = null;
	if (a.roots != null)
		for (var e = a.roots, d = [], f = 0; f < e.length; f++) {
...
mxCoordinateAssignment.prototype.minNode = function(a) {
	...
	for (f = 0; b.length > 0 && f <= a;) {
		var h = b.shift(), e = h.cell, k = h.weightedValue, i = parseInt(h.rankIndex), g = e
				.getNextLayerConnectedCells(k), l = e
				.getPreviousLayerConnectedCells(k), m = g.length, n = l.length, o = this
				.medianXValue(g, k + 1), p = this.medianXValue(l, k - 1), q = m
				+ n, t = e.getGeneralPurposeVariable(k), u = t;
		q > 0 && (u = (o * m + p * n) / q);
		m = false;
		if (u < t - 1)
			if (i == 0) {
	...
	for (f = 0; f < d.length; f++) {
		...
		for (var i = 0, k = -1E8, l = d[f].rankIndex - 1; l >= 0;) {
			...
			if (m != null) {
				var n = m.cell;
				if (m.visited) {
					k = n.getGeneralPurposeVariable(a) + n.width / 2
							+ this.intraCellSpacing + i + g.width / 2;
					l = -1
				} else {
		...
		for (l = d[f].rankIndex + 1; l < d.length;) {
			...
			if (m != null) {
				var o = m.cell;
				if (m.visited) {
					n = o.getGeneralPurposeVariable(a) - o.width / 2
							- this.intraCellSpacing - i - g.width / 2;
					l = d.length
				} else {
...
mxCoordinateAssignment.prototype.initialCoords = function(a, b) {
	...
	for (var c = this.widestRank; c >= 0; c--)
		c < b.maxRank && this.rankCoordinates(c, a, b);
	for (c = this.widestRank + 1; c <= b.maxRank; c++)
		c > 0 && this.rankCoordinates(c, a, b)
};
mxCoordinateAssignment.prototype.rankCoordinates = function(a, b, c) {
	for (var b = c.ranks[a], c = 0, d = this.initialX
			+ (this.widestRankValue - this.rankWidths[a]) / 2, e = false, f = 0; f < b.length; f++) {
		var g = b[f];
		if (g.isVertex()) {
			...
			h = 1;
			g.edges != null ? h = g.edges.length : mxLog
					.warn("edge.edges is null");
	...
	for (var e = b.maxRank; e >= 0; e--) {
		for (var f = 0, g = b.ranks[e], h = this.initialX, k = false, i = 0; i < g.length; i++) {
			...
			if (l.isVertex()) {
				...
				m = 1;
				l.edges != null ? m = l.edges.length : mxLog
						.warn("edge.edges is null");
...
mxCoordinateAssignment.prototype.minPath = function(a, b) {
	...
	for (d in c) {
		...
		if (!(e.maxRank - e.minRank - 1 < 1)) {
			for (var f = e.getGeneralPurposeVariable(e.minRank + 1), g = true, h = 0, k = e.minRank
					+ 2; k < e.maxRank; k++) {
...
mxCoordinateAssignment.prototype.setCellLocations = function(a, b) {
	...
	(this.edgeStyle == mxHierarchicalEdgeStyle.ORTHOGONAL || this.edgeStyle == mxHierarchicalEdgeStyle.POLYLINE)
...
mxCoordinateAssignment.prototype.localEdgeProcessing = function(a) {
	for (var b = 0; b < a.ranks.length; b++)
		for (var c = a.ranks[b], d = 0; d < c.length; d++) {
			var e = c[d];
			if (e.isVertex())
				for (var f = e.getPreviousLayerConnectedCells(b), g = b - 1, h = 0; h < 2; h++) {
					if (g > -1 && g < a.ranks.length && f != null
							&& f.length > 0) {
						...
						if (e.width > (f + 1) * this.prefHozEdgeSep + 2
								* this.prefHozEdgeSep) {
						...
						for (i = n = 0; i < g.length; i++) {
							...
							i < f / 2 ? m = m + this.prefVertEdgeOff : i > f
									/ 2
									&& (m = m - this.prefVertEdgeOff);
							for (q = 0; q < o; q++) {
								p[q * 4 + h * 2] = l;
								l = l + k;
								p[q * 4 + h * 2 + 1] = m
...
mxCoordinateAssignment.prototype.setEdgePosition = function(a) {
	...
	if (a.temp[0] != 101207) {
		...
		for (var e = 0, f = this.jettyPositions[mxCellPath.create(a.edges[0])], g = a.isReversed
				? a.target.cell
				: a.source.cell, h = 0; h < a.edges.length; h++) {
			var k = a.edges[h], i = this.layout.graph.view.getVisibleTerminal(
					k, true), l = [], m = a.isReversed;
			i != g && (m = !m);
			if (f != null) {
				var i = m ? 2 : 0, n = m
						? this.rankTopY[d]
						: this.rankBottomY[c], o = f[e * 4 + 1 + i];
				m && (o = -o);
				n = n + o;
				i = f[e * 4 + i];
				this.orientation == mxConstants.DIRECTION_NORTH
						|| this.orientation == mxConstants.DIRECTION_SOUTH ? l
						.push(new mxPoint(i, n)) : l.push(new mxPoint(n, i))
			}
			...
			for (; a.maxRank != a.minRank && p != i; p = p + n) {
				var q = a.x[p] + b, t = (this.rankTopY[o] + this.rankBottomY[o
						+ 1])
						/ 2, u = (this.rankTopY[o - 1] + this.rankBottomY[o])
						/ 2;
				if (m)
					var v = t, t = u, u = v;
				if (this.orientation == mxConstants.DIRECTION_NORTH
			...
			b = b == 0 ? this.parallelEdgeSpacing : b > 0 ? -b : -b
...
mxHierarchicalLayout.prototype.execute = function(a, b) {
	...
	if (!(b == null && a == null)) {
		if (b != null && a != null) {
			...
			this.roots = b == null ? this.findTreeRoots(a) : b;
		if (this.roots != null) {
		...
		for (var c = this.graph.model, d = c.getChildCount(a), e = null, f = 0, g = 0; g < d; g++) {
			...
			for (var i = 0; i < k.length; i++) {
				...
				if (c.isVertex(h) && this.graph.isCellVisible(h)) {
					for (var l = this.getEdges(h), m = 0, n = 0, o = 0; o < l.length; o++)
						this.graph.view.getVisibleTerminal(l[o], true) == h
								? m++
								: n++;
					n == 0 && m > 0 && b.push(h);
					l = n - m;
...
mxHierarchicalLayout.prototype.getEdges = function(a) {
	for (var b = this.graph.model, c = [], d = this.graph.isCellCollapsed(a), e = b
			.getChildCount(a), f = 0; f < e; f++) {
		var g = b.getChildAt(a, f);
		if (d || !this.graph.isCellVisible(g))
			c = c.concat(b.getEdges(g, true, true))
	}
	c = c.concat(b.getEdges(a, true, true));
	b = [];
	for (f = 0; f < c.length; f++) {
		e = this.graph.view.getState(c[f]);
		d = e != null ? e.getVisibleTerminal(true) : this.graph.view
				.getVisibleTerminal(c[f], true);
		e = e != null ? e.getVisibleTerminal(false) : this.graph.view
				.getVisibleTerminal(c[f], false);
		(d == e || d != e
				&& (e == a
						&& (this.parent == null || this.graph.isValidAncestor(
								d, this.parent, this.traverseAncestors)) || d == a
						&& (this.parent == null || this.graph.isValidAncestor(
								e, this.parent, this.traverseAncestors))))
				&& b.push(c[f])
	}
	return b
};
mxHierarchicalLayout.prototype.run = function(a) {
		...
		if (g) {
			...
			for (g = {}; h.length > 0;) {
				...
				if (g[l] == null) {
					g[l] = i;
					if (this.fixRoots)
						for (var m = this.graph.getIncomingEdges(i, a), l = 0; l < m.length; l++)
							k.push(m[l]);
	...
	for (f = h = 0; f < b.length; f++) {
		...
		for (n in g)
			m.push(g[n]);
		this.model = new mxGraphHierarchyModel(this, m, this.roots, a,
				this.deterministic, this.tightenToSource, this.layoutFromSinks);
		this.cycleStage(a);
		this.layeringStage();
...
mxGraphModel.prototype.updateEdgeParents = function(a, b) {
	for (var b = b || this.getRoot(a), c = this.getChildCount(a), d = 0; d < c; d++)
		this.updateEdgeParents(this.getChildAt(a, d), b);
	for (var e = this.getEdgeCount(a), c = [], d = 0; d < e; d++)
...
mxGraphModel.prototype.updateEdgeParent = function(a, b) {
	for (var c = this.getTerminal(a, true), d = this.getTerminal(a, false), e = null; c != null
			&& !this.isEdge(c) && c.geometry != null && c.geometry.relative;)
		c = this.getParent(c);
	for (; d != null && !this.isEdge(d) && d.geometry != null
			&& d.geometry.relative;)
		d = this.getParent(d);
	if (this.isAncestor(b, c) && this.isAncestor(b, d)) {
		...
		if (e != null
			...
			if (c != null) {
				var f = this.getOrigin(this.getParent(a)), g = this
						.getOrigin(e), d = g.x - f.x, f = g.y - f.y, c = c
						.clone();
				c.translate(-d, -f);
...
mxGraphModel.prototype.getNearestCommonAncestor = function(a, b) {
	if (a != null && b != null) {
		...
		if (c != null && c.length > 0) {
			...
			for (; d != null;) {
				f = this.getParent(d);
				if (c.indexOf(e + mxCellPath.PATH_SEPARATOR) == 0 && f != null)
					return d;
...
mxGraphModel.prototype.remove = function(a) {
	a == this.root ? this.setRoot(null) : this.getParent(a) != null
...
mxGraphModel.prototype.parentForCellChanged = function(a, b, c) {
	...
	if (b != null)
		(b != d || d.getIndex(a) != c) && b.insert(a, c);
	else if (d != null) {
		c = d.getIndex(a);
		d.remove(c)
	}
	!this.contains(d) && b != null ? this.cellAdded(a) : b == null
			&& this.cellRemoved(a);
	return d
};
...
mxGraphModel.prototype.getChildCells = function(a, b, c) {
	for (var b = b != null ? b : false, c = c != null ? c : false, d = this
			.getChildCount(a), e = [], f = 0; f < d; f++) {
...
mxGraphModel.prototype.getEdges = function(a, b, c, d) {
	for (var b = b != null ? b : true, c = c != null ? c : true, d = d != null
			? d
			: true, e = this.getEdgeCount(a), f = [], g = 0; g < e; g++) {
		var h = this.getEdgeAt(a, g), k = this.getTerminal(h, true), i = this
				.getTerminal(h, false);
...
mxGraphModel.prototype.getEdgesBetween = function(a, b, c) {
	var c = c != null ? c : false, d = this.getEdgeCount(a), e = this
			.getEdgeCount(b), f = a, g = d;
	if (e < d) {
		g = e;
		f = b
	}
	d = [];
	for (e = 0; e < g; e++) {
		var h = this.getEdgeAt(f, e), k = this.getTerminal(h, true), i = this
				.getTerminal(h, false), l = i == a && k == b;
...
mxGraphModel.prototype.getOpposites = function(a, b, c, d) {
	...
	if (a != null)
		for (var f = 0; f < a.length; f++) {
			var g = this.getTerminal(a[f], true), h = this.getTerminal(a[f],
					false);
			g == b && h != null && h != b && d ? e.push(h) : h == b
					&& (g != null && g != b && c) && e.push(g)
		}
	return e
};
	...
	try {
		for (var e = a.getChildCount(), f = 0; f < e; f++) {
			...
			if (typeof g.getId == "function") {
				var h = g.getId(), k = h != null && (!this.isEdge(g) || !c)
						? this.getCell(h)
						: null;
				if (k == null) {
					var i = g.clone();
...
mxGraphModel.prototype.cloneCells = function(a, b) {
	for (var c = {}, d = [], e = 0; e < a.length; e++)
		a[e] != null ? d.push(this.cloneCellImpl(a[e], c, b)) : d.push(null);
	for (e = 0; e < d.length; e++)
		d[e] != null && this.restoreClone(d[e], a[e], c);
	return d
};
mxGraphModel.prototype.cloneCellImpl = function(a, b, c) {
	...
	if (c)
		for (var c = this.getChildCount(a), e = 0; e < c; e++) {
...
mxChildChange.prototype.execute = function() {
	var a = this.model.getParent(this.child), b = a != null ? a
...
mxChildChange.prototype.connect = function(a, b) {
	var b = b != null ? b : true, c = a.getTerminal(true), d = a
			.getTerminal(false);
	c != null
			&& (b ? this.model.terminalForCellChanged(a, c, true) : this.model
					.terminalForCellChanged(a, null, true));
	d != null
			&& (b ? this.model.terminalForCellChanged(a, d, false) : this.model
					.terminalForCellChanged(a, null, false));
...
mxCell.prototype.insertEdge = function(a, b) {
	if (a != null) {
		...
		if (this.edges == null || a.getTerminal(!b) != this
				|| mxUtils.indexOf(this.edges, a) < 0) {
			if (this.edges == null)
				this.edges = [];
			this.edges.push(a)
		}
...
mxCell.prototype.getAttribute = function(a, b) {
	var c = this.getValue();
	return (c != null && c.nodeType == mxConstants.NODETYPE_ELEMENT ? c
			.getAttribute(a) : null)
			|| b
};
mxCell.prototype.setAttribute = function(a, b) {
	var c = this.getValue();
	c != null && c.nodeType == mxConstants.NODETYPE_ELEMENT
			&& c.setAttribute(a, b)
};
...
mxCell.prototype.cloneValue = function() {
	...
	a != null
			&& (typeof a.clone == "function"
					? a = a.clone()
					: isNaN(a.nodeType) || (a = a.cloneNode(true)));
	return a
};
...
var mxCellPath = {
	...
	RectanglePerimeter : function(a, b, c, d) {
		var b = a.getCenterX(), e = a.getCenterY(), f = Math.atan2(c.y - e, c.x
						- b), g = new mxPoint(0, 0), h = Math.PI, k = Math.PI
				/ 2 - f, i = Math.atan2(a.height, a.width);
		if (f < -h + i || f > h - i) {
			g.x = a.x;
		...
		if (d) {
			if (c.x >= a.x && c.x <= a.x + a.width)
				g.x = c.x;
			else if (c.y >= a.y && c.y <= a.y + a.height)
				g.y = c.y;
			if (c.x < a.x)
				g.x = a.x;
			else if (c.x > a.x + a.width)
				g.x = a.x + a.width;
			if (c.y < a.y)
				g.y = a.y;
			else if (c.y > a.y + a.height)
				g.y = a.y + a.height
		}
		return g
	},
	EllipsePerimeter : function(a, b, c, d) {
		var e = a.x, f = a.y, g = a.width / 2, h = a.height / 2, k = e + g, i = f
				+ h, b = c.x, c = c.y, l = parseInt(b - k), m = parseInt(c - i);
		if (l == 0 && m != 0)
			return new mxPoint(k, i + h * m / Math.abs(m));
		if (l == 0 && m == 0)
	...
	RhombusPerimeter : function(a, b, c, d) {
		var b = a.x, e = a.y, f = a.width, a = a.height, g = b + f / 2, h = e
				+ a / 2, k = c.x, c = c.y;
		if (g == k)
		...
		return k < g ? c < h
				? mxUtils.intersection(k, c, i, l, g, e, b, h)
				: mxUtils.intersection(k, c, i, l, g, e + a, b, h) : c < h
				? mxUtils.intersection(k, c, i, l, g, e, b + f, h)
				: mxUtils.intersection(k, c, i, l, g, e + a, b + f, h)
	},
	TrianglePerimeter : function(a, b, c, d) {
		var b = b != null ? b.style[mxConstants.STYLE_DIRECTION] : null, e = b == mxConstants.DIRECTION_NORTH
				|| b == mxConstants.DIRECTION_SOUTH, f = a.x, g = a.y, h = a.width, a = a.height, k = f
				+ h / 2, i = g + a / 2, l = new mxPoint(f, g), m = new mxPoint(
				f + h, i), n = new mxPoint(f, g + a);
		...
		var o = c.x - k, p = c.y - i, o = e ? Math.atan2(o, p) : Math.atan2(p,
				o), q = e ? Math.atan2(h, a) : Math.atan2(a, h), p = false, p = b == mxConstants.DIRECTION_NORTH
				|| b == mxConstants.DIRECTION_WEST
				? o > -q && o < q
				: o < -Math.PI + q || o > Math.PI - q, q = null;
		if (p)
			q = d
					&& (e && c.x >= l.x && c.x <= n.x || !e && c.y >= l.y
							&& c.y <= n.y) ? e
					? new mxPoint(c.x, l.y)
					: new mxPoint(l.x, c.y) : b == mxConstants.DIRECTION_NORTH
					? new mxPoint(f + h / 2 + a * Math.tan(o) / 2, g + a)
					: b == mxConstants.DIRECTION_SOUTH
							? new mxPoint(f + h / 2 - a * Math.tan(o) / 2, g)
							: b == mxConstants.DIRECTION_WEST ? new mxPoint(f
											+ h, g + a / 2 + h * Math.tan(o)
											/ 2) : new mxPoint(f, g + a / 2 - h
											* Math.tan(o) / 2);
		else {
			if (d) {
				d = new mxPoint(k, i);
			...
			q = e && c.x <= f + h / 2 || !e && c.y <= g + a / 2 ? mxUtils
					.intersection(c.x, c.y, k, i, l.x, l.y, m.x, m.y) : mxUtils
					.intersection(c.x, c.y, k, i, m.x, m.y, n.x, n.y)
		}
...
mxPrintPreview.prototype.open = function(a) {
	...
	try {
		...
		if (this.wnd == null) {
			...
			f.width = f.width / h;
			f.height = f.height / h;
			var i = this.pageFormat.width - this.border * 2, l = this.pageFormat.height
					- this.border * 2, m = Math.max(1, Math
							.ceil((f.width + this.x0) / i)), n = Math.max(1,
					Math.ceil((f.height + this.y0) / l));
			this.pageCount = m * n;
			...
			for (a = 0; a < n; a++)
				for (var r = a * l / this.scale - this.y0 / this.scale
						+ (f.y - k.y * g) / g, e = 0; e < m; e++) {
					if (this.wnd == null)
						return null;
					h = a * m + e + 1;
					c = this.renderPage(this.pageFormat.width,
							this.pageFormat.height, -(e * i / this.scale
									- this.x0 / this.scale + (f.x - k.x * g)
									/ g), -r, this.scale, h);
...
mxPrintPreview.prototype.renderPage = function(a, b, c, d, e) {
	...
	try {
		...
		var i = h.getCanvas(), l = h.getBackgroundPane(), m = h.getDrawPane(), n = h
				.getOverlayPane();
		this.graph.dialect == mxConstants.DIALECT_SVG
				? h.createSvg()
				: this.graph.dialect == mxConstants.DIALECT_VML
						? h.createVml()
						: h.createHtml();
		...
		a = null;
		try {
			var t = [this.graph.getModel().getRoot()], a = new mxTemporaryCellStates(
					h, e, t)
		} finally {
			if (mxClient.IS_IE)
				h.overlayPane.innerHTML = "";
			else
				for (var u = g.firstChild; u != null;) {
					...
					if (w == "svg") {
						...
						u.style.cursor != "default" && w != "table"
...
mxStylesheet.prototype.getCellStyle = function(a, b) {
	var c = b;
	if (a != null && a.length > 0)
		for (var d = a.split(";"), c = c != null && a.charAt(0) != ";"
				? mxUtils.clone(c)
				: {}, e = 0; e < d.length; e++) {
			var f = d[e], g = f.indexOf("=");
			if (g >= 0) {
				var h = f.substring(0, g), f = f.substring(g + 1);
				f == mxConstants.NONE ? delete c[h] : c[h] = mxUtils
						.isNumeric(f) ? parseFloat(f) : f
			} else {
				f = this.styles[f];
				if (f != null)
					for (h in f)
...
mxCellState.prototype.clone = function() {
	...
	if (this.boundingBox != null)
		a.boundingBox = this.boundingBox.clone();
...
mxGraphSelectionModel.prototype.changeSelection = function(a, b) {
	if (a != null && a.length > 0 && a[0] != null || b != null && b.length > 0
			&& b[0] != null) {
	...
	if (c != null) {
		...
		var d = this.graph.getView().scale, d = mxUtils.getValue(c.style,
				...
				* d, e = mxUtils.getValue(c.style,
				...
				.getValue(c.style, mxConstants.STYLE_FONTCOLOR, "black"), g = this.graph.model
				.isEdge(c.cell) ? mxConstants.ALIGN_LEFT : mxUtils.getValue(
				c.style, mxConstants.STYLE_ALIGN, mxConstants.ALIGN_LEFT), h = (mxUtils
				.getValue(c.style, mxConstants.STYLE_FONTSTYLE, 0) & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD;
...
mxCellEditor.prototype.getMinimumSize = function(a) {
	...
	return new mxRectangle(0, 0, a.text == null ? 30 : a.text.size * b + 20,
...
mxCellEditor.prototype.getEditorBounds = function(a) {
	var b = this.graph.getModel().isEdge(a.cell), c = this.graph.getView().scale, d = this
			...
			|| 2)
			* c, g = parseInt(a.style[mxConstants.STYLE_SPACING_TOP] || 0) * c
			+ f, h = parseInt(a.style[mxConstants.STYLE_SPACING_RIGHT] || 0)
			* c + f, k = parseInt(a.style[mxConstants.STYLE_SPACING_BOTTOM]
			|| 0)
			* c + f, c = parseInt(a.style[mxConstants.STYLE_SPACING_LEFT] || 0)
			* c + f, h = new mxRectangle(a.x, a.y,
			Math.max(e, a.width - c - h), Math.max(d, a.height - g - k));
	if (b) {
		h.x = a.absoluteOffset.x;
		h.y = a.absoluteOffset.y;
		if (a.text != null && a.text.boundingBox != null) {
			if (a.text.boundingBox.x > 0)
				h.x = a.text.boundingBox.x;
			if (a.text.boundingBox.y > 0)
	...
	if (this.graph.getModel().isVertex(a.cell)) {
		...
		if (b == mxConstants.ALIGN_TOP)
			h.y = h.y - a.height;
		else if (b == mxConstants.ALIGN_BOTTOM)
			h.y = h.y + a.height
	}
	return h
};
...
mxCellRenderer.prototype.initialize = function(a, b) {
	...
	if (a.view.graph.container != null && a.shape == null
			&& a.cell != a.view.currentRoot
			&& (c.isVertex(a.cell) || c.isEdge(a.cell))) {
		this.createShape(a);
		if (a.shape != null && (b == null || b)) {
			this.initializeShape(a);
			if (a.view.graph.ordered || c.isEdge(a.cell))
				a.invalidOrder = true;
			else if (a.view.graph.keepEdgesInForeground
					&& this.firstEdge != null)
				this.firstEdge.parentNode == a.shape.node.parentNode ? this
						.insertState(a, this.firstEdge) : this.firstEdge = null;
...
mxCellRenderer.prototype.getPreviousStateInContainer = function(a, b) {
	for (var c = null, d = a.view.graph, e = d.getModel(), f = a.cell, g = e
			.getParent(f); g != null && c == null;) {
...
mxCellRenderer.prototype.findPreviousStateInContainer = function(a, b, c, d) {
	for (var e = null, f = a.getModel(), c = c != null ? b.getIndex(c) - 1 : f
			.getChildCount(b)
			- 1; c >= 0 && e == null; c--)
		e = this.findPreviousStateInContainer(a, f.getChildAt(b, c), null, d);
	if (e == null) {
		e = a.view.getState(b);
		if (e != null
				&& (e.shape == null || e.shape.node == null || e.shape.node.parentNode != d))
			e = null
	}
	return e
};
mxCellRenderer.prototype.order = function(a) {
	...
	if (c != null) {
		d = c.shape.node;
		if (c.text != null && c.text.node != null
				&& c.text.node.parentNode == b)
			d = c.text.node;
		d = d.nextSibling
	}
...
mxCellRenderer.prototype.orderEdge = function(a) {
	...
	if (b.graph.keepEdgesInForeground) {
		if (this.firstEdge == null || this.firstEdge.parentNode == null
				|| this.firstEdge.parentNode != a.shape.node.parentNode)
			this.firstEdge = a.shape.node
	} else if (b.graph.keepEdgesInBackground) {
		var d = a.shape.node, e = d.parentNode, c = c.getParent(a.cell), b = b
				.getState(c), e = b != null && b.shape != null
				&& b.shape.node != null
				? b.shape.node.nextSibling
				: e.firstChild;
...
mxCellRenderer.prototype.insertState = function(a, b) {
	...
	a.text != null
			&& (a.text.node != null && a.text.node.parentNode == a.shape.node.parentNode)
			&& a.shape.node.parentNode.insertBefore(a.text.node,
					a.shape.node.nextSibling)
};
mxCellRenderer.prototype.createShape = function(a) {
	if (a.style != null) {
		var b = mxStencilRegistry.getStencil(a.style[mxConstants.STYLE_SHAPE]);
		if (b != null)
			a.shape = new mxStencilShape(b);
		else {
...
mxCellRenderer.prototype.getShapeConstructor = function(a) {
	var b = a.style[mxConstants.STYLE_SHAPE], b = b != null
			? this.shapes[b]
			: null;
	b == null
...
mxCellRenderer.prototype.configureShape = function(a) {
	...
	if (b != null)
		a.shape.image = b;
	var b = a.view.graph.getIndicatorColor(a), c = a.view.graph
			.getIndicatorShape(a), c = c != null ? this.shapes[c] : null;
	if (b != null) {
		a.shape.indicatorShape = c;
		a.shape.indicatorColor = b;
		a.shape.indicatorGradientColor = a.view.graph
				.getIndicatorGradientColor(a);
		a.shape.indicatorDirection = a.style[mxConstants.STYLE_INDICATOR_DIRECTION]
	} else {
		b = a.view.graph.getIndicatorImage(a);
		if (b != null)
			a.shape.indicatorImage = b
	}
...
mxCellRenderer.prototype.postConfigureShape = function(a) {
	if (a.shape != null) {
		...
		this.resolveColor(a, "indicatorGradientColor",
...
mxCellRenderer.prototype.resolveColor = function(a, b, c) {
	...
	if (d == "inherit")
		...
		f = e.model.getTerminal(a.cell, false) != null ? e.model.getTerminal(
				a.cell, false) : a.cell;
		f = e.getSwimlane(f);
		c = e.swimlaneIndicatorColorAttribute
	} else if (d == "indicated")
		a.shape[b] = a.shape.indicatorColor;
	if (f != null) {
		d = e.getView().getState(f);
		a.shape[b] = null;
		d != null
				&& (a.shape[b] = d.shape != null && b != "indicatorColor"
						? d.shape[b]
						: d.style[c])
	}
};
mxCellRenderer.prototype.getLabelValue = function(a) {
	...
	!b.isHtmlLabel(a.cell)
			&& (!mxUtils.isNode(c) && b.dialect != mxConstants.DIALECT_SVG && c != null)
			&& (c = mxUtils.htmlEntities(c, false));
	return c
};
mxCellRenderer.prototype.createLabel = function(a, b) {
	var c = a.view.graph;
	c.getModel().isEdge(a.cell);
	if (a.style[mxConstants.STYLE_FONTSIZE] > 0
			|| a.style[mxConstants.STYLE_FONTSIZE] == null) {
		var d = (c.isHtmlLabel(a.cell) || b != null && mxUtils.isNode(b))
				&& c.dialect == mxConstants.DIALECT_SVG;
		a.text = new mxText(b, new mxRectangle,
		...
		var e = false, f = function(b) {
			...
			return d
		}, d = mxClient.IS_TOUCH ? "touchmove" : "mousemove", g = mxClient.IS_TOUCH
				? "touchend"
				: "mouseup";
		mxEvent.addListener(a.text.node, mxClient.IS_TOUCH
						? "touchstart"
						: "mousedown", mxUtils.bind(this, function(b) {
							if (this.isLabelEvent(a, b)) {
								c.fireMouseEvent(mxEvent.MOUSE_DOWN,
										new mxMouseEvent(b, a));
								e = c.dialect != mxConstants.DIALECT_SVG
										&& mxEvent.getSource(b).nodeName == "IMG"
							}
						}));
...
mxCellRenderer.prototype.initializeLabel = function(a) {
	var b = a.view.graph;
	a.text.dialect != mxConstants.DIALECT_SVG
			&& (mxClient.IS_SVG && mxClient.NO_FO
					? a.text.init(b.container)
					: mxUtils.isVml(a.view.getDrawPane())
							&& (a.shape.label != null ? a.text
...
mxCellRenderer.prototype.initControl = function(a, b, c, d) {
	var e = a.view.graph;
	if (e.isHtmlLabel(a.cell) && mxClient.NO_FO
	...
	if (c) {
		...
		mxEvent.addListener(b, c, function(b) {
					e
							.fireMouseEvent(mxEvent.MOUSE_MOVE,
									new mxMouseEvent(b, a))
				})
	}
	return b
...
mxCellRenderer.prototype.installListeners = function(a) {
	...
	if (b.dialect == mxConstants.DIALECT_SVG) {
		var c = "all";
		if (b.getModel().isEdge(a.cell) && a.shape.stroke != null
				&& (a.shape.fill == null || a.shape.fill == mxConstants.NONE))
			c = "visibleStroke";
		a.shape.innerNode != null ? a.shape.innerNode.setAttribute(
				"pointer-events", c) : a.shape.node.setAttribute(
				"pointer-events", c)
	}
	var d = function(c) {
		var d = a;
		if (b.dialect != mxConstants.DIALECT_SVG
				&& mxEvent.getSource(c).nodeName == "IMG" || mxClient.IS_TOUCH) {
	...
	var c = mxClient.IS_TOUCH ? "touchmove" : "mousemove", f = mxClient.IS_TOUCH
			? "touchend"
			: "mouseup";
	mxEvent.addListener(a.shape.node, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", mxUtils.bind(this, function(c) {
				this.isShapeEvent(a, c) && !e
						? b
								.fireMouseEvent(
										mxEvent.MOUSE_DOWN,
										new mxMouseEvent(
...
mxCellRenderer.prototype.redrawLabel = function(a) {
	...
	if (a.text == null && b != null && (mxUtils.isNode(b) || b.length > 0))
		this.createLabel(a, b);
	else if (a.text != null && (b == null || b.length == 0)) {
		a.text.destroy();
		a.text = null
	}
	if (a.text != null) {
		var c = a.view.graph, d = c.isWrapping(a.cell), c = c
				.isLabelClipped(a.cell), e = this.getLabelBounds(a);
		if (a.text.value != b || a.text.isWrapping != d
				|| a.text.isClipping != c || a.text.scale != a.view.scale
				|| !a.text.bounds.equals(e)) {
			a.text.value = b;
			a.text.bounds = e;
...
mxCellRenderer.prototype.getLabelBounds = function(a) {
	var b = a.view.graph, c = b.getModel().isEdge(a.cell), d = new mxRectangle(
...
mxCellRenderer.prototype.getControlBounds = function(a) {
	if (a.control != null) {
		var b = a.control.scale, c = a.control.bounds.width / b, b = a.control.bounds.height
				/ b, d = a.view.scale;
		return a.view.graph.getModel().isEdge(a.cell) ? new mxRectangle(a.x
						+ a.width / 2 - c / 2 * d, a.y + a.height / 2 - b / 2
						* d, c * d, b * d) : new mxRectangle(a.x + c / 2 * d,
				a.y + b / 2 * d, c * d, b * d)
	}
	return null
};
mxCellRenderer.prototype.redraw = function(a, b, c) {
	if (a.shape != null) {
		...
		!reconfigure && !mxUtils.equalEntries(a.shape.style, a.style)
				&& (reconfigure = true);
		if (reconfigure) {
			this.configureShape(a);
			a.shape.reconfigure()
		...
		if (b || a.shape.bounds == null || a.shape.scale != a.view.scale
				|| !a.shape.bounds.equals(a)
				|| !mxUtils.equalPoints(a.shape.points, a.absolutePoints)) {
			a.shape.points = a.absolutePoints != null ? a.absolutePoints
					.slice() : null;
			a.shape.bounds = new mxRectangle(a.x, a.y, a.width, a.height);
			a.shape.scale = a.view.scale;
...
var mxEdgeStyle = {
	EntityRelation : function(a, b, c, d, e) {
		var f = a.view, g = f.graph, d = mxUtils.getValue(a.style,
				mxConstants.STYLE_SEGMENT, mxConstants.ENTITY_SEGMENT)
				* f.scale, h = a.absolutePoints, k = h[0], i = h[h.length - 1], h = false;
		if (k != null) {
			b = new mxCellState;
			b.x = k.x;
			b.y = k.y
		} else if (b != null) {
			var l = mxUtils.getPortConstraints(b, a, true,
					mxConstants.DIRECTION_MASK_NONE);
			if (l != mxConstants.DIRECTION_MASK_NONE)
				h = l == mxConstants.DIRECTION_MASK_WEST;
			else {
				k = g.getCellGeometry(b.cell);
				k.relative ? h = k.x <= 0.5 : c != null
						&& (h = c.x + c.width < b.x)
			}
		} else
			return;
		...
		if (i != null) {
			...
			l = mxUtils.getPortConstraints(c, a, false,
					mxConstants.DIRECTION_MASK_NONE);
			if (l != mxConstants.DIRECTION_MASK_NONE)
				k = l == mxConstants.DIRECTION_MASK_WEST;
			else {
				a = g.getCellGeometry(c.cell);
				a.relative ? k = a.x <= 0.5 : b != null
						&& (k = b.x + b.width < c.x)
			}
		}
		if (b != null && c != null) {
	...
	Loop : function(a, b, c, d, e) {
		if (b != null) {
			var c = a.view, f = c.graph, d = d != null && d.length > 0
					? d[0]
					: null;
			if (d != null) {
			...
			var g = 0, h = 0, k = 0, i = 0, f = mxUtils.getValue(a.style,
					mxConstants.STYLE_SEGMENT, f.gridSize)
					* c.scale, a = mxUtils.getValue(a.style,
					mxConstants.STYLE_DIRECTION, mxConstants.DIRECTION_WEST);
			if (a == mxConstants.DIRECTION_NORTH
			...
			if (d == null || d.x < b.x || d.x > b.x + b.width)
				if (d != null) {
					g = d.x;
	...
	ElbowConnector : function(a, b, c, d, e) {
		...
		if (b != null && c != null)
			if (f != null)
				var k = Math.min(b.x, c.x), i = Math.max(b.x + b.width, c.x
								+ c.width), h = Math.min(b.y, c.y), l = Math
						.max(b.y + b.height, c.y + c.height), f = a.view
						.transformControlPoint(a, f), g = f.y < h || f.y > l, h = f.x < k
						|| f.x > i;
			else {
				k = Math.max(b.x, c.x);
	...
	SideToSide : function(a, b, c, d, e) {
		var f = a.view, d = d != null && d.length > 0 ? d[0] : null, g = a.absolutePoints, h = g[0], g = g[g.length
				- 1];
		...
		if (b != null && c != null) {
			...
			if (d != null) {
				if (d.y >= b.y && d.y <= b.y + b.height)
					h = d.y;
				if (d.y >= c.y && d.y <= c.y + c.height)
					f = d.y
			}
			!mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h)
					&& e.push(new mxPoint(a, h));
			!mxUtils.contains(c, a, f) && !mxUtils.contains(b, a, f)
					&& e.push(new mxPoint(a, f));
			if (e.length == 1)
				if (d != null)
					!mxUtils.contains(c, a, d.y)
							&& !mxUtils.contains(b, a, d.y)
							&& e.push(new mxPoint(a, d.y));
				else {
					f = Math.max(b.y, c.y);
	...
	TopToBottom : function(a, b, c, d, e) {
		...
		if (b != null && c != null) {
			...
			!mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h)
					&& e.push(new mxPoint(a, h));
			a = d != null && d.x >= c.x && d.x <= c.x + c.width ? d.x : f
					.getRoutingCenterX(c);
			!mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h)
					&& e.push(new mxPoint(a, h));
			if (e.length == 1)
				if (d != null && e.length == 1)
					!mxUtils.contains(c, d.x, h)
							&& !mxUtils.contains(b, d.x, h)
							&& e.push(new mxPoint(d.x, h));
				else {
					f = Math.max(b.x, c.x);
	...
	SegmentConnector : function(a, b, c, d, e) {
		...
		k == null && b != null ? k = new mxPoint(a.view.getRoutingCenterX(b),
				a.view.getRoutingCenterY(b)) : k != null && (k = k.clone());
		var i = f.length - 1;
		if (d != null && d.length > 0) {
			for (var h = a.view.transformControlPoint(a, d[0]), l = b, m = f[0], n = false, o = false, n = h, p = d.length, q = 0; q < 2; q++) {
				var t = m != null && m.x == n.x, u = m != null && m.y == n.y, v = l != null
						&& n.y >= l.y && n.y <= l.y + l.height, l = l != null
						&& n.x >= l.x && n.x <= l.x + l.width, n = u
						|| m == null && v, o = t || m == null && l;
				if (m != null && !u && !t && (v || l)) {
					g = v ? false : true;
					break
				}
			...
			g
					&& (f[0] != null && f[0].y != h.y || f[0] == null
							&& b != null && (h.y < b.y || h.y > b.y + b.height))
					? e.push(new mxPoint(k.x, h.y))
					: !g
							&& (f[0] != null && f[0].x != h.x || f[0] == null
									&& b != null
		...
		k == null
				...
				&& (k = new mxPoint(a.view.getRoutingCenterX(c), a.view
								.getRoutingCenterY(c)));
		g
				&& (f[i] != null && f[i].y != h.y || f[i] == null && c != null
						&& (h.y < c.y || h.y > c.y + c.height)) ? e
				.push(new mxPoint(k.x, h.y)) : !g
				&& (f[i] != null && f[i].x != h.x || f[i] == null && c != null
						&& (h.x < c.x || h.x > c.x + c.width))
				&& e.push(new mxPoint(h.x, k.y));
		if (f[0] == null && b != null)
			for (; e.length > 1 && mxUtils.contains(b, e[1].x, e[1].y);)
				e = e.splice(1, 1);
		if (f[i] == null && c != null)
			for (; e.length > 1
					&& mxUtils
	...
	OrthConnector : function(a, b, c, d, e) {
		var f = a.view.graph, g = b == null ? false : f.getModel()
				.isEdge(b.cell), f = c == null ? false : f.getModel()
				.isEdge(c.cell);
		if (d != null && d.length > 0 || g || f)
			mxEdgeStyle.SegmentConnector(a, b, c, d, e);
		else {
			var d = a.absolutePoints, h = d[0], k = d[d.length - 1], d = b != null
					? b.x
					: h.x, g = b != null ? b.y : h.y, i = b != null
					? b.width
					: 1, l = b != null ? b.height : 1, m = c != null
					? c.x
					: k.x, n = c != null ? c.y : k.y, o = c != null
					? c.width
					: 1, p = c != null ? c.height : 1, f = a.view.scale
					* mxEdgeStyle.orthBuffer, q = [
					mxConstants.DIRECTION_MASK_ALL,
					mxConstants.DIRECTION_MASK_ALL];
			b != null
					&& (q[0] = mxUtils.getPortConstraints(b, a, true,
							mxConstants.DIRECTION_MASK_ALL));
			c != null
					&& (q[1] = mxUtils.getPortConstraints(c, a, false,
							mxConstants.DIRECTION_MASK_ALL));
			a = [0, 0];
			d = [[d, g, i, l], [m, n, o, p]];
			for (i = 0; i < 2; i++) {
			...
			for (i = 0; i < 2; i++) {
				if (l != null) {
					...
					if (b[i][0] < 0.01)
						a[i] = mxConstants.DIRECTION_MASK_WEST;
					else if (b[i][0] > 0.99)
						a[i] = mxConstants.DIRECTION_MASK_EAST;
					b[i][1] = (l.y - d[i][1]) / d[i][3];
					if (b[i][1] < 0.01)
						a[i] = mxConstants.DIRECTION_MASK_NORTH;
					else if (b[i][1] > 0.99)
						a[i] = mxConstants.DIRECTION_MASK_SOUTH
				}
				l = null;
				c != null && (l = k)
			}
			...
			for (i = 0; i < 2; i++)
				if (a[i] == 0) {
					(h[i] & q[i]) == 0
							&& (h[i] = mxUtils.reversePortConstraints(h[i]));
					(k[i] & q[i]) == 0
							&& (k[i] = mxUtils.reversePortConstraints(k[i]));
					n[i][0] = k[i];
					n[i][1] = h[i]
				}
			if (m > f * 2 && l > f * 2)
				if ((h[0] & q[0]) > 0 && (k[1] & q[1]) > 0) {
					n[0][0] = h[0];
					n[0][1] = k[0];
					n[1][0] = k[1];
					n[1][1] = h[1];
			...
			for (i = 0; i < 2; i++)
				if (a[i] == 0) {
					...
					(c[i] & 983040) == 0
							&& (c[i] = c[i] & 65535 | (c[i] & 251658240) >> 8);
					a[i] = c[i] & 15;
					if (q[i] == mxConstants.DIRECTION_MASK_WEST
							|| q[i] == mxConstants.DIRECTION_MASK_NORTH
							|| q[i] == mxConstants.DIRECTION_MASK_EAST
							|| q[i] == mxConstants.DIRECTION_MASK_SOUTH)
						a[i] = q[i]
				}
			...
			switch (a[0]) {
				case mxConstants.DIRECTION_MASK_WEST :
					mxEdgeStyle.wayPoints1[0][0] = mxEdgeStyle.wayPoints1[0][0]
							- f;
					mxEdgeStyle.wayPoints1[0][1] = mxEdgeStyle.wayPoints1[0][1]
							+ b[0][1] * d[0][3];
					break;
			...
			f = 0;
			h = c = (a[0] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) > 0
					? 0
					: 1;
			for (i = k = 0; i < q.length; i++) {
				...
				if ((o || t) && m < 9) {
					p = 0;
					o = o ? 0 : 1;
					p = n && k == 0 ? d[o][0] + b[o][0] * d[o][2] : n ? d[o][1]
							+ b[o][1] * d[o][3] : mxEdgeStyle.limits[o][m];
					if (k == 0) {
						m = (p - mxEdgeStyle.wayPoints1[f][0]) * l[0];
						m > 0
								&& (mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f][0]
										+ l[0] * m)
					} else {
						m = (p - mxEdgeStyle.wayPoints1[f][1]) * l[1];
						m > 0
								&& (mxEdgeStyle.wayPoints1[f][1] = mxEdgeStyle.wayPoints1[f][1]
										+ l[1] * m)
					}
				} else if (n) {
					mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f][0]
							+ l[0]
							* Math.abs(mxEdgeStyle.vertexSeperations[p] / 2);
					mxEdgeStyle.wayPoints1[f][1] = mxEdgeStyle.wayPoints1[f][1]
							+ l[1]
							* Math.abs(mxEdgeStyle.vertexSeperations[p] / 2)
				}
			...
			for (i = 0; i <= f; i++) {
				if (i == f
						&& (((a[1] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) > 0
								? 0
								: 1) == h ? 0 : 1) != (f + 1) % 2)
					break;
				e.push(new mxPoint(mxEdgeStyle.wayPoints1[i][0],
						mxEdgeStyle.wayPoints1[i][1]))
			}
		}
	},
	getRoutePattern : function(a, b, c, d) {
		var e = a[0] == mxConstants.DIRECTION_MASK_EAST ? 3 : a[0], a = a[1] == mxConstants.DIRECTION_MASK_EAST
				? 3
				: a[1], e = e - b, a = a - b;
		e < 1 && (e = e + 4);
		a < 1 && (a = a + 4);
		...
		if (c == 0 || d == 0)
			inlineRoutePatterns[e - 1][a - 1] != null
	...
	if (a != null && a.length > 0)
		for (var c = this.graph.getModel(), d = 0; d < a.length; d++)
			if (c.isVertex(a[d]) || c.isEdge(a[d])) {
				...
				e != null
						&& (b == null ? b = new mxRectangle(e.x, e.y, e.width,
								e.height) : b.add(e))
			}
	return b
};
...
mxGraphView.prototype.clear = function(a, b, c) {
	var d = this.graph.getModel(), a = a || d.getRoot(), b = b != null
			? b
			: false, c = c != null ? c : true;
	this.removeState(a);
	if (c && (b || a != this.currentRoot))
		for (var c = d.getChildCount(a), e = 0; e < c; e++)
			this.clear(d.getChildAt(a, e), b);
	else
		this.invalidate(a)
};
mxGraphView.prototype.invalidate = function(a, b, c, d) {
	var e = this.graph.getModel(), a = a || e.getRoot(), b = b != null
			? b
			: true, c = c != null ? c : true, d = d != null ? d : false, f = this
			.getState(a);
	if (f != null) {
		f.invalid = true;
		if (d)
	...
	if (b)
		for (var g = e.getChildCount(a), f = 0; f < g; f++)
			this.invalidate(e.getChildAt(a, f), b, c, d);
	if (c) {
		d = e.getEdgeCount(a);
		for (f = 0; f < d; f++)
			this.invalidate(e.getEdgeAt(a, f), b, c)
	}
};
	...
	if (this.graph.pageVisible) {
		...
		if (this.backgroundPageShape == null) {
			...
			mxEvent.addListener(this.backgroundPageShape.node,
					mxClient.IS_TOUCH ? "touchstart" : "mousedown", mxUtils
							.bind(this, function(a) {
										this.graph.fireMouseEvent(
												mxEvent.MOUSE_DOWN,
												new mxMouseEvent(a))
									}));
			mxEvent.addListener(this.backgroundPageShape.node, a, mxUtils.bind(
							this, function(a) {
			...
			mxEvent.addListener(this.backgroundPageShape.node, b, mxUtils.bind(
							this, function(a) {
					...
					if (!c.isEdge(b)) {
						...
						if (e.relative) {
							d.origin.x = d.origin.x
									+ (e.x * a.width / this.scale + f.x);
							d.origin.y = d.origin.y
									+ (e.y * a.height / this.scale + f.y)
						} else {
...
mxGraphView.prototype.updateVertexLabelOffset = function(a) {
	var b = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_POSITION,
			mxConstants.ALIGN_CENTER);
	if (b == mxConstants.ALIGN_LEFT)
		a.absoluteOffset.x = a.absoluteOffset.x - a.width;
	else if (b == mxConstants.ALIGN_RIGHT)
		a.absoluteOffset.x = a.absoluteOffset.x + a.width;
	b = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_LABEL_POSITION,
			mxConstants.ALIGN_MIDDLE);
	if (b == mxConstants.ALIGN_TOP)
		a.absoluteOffset.y = a.absoluteOffset.y - a.height;
	else if (b == mxConstants.ALIGN_BOTTOM)
		a.absoluteOffset.y = a.absoluteOffset.y + a.height
};
mxGraphView.prototype.validatePoints = function(a, b) {
	...
	if (d != null) {
		if (d.invalid) {
			...
			d.invalid = false;
			b != this.currentRoot
					&& this.graph.cellRenderer.redraw(d, false, this
									.isRendering())
		}
		if (c.isEdge(b) || c.isVertex(b)) {
			d.shape != null && d.shape.boundingBox != null
					&& (e = d.shape.boundingBox.clone());
			d.text != null
					&& !this.graph.isLabelClipped(d.cell)
					&& d.text.boundingBox != null
					&& (e != null
...
mxGraphView.prototype.updateFixedTerminalPoints = function(a, b, c) {
	this.updateFixedTerminalPoint(a, b, true, this.graph
					.getConnectionConstraint(a, b, true));
	this.updateFixedTerminalPoint(a, c, false, this.graph
					.getConnectionConstraint(a, c, false))
};
mxGraphView.prototype.updateFixedTerminalPoint = function(a, b, c, d) {
	var e = null;
	d != null && (e = this.graph.getConnectionPoint(b, d));
	if (e == null && b == null) {
		var b = this.scale, d = this.translate, f = a.origin, e = this.graph
				.getCellGeometry(a.cell).getTerminalPoint(c);
		e != null
...
mxGraphView.prototype.getEdgeStyle = function(a, b, c, d) {
	a = c != null && c == d ? mxUtils.getValue(a.style, mxConstants.STYLE_LOOP,
...
mxGraphView.prototype.updateFloatingTerminalPoints = function(a, b, c) {
	...
	d[d.length - 1] == null && c != null
			&& this.updateFloatingTerminalPoint(a, c, b, false);
...
mxGraphView.prototype.updateFloatingTerminalPoint = function(a, b, c, d) {
	var b = this.getTerminalPort(a, b, d), e = this.getNextPoint(a, c, d), c = mxUtils
			.toRadians(Number(b.style[mxConstants.STYLE_ROTATION] || "0")), f = new mxPoint(
			b.getCenterX(), b.getCenterY());
	if (c != 0)
		var g = Math.cos(-c), h = Math.sin(-c), e = mxUtils.getRotatedPoint(e,
				g, h, f);
	g = parseFloat(a.style[mxConstants.STYLE_PERIMETER_SPACING] || 0);
	g = g
			+ parseFloat(a.style[d
...
mxGraphView.prototype.getPerimeterBounds = function(a, b) {
	...
	a != null
			&& (b = b
					+ parseFloat(a.style[mxConstants.STYLE_PERIMETER_SPACING]
							|| 0));
...
mxGraphView.prototype.getVisibleTerminal = function(a, b) {
	for (var c = this.graph.getModel(), d = c.getTerminal(a, b), e = d; d != null
			&& d != this.currentRoot;) {
...
mxGraphView.prototype.updateEdgeBounds = function(a) {
	...
	if (b != null && b.length > 0) {
		...
		if (c == null || d == null)
			a.cell != this.currentRoot && this.clear(a.cell, true);
		else {
			if (c.x != d.x || c.y != d.y) {
...
mxGraphView.prototype.getPoint = function(a, b) {
	...
	if (a.segments != null && (b == null || b.relative)) {
		for (var e = a.absolutePoints.length, f = ((b != null ? b.x / 2 : 0) + 0.5)
	...
	if (d != null) {
		...
		if (d.relative && e > 1) {
			for (var d = a.length, f = a.segments, g = a.absolutePoints[0], h = a.absolutePoints[1], k = mxUtils
					.ptSegDistSq(g.x, g.y, h.x, h.y, b, c), i = 0, l = 0, m = 0, n = 2; n < e; n++) {
				l = l + f[n - 2];
	...
	if (a != null) {
		...
		if (this.graph.isCellVisible(a))
			if (c == null && b && this.graph.isCellVisible(a)) {
				...
				this.states.put(a, c)
			} else if (b && c != null && this.updateStyle)
...
mxGraphView.prototype.isScrollEvent = function(a) {
	var b = mxUtils.getOffset(this.graph.container), a = new mxPoint(a.clientX
					- b.x, a.clientY - b.y), b = this.graph.container.offsetWidth, c = this.graph.container.clientWidth;
...
mxGraphView.prototype.installListeners = function() {
	...
	if (b != null) {
		var c = mxClient.IS_TOUCH ? "touchmove" : "mousemove", d = mxClient.IS_TOUCH
				? "touchend"
				: "mouseup";
		mxEvent.addListener(b, mxClient.IS_TOUCH ? "touchstart" : "mousedown",
				mxUtils.bind(this, function(b) {
					mxClient.IS_TOUCH && a.isEditing()
							&& a.stopEditing(!a.isInvokesStopCellEditing());
		...
		if (mxClient.IS_QUIRKS) {
			a = mxUtils.bind(this, function() {
						...
						this.updateHtmlCanvasSize(a.x + a.width
										+ this.graph.border, a.y + a.height
										+ this.graph.border)
					});
...
mxGraphView.prototype.createSvg = function() {
	...
	if (a != null) {
		a.appendChild(b);
		if (mxUtils.getCurrentStyle(a).position == "static")
...
function mxCurrentRootChange(a, b) {
	...
	this.isUp = b == null;
	if (!this.isUp)
		for (var c = this.view.currentRoot, d = this.view.graph.getModel(); c != null;) {
			if (c == b) {
				this.isUp = true;
				break
			}
...
mxCurrentRootChange.prototype.execute = function() {
	...
	if (a != null)
		this.view.translate = new mxPoint(-a.x, -a.y);
...
mxGraph.prototype.getSelectionCellsForChanges = function(a) {
	for (var b = [], c = 0; c < a.length; c++) {
		...
		if (d.constructor != mxRootChange) {
			var e = null;
			if (d instanceof mxChildChange && d.previous == null)
				e = d.child;
			else if (d.cell != null && d.cell instanceof mxCell)
				e = d.cell;
...
mxGraph.prototype.processChange = function(a) {
	if (a instanceof mxRootChange) {
		...
		if (b != null)
			this.view.invalidate(a.child, true, false, a.previous != null);
		else {
		...
		if (b != a.previous) {
			...
			a.previous != null
					&& this.view.invalidate(a.previous, false, false)
		}
	} else if (a instanceof mxTerminalChange || a instanceof mxGeometryChange)
		this.view.invalidate(a.cell);
	else if (a instanceof mxValueChange)
		this.view.invalidate(a.cell, false, false);
	else if (a instanceof mxStyleChange) {
		this.view.invalidate(a.cell, true, true, false);
		this.view.removeState(a.cell)
	} else
		a.cell != null && a.cell instanceof mxCell
...
mxGraph.prototype.clearCellOverlays = function(a) {
	...
	this.removeCellOverlays(a);
	for (var b = this.model.getChildCount(a), c = 0; c < b; c++)
		this.clearCellOverlays(this.model.getChildAt(a, c))
};
...
mxGraph.prototype.startEditingAtCell = function(a, b) {
	...
	if (a != null) {
		this.fireEvent(new mxEventObject(mxEvent.START_EDITING, "cell", a,
				"event", b));
...
mxGraph.prototype.click = function(a) {
	...
	if (this.isEnabled() && !mxEvent.isConsumed(b) && !d.isConsumed())
		if (c != null)
			...
			c != null ? this.selectCellForEvent(c, b) : this.isToggleEvent(b)
					|| this.clearSelection()
		}
};
mxGraph.prototype.dblClick = function(a, b) {
	...
	this.fireEvent(c);
	this.isEnabled()
			&& (!mxEvent.isConsumed(a) && !c.isConsumed() && b != null && this
					.isCellEditable(b)) && this.startEditingAtCell(b, a)
};
...
mxGraph.prototype.getBorderSizes = function() {
	function a(a) {
		var b = 0, b = a == "thin" ? 2 : a == "medium" ? 4 : a == "thick"
				? 6
				: parseInt(a);
		isNaN(b) && (b = 0);
		return b
...
mxGraph.prototype.getPreferredPageSize = function(a, b, c) {
	var a = this.view.scale, d = this.view.translate, e = this.pageFormat, f = a
			* this.pageScale, e = new mxRectangle(0, 0, e.width * f, e.height
					* f), b = this.pageBreaksVisible
			? Math.ceil(b / e.width)
			: 1, c = this.pageBreaksVisible ? Math.ceil(c / e.height) : 1;
...
mxGraph.prototype.sizeDidChange = function() {
	...
	if (this.container != null) {
		...
		if (this.dialect == mxConstants.DIALECT_SVG) {
			...
			this.view.updateHtmlCanvasSize(Math.max(1, c), Math.max(1, b));
		else {
...
mxGraph.prototype.doResizeContainer = function(a, b) {
	if (mxClient.IS_IE)
		if (mxClient.IS_QUIRKS)
			var c = this.getBorderSizes(), a = a
					+ Math.max(2, c.x + c.width + 1), b = b
					+ Math.max(2, c.y + c.height + 1);
...
mxGraph.prototype.getCellStyle = function(a) {
	...
	b != null
			&& (c = this.postProcessCellStyle(this.stylesheet
					.getCellStyle(b, c)));
	if (c == null)
		c = mxGraph.prototype.EMPTY_ARRAY;
	return c
};
...
mxGraph.prototype.toggleCellStyles = function(a, b, c) {
	...
	if (c != null && c.length > 0) {
		var d = this.view.getState(c[0]), d = d != null ? d.style : this
				.getCellStyle(c[0]);
		if (d != null) {
...
mxGraph.prototype.setCellStyleFlags = function(a, b, c, d) {
	...
	if (d != null && d.length > 0) {
		if (c == null) {
			var e = this.view.getState(d[0]), e = e != null ? e.style : this
					.getCellStyle(d[0]);
				...
				for (d = 0; d < b.length; d++) {
					...
					if (e != null && !this.model.isEdge(b[d])) {
						...
						a == mxConstants.ALIGN_CENTER
								? e.x = c - e.width / 2
								: a == mxConstants.ALIGN_RIGHT ? e.x = c
										- e.width : a == mxConstants.ALIGN_TOP
										? e.y = c
...
mxGraph.prototype.flipEdge = function(a) {
	if (a != null && this.alternateEdgeStyle != null) {
		...
		try {
			...
			b == null || b.length == 0 ? this.model.setStyle(a,
...
mxGraph.prototype.orderCells = function(a, b) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.ORDER_CELLS, "back", a,
				"cells", b))
	} finally {
		this.model.endUpdate()
	}
...
mxGraph.prototype.ungroupCells = function(a) {
	var b = [];
	if (a == null) {
		for (var a = this.getSelectionCells(), c = [], d = 0; d < a.length; d++)
			this.model.getChildCount(a[d]) > 0 && c.push(a[d]);
		a = c
	}
	if (a != null && a.length > 0) {
		this.model.beginUpdate();
	...
	if (a != null) {
		...
		if (c.length > 0)
			for (var f = this.view.scale, g = this.view.translate, c = this.model
					.cloneCells(a, true), e = 0; e < a.length; e++)
				if (!b
						&& this.model.isEdge(c[e])
						&& this.getEdgeValidationError(c[e], this.model
										.getTerminal(c[e], true), this.model
										.getTerminal(c[e], false)) != null)
					c[e] = null;
				else {
					var h = this.model.getGeometry(c[e]);
					if (h != null) {
						var k = this.view.getState(a[e]), i = this.view
								.getState(this.model.getParent(a[e]));
						if (k != null && i != null) {
							var l = i.origin.x, i = i.origin.y;
							if (this.model.isEdge(c[e])) {
								for (var k = k.absolutePoints, m = this.model
										.getTerminal(a[e], true), n = mxCellPath
										.create(m); m != null && d[n] == null;) {
								...
								for (n = mxCellPath.create(m); m != null
										&& d[n] == null;) {
									m = this.model.getParent(m);
									n = mxCellPath.create(m)
								}
								if (m == null) {
									m = k.length - 1;
									h.setTerminalPoint(new mxPoint(k[m].x / f
															- g.x, k[m].y / f
															- g.y), false)
								}
								h = h.points;
...
mxGraph.prototype.addCells = function(a, b, c, d, e) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.ADD_CELLS, "cells", a,
...
mxGraph.prototype.cellsAdded = function(a, b, c, d, e, f, g) {
	if (a != null && b != null && c != null) {
		this.model.beginUpdate();
		try {
			for (var h = f ? this.view.getState(b) : null, k = h != null
					? h.origin
					: null, i = new mxPoint(0, 0), h = 0; h < a.length; h++)
				if (a[h] == null)
					c--;
				else {
					var l = this.model.getParent(a[h]);
					if (k != null && a[h] != b && b != l) {
						var m = this.view.getState(l), n = m != null
								? m.origin
								: i, o = this.model.getGeometry(a[h]);
						if (o != null) {
							var p = n.x - k.x, q = n.y - k.y, o = o.clone();
							o.translate(p, q);
							if (!o.relative && this.model.isVertex(a[h])
...
mxGraph.prototype.removeCells = function(a, b) {
	...
	try {
		this.cellsRemoved(a);
		this.fireEvent(new mxEventObject(mxEvent.REMOVE_CELLS, "cells", a,
				"includeEdges", b))
	} finally {
		this.model.endUpdate()
	}
				...
				for (var g = this.getConnections(a[e]), h = 0; h < g.length; h++) {
					...
					if (d[f] == null) {
						...
						if (k != null) {
							...
							if (i != null) {
								var k = k.clone(), l = i
										.getVisibleTerminal(true) == a[e], m = i.absolutePoints, n = l
										? 0
										: m.length - 1;
...
mxGraph.prototype.splitEdge = function(a, b, c, d, e) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.SPLIT_EDGE, "edge", a,
				"cells", b, "newEdge", c, "dx", d, "dy", e))
	} finally {
		this.model.endUpdate()
	}
	return c
...
mxGraph.prototype.toggleCells = function(a, b, c) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.TOGGLE_CELLS, "show", a,
...
mxGraph.prototype.foldCells = function(a, b, c, d) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.FOLD_CELLS, "collapse", a,
				"recurse", b, "cells", c))
	} finally {
		this.model.endUpdate()
	}
...
mxGraph.prototype.updateCellSize = function(a, b) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.UPDATE_CELL_SIZE, "cell", a,
				"ignoreChildren", b))
	} finally {
		this.model.endUpdate()
	}
		...
		try {
			...
			if (c != null && d != null) {
				...
				if (!b && !e) {
					...
					if (k != null) {
						var i = this.view.translate, l = this.view.scale, m = (k.y + k.height)
								/ l - d.y - i.y;
						d.width = Math.max(d.width, (k.x + k.width) / l - d.x
										- i.x);
...
mxGraph.prototype.getPreferredSizeForCell = function(a) {
	var b = null;
	if (a != null) {
		var c = this.view.getState(a), d = c != null ? c.style : this
				.getCellStyle(a);
		if (d != null && !this.model.isEdge(a)) {
			var e = d[mxConstants.STYLE_FONTSIZE]
					|| mxConstants.DEFAULT_FONTSIZE, f = 0, b = 0;
			if ((this.getImage(c) != null || d[mxConstants.STYLE_IMAGE] != null)
					&& d[mxConstants.STYLE_SHAPE] == mxConstants.SHAPE_LABEL) {
				d[mxConstants.STYLE_VERTICAL_ALIGN] == mxConstants.ALIGN_MIDDLE
						&& (f = f
								+ (parseFloat(d[mxConstants.STYLE_IMAGE_WIDTH]) || mxLabel.prototype.imageSize));
				d[mxConstants.STYLE_ALIGN] != mxConstants.ALIGN_CENTER
						&& (b = b
								+ (parseFloat(d[mxConstants.STYLE_IMAGE_HEIGHT]) || mxLabel.prototype.imageSize))
			}
			...
			if (c != null && c.length > 0) {
				...
				e = mxUtils.getSizeForString(c, e,
						d[mxConstants.STYLE_FONTFAMILY]);
				a = e.width + f;
				b = e.height + b;
...
mxGraph.prototype.handleGesture = function(a, b) {
	if (Math.abs(1 - b.scale) > 0.2) {
		var c = this.view.scale, d = this.view.translate, e = a.width * b.scale, f = a.height
				* b.scale, g = a.y - (f - a.height) / 2, c = new mxRectangle(
				this.snap((a.x - (e - a.width) / 2) / c) - d.x, this
						.snap(g / c)
						- d.y, this.snap(e / c), this.snap(f / c));
...
mxGraph.prototype.resizeCells = function(a, b) {
	...
	try {
		...
		this.fireEvent(new mxEventObject(mxEvent.RESIZE_CELLS, "cells", a,
				"bounds", b))
	} finally {
		this.model.endUpdate()
	}
	...
	if (a != null && b != null && a.length == b.length) {
		...
		try {
			for (var c = 0; c < a.length; c++) {
				...
				if (e != null
						&& (e.x != d.x || e.y != d.y || e.width != d.width || e.height != d.height)) {
					e = e.clone();
					if (e.relative) {
						var f = e.offset;
						if (f != null) {
					...
					e.width = d.width;
					e.height = d.height;
					if (!e.relative && this.model.isVertex(a[c])
							&& !this.isAllowNegativeCoordinates()) {
						e.x = Math.max(0, e.x);
						e.y = Math.max(0, e.y)
					}
	...
	if (a != null && (b != 0 || c != 0 || d || e != null)) {
		...
		try {
			...
			this.cellsMoved(a, b, c, !d && this.isDisconnectOnMove()
							&& this.isAllowDanglingEdges(), e == null);
...
mxGraph.prototype.translateCell = function(a, b, c) {
	...
	if (d != null) {
		d = d.clone();
		d.translate(b, c);
		if (!d.relative && this.model.isVertex(a)
				&& !this.isAllowNegativeCoordinates()) {
			d.x = Math.max(0, d.x);
			d.y = Math.max(0, d.y)
		}
...
mxGraph.prototype.constrainChild = function(a) {
	if (a != null) {
		...
		if (b != null
			...
			a = this.getOverlap(a);
			if (c.width > 0)
				b.x = Math.min(b.x, c.x + c.width - (1 - a) * b.width);
			if (c.height > 0)
				b.y = Math.min(b.y, c.y + c.height - (1 - a) * b.height);
			...
			for (c = 0; c < a.length; c++) {
				...
				if (e != null)
					for (d = 0; d < e.length; d++) {
						var f = this.view.getState(e[d]), g = f != null ? f
								.getVisibleTerminal(true) : this.view
								.getVisibleTerminal(e[d], true), h = f != null
								? f.getVisibleTerminal(false)
								: this.view.getVisibleTerminal(e[d], false), k = mxCellPath
								.create(g), i = mxCellPath.create(h);
...
mxGraph.prototype.getAllConnectionConstraints = function(a) {
	return a != null && (a.shape != null && a.shape instanceof mxStencilShape)
			&& a.shape.stencil != null ? a.shape.stencil.constraints : null
};
mxGraph.prototype.getConnectionConstraint = function(a, b, c) {
	var b = null, d = a.style[c
		...
		try {
			if (d == null || d.point == null) {
				this.setCellStyles(c
								? mxConstants.STYLE_EXIT_X
								: mxConstants.STYLE_ENTRY_X, null, [a]);
				this.setCellStyles(c
								? mxConstants.STYLE_EXIT_Y
								: mxConstants.STYLE_ENTRY_Y, null, [a]);
				this.setCellStyles(c
								? mxConstants.STYLE_EXIT_PERIMETER
								: mxConstants.STYLE_ENTRY_PERIMETER, null, [a])
			} else if (d.point != null) {
				this.setCellStyles(c
								? mxConstants.STYLE_EXIT_X
								: mxConstants.STYLE_ENTRY_X, d.point.x, [a]);
				this.setCellStyles(c
								? mxConstants.STYLE_EXIT_Y
								: mxConstants.STYLE_ENTRY_Y, d.point.y, [a]);
				d.perimeter
						? this.setCellStyles(c
										? mxConstants.STYLE_EXIT_PERIMETER
	...
	if (a != null) {
		...
		if (b.point != null) {
			...
			if (a.shape instanceof mxStencilShape) {
				var m = a.style[mxConstants.STYLE_STENCIL_FLIPH], n = a.style[mxConstants.STYLE_STENCIL_FLIPV];
				if (f == "north" || f == "south") {
					h = m;
					m = n;
					n = h
			...
			c = new mxPoint(d.x + b.point.x * d.width * c - i, d.y + b.point.y
							* d.height * k - l)
		}
		...
		if (b.perimeter) {
			...
			c != null && b.perimeter
					&& (c = this.view.getPerimeterPoint(a, c, false))
		} else
			f = f + g;
		if (f != 0 && c != null) {
	...
	if (a != null) {
		...
		try {
			...
			if (this.isPortsEnabled()) {
				...
				this.setCellStyles(c
								? mxConstants.STYLE_SOURCE_PORT
								: mxConstants.STYLE_TARGET_PORT, d, [a])
			}
				...
				if (this.model.isEdge(a[e])) {
					...
					if (g != null) {
						var h = this.view.getState(a[e]), k = this.view
								.getState(this.model.getParent(a[e]));
						if (h != null && k != null) {
							var g = g.clone(), i = -k.origin.x, l = -k.origin.y, m = h.absolutePoints, n = this.model
									.getTerminal(a[e], true);
							if (n != null
									&& this.isCellDisconnectable(a[e], n, true)) {
								for (var o = mxCellPath.create(n); n != null
										&& d[o] == null;) {
									n = this.model.getParent(n);
									o = mxCellPath.create(n)
								}
								if (n == null) {
									g.setTerminalPoint(new mxPoint(m[0].x / b
															- c.x + i, m[0].y
															/ b - c.y + l),
											true);
							...
							if (p != null
									&& this
											.isCellDisconnectable(a[e], p,
													false)) {
								for (var q = mxCellPath.create(p); p != null
										&& d[q] == null;) {
								...
								if (p == null) {
									var t = m.length - 1;
									g.setTerminalPoint(new mxPoint(m[t].x / b
															- c.x + i, m[t].y
															/ b - c.y + l),
											false);
...
mxGraph.prototype.getCellBounds = function(a, b, c) {
	...
	if (c)
		for (var c = this.model.getChildCount(a), e = 0; e < c; e++) {
...
mxGraph.prototype.panGraph = function(a, b) {
	if (this.useScrollbarsForPanning && mxUtils.hasScrollbars(this.container)) {
		...
		if (this.dialect == mxConstants.DIALECT_SVG)
			if (a == 0 && b == 0) {
				mxClient.IS_IE ? c.setAttribute("transform", "translate(" + a
								+ "," + b + ")") : c
...
mxGraph.prototype.zoom = function(a, b) {
	var b = b != null ? b : this.centerZoom, c = this.view.scale * a, d = this.view
	...
	if (this.keepSelectionVisibleOnZoom && d != null) {
		...
		if (mxUtils.hasScrollbars(this.container)) {
			...
			this.container.scrollLeft = Math.round(this.container.scrollLeft
					* a + d);
			this.container.scrollTop = Math.round(this.container.scrollTop * a
					+ e)
		}
	}
};
mxGraph.prototype.zoomToRect = function(a) {
	...
	if (mxUtils.hasScrollbars(this.container)) {
		...
		this.view.scaleAndTranslate(b, -a.x, -a.y)
};
mxGraph.prototype.fit = function(a, b) {
	if (this.container != null) {
		var a = a != null ? a : 0, b = b != null ? b : false, c = this.container.clientWidth, d = this.container.clientHeight, e = this.view
				.getGraphBounds();
		...
		var k = b ? a : 2 * a, c = Math.floor(Math
				.min(c / (g + k), d / (h + k))
				* 100)
				/ 100;
		if ((this.minFitScale == null || c > this.minFitScale)
				&& (this.maxFitScale == null || c < this.maxFitScale))
			if (b)
				this.view.setScale(c);
				...
				if (e.x != null)
					this.container.scrollLeft = Math.round(e.x / f)
							* c
							- a
							- Math.max(0, (this.container.clientWidth - g * c)
											/ 2);
				if (e.y != null)
					this.container.scrollTop = Math.round(e.y / f)
							* c
							- a
							- Math.max(0, (this.container.clientHeight - h * c)
											/ 2)
			} else
				this.view.scaleAndTranslate(c, e.x != null
...
mxGraph.prototype.scrollRectToVisible = function(a) {
	...
	if (a != null) {
		...
		if (mxUtils.hasScrollbars(this.container)) {
			...
			if (e > 0)
				c.scrollTop = c.scrollTop - (e + 2);
			else {
				e = a.y + f - c.scrollTop - c.clientHeight;
				if (e > 0)
					c.scrollTop = c.scrollTop + (e + 2)
			}
			!this.useScrollbarsForPanning && (d != 0 || g != 0)
					&& this.view.setTranslate(d, g)
		} else {
			var g = -this.view.translate.x, h = -this.view.translate.y, k = this.view.scale;
			if (a.x + e > g + c) {
				this.view.translate.x = this.view.translate.x
						- (a.x + e - c - g) / k;
				b = true
			}
			if (a.y + f > h + d) {
				this.view.translate.y = this.view.translate.y
						- (a.y + f - d - h) / k;
				b = true
			}
			if (a.x < g) {
			...
			if (b) {
				this.view.refresh();
				this.selectionCellsHandler != null
...
mxGraph.prototype.isLoop = function(a) {
	var b = a.getVisibleTerminalState(true), a = a
...
mxGraph.prototype.getEdgeValidationError = function(a, b, c) {
	if (a != null && !this.isAllowDanglingEdges() && (b == null || c == null))
		return "";
	if (a != null && this.model.getTerminal(a, true) == null
			&& this.model.getTerminal(a, false) == null)
		return null;
	if (!this.allowLoops && b == c && b != null
	...
	if (b != null && c != null) {
		...
		if (!this.multigraph) {
			...
			if (e.length > 1 || e.length == 1 && e[0] != a)
				d = d
						+ ((mxResources.get(this.alreadyConnectedResource) || this.alreadyConnectedResource) + "\n")
		}
		var e = this.model.getDirectedEdgeCount(b, true, a), f = this.model
				.getDirectedEdgeCount(c, false, a);
...
mxGraph.prototype.validateGraph = function(a, b) {
	for (var a = a != null ? a : this.model.getRoot(), b = b != null ? b : {}, c = true, d = this.model
			.getChildCount(a), e = 0; e < d; e++) {
	...
	d = this.model.isEdge(a) ? d
			+ (this.getEdgeValidationError(a, this.model.getTerminal(a, true),
					this.model.getTerminal(a, false)) || "") : d
...
mxGraph.prototype.getCellValidationError = function(a) {
	var b = this.model.getDirectedEdgeCount(a, true), c = this.model
			.getDirectedEdgeCount(a, false), a = this.model.getValue(a), d = "";
	if (this.multiplicities != null)
		for (var e = 0; e < this.multiplicities.length; e++) {
			var f = this.multiplicities[e];
			if (f.source
					&& mxUtils.isNode(a, f.type, f.attr, f.value)
					&& (f.max == 0 && b > 0 || f.min == 1 && b == 0 || f.max == 1
							&& b > 1))
				d = d + (f.countError + "\n");
			else if (!f.source
					&& mxUtils.isNode(a, f.type, f.attr, f.value)
					&& (f.max == 0 && c > 0 || f.min == 1 && c == 0 || f.max == 1
							&& c > 1))
				d = d + (f.countError + "\n")
		}
	return d.length > 0 ? d : null
...
mxGraph.prototype.getLabel = function(a) {
	...
	if (this.labelsVisible && a != null) {
		var c = this.view.getState(a), c = c != null ? c.style : this
				.getCellStyle(a);
		mxUtils.getValue(c, mxConstants.STYLE_NOLABEL, false)
...
mxGraph.prototype.isWrapping = function(a) {
	var b = this.view.getState(a), a = b != null ? b.style : this
			.getCellStyle(a);
...
mxGraph.prototype.getTooltip = function(a, b) {
	...
	if (a != null) {
		...
		c == null && a.overlays != null && a.overlays.visit(function(a, d) {
					if (c == null && (b == d.node || b.parentNode == d.node))
						c = d.overlay.toString()
				});
		if (c == null) {
			var d = this.selectionCellsHandler.getHandler(a.cell);
			d != null && typeof d.getTooltipForNode == "function"
					&& (c = d.getTooltipForNode(b))
		}
...
mxGraph.prototype.getTooltipForCell = function(a) {
	var b = null;
	return b = a != null && a.getTooltip != null ? a.getTooltip() : this
...
mxGraph.prototype.getStartSize = function(a) {
	var b = new mxRectangle, c = this.view.getState(a), a = c != null
			? c.style
			: this.getCellStyle(a);
	if (a != null) {
		c = parseInt(mxUtils.getValue(a, mxConstants.STYLE_STARTSIZE,
				mxConstants.DEFAULT_STARTSIZE));
		mxUtils.getValue(a, mxConstants.STYLE_HORIZONTAL, true)
				? b.height = c
				: b.width = c
	}
	return b
...
mxGraph.prototype.isSwimlane = function(a) {
	if (a != null && this.model.getParent(a) != this.model.getRoot()) {
		var b = this.view.getState(a), b = b != null ? b.style : this
				.getCellStyle(a);
...
mxGraph.prototype.isCellLocked = function(a) {
	var b = this.model.getGeometry(a);
	return this.isCellsLocked() || b != null && this.model.isVertex(a)
			&& b.relative
};
...
mxGraph.prototype.isCellResizable = function(a) {
	...
	return this.isCellsResizable() && !this.isCellLocked(a)
			&& b[mxConstants.STYLE_RESIZABLE] != 0
};
...
mxGraph.prototype.isCellBendable = function(a) {
	...
	return this.isCellsBendable() && !this.isCellLocked(a)
			&& b[mxConstants.STYLE_BENDABLE] != 0
};
...
mxGraph.prototype.isCellEditable = function(a) {
	...
	return this.isCellsEditable() && !this.isCellLocked(a)
			&& b[mxConstants.STYLE_EDITABLE] != 0
};
...
mxGraph.prototype.isValidSource = function(a) {
	return a == null && this.allowDanglingEdges || a != null
...
mxGraph.prototype.isCellFoldable = function(a) {
	var b = this.view.getState(a), b = b != null ? b.style : this
			.getCellStyle(a);
	return this.model.getChildCount(a) > 0
			&& b[mxConstants.STYLE_FOLDABLE] != 0
};
mxGraph.prototype.isValidDropTarget = function(a, b, c) {
	return a != null
			&& (this.isSplitEnabled() && this.isSplitTarget(a, b, c) || !this.model
					.isEdge(a)
					&& (this.isSwimlane(a) || this.model.getChildCount(a) > 0
							&& !this.isCellCollapsed(a)))
};
mxGraph.prototype.isSplitTarget = function(a, b) {
	if (this.model.isEdge(a)
			...
			&& this.getEdgeValidationError(a, this.model.getTerminal(a, true),
					b[0]) == null) {
		var c = this.model.getTerminal(a, true), d = this.model.getTerminal(a,
				false);
		return !this.model.isAncestor(b[0], c)
				&& !this.model.isAncestor(b[0], d)
	}
	return false
};
mxGraph.prototype.getDropTarget = function(a, b, c) {
	...
	if (c == null)
		...
		for (var e = this.model.getParent(d); e != null && this.isSwimlane(e)
				&& e != c;)
			e = this.model.getParent(e);
		e == c && (c = d)
	}
	for (; c != null && !this.isValidDropTarget(c, a, b)
	...
	if (c != null)
		for (var d = this.model.getChildCount(c), e = 0; e < d; e++) {
			...
			if (this.isSwimlane(f)
					&& this.intersects(this.view.getState(f), a, b))
				return f
		}
	return null
};
mxGraph.prototype.getCellAt = function(a, b, c, d, e) {
	...
	if (c != null)
		for (var f = this.model.getChildCount(c) - 1; f >= 0; f--) {
			...
			if (this.isCellVisible(g)
					...
					&& this.intersects(this.view.getState(g), a, b))
				return g
		}
	return null
};
mxGraph.prototype.intersects = function(a, b, c) {
	if (a != null) {
		...
		if (d != null)
			for (var a = this.tolerance * this.tolerance, e = d[0], f = 1; f < d.length; f++) {
				var g = d[f];
				if (mxUtils.ptSegDistSq(e.x, e.y, g.x, g.y, b, c) <= a)
					return true;
				e = g
			}
		else if (mxUtils.contains(a, b, c))
			return true
	}
	return false
};
mxGraph.prototype.hitsSwimlaneContent = function(a, b, c) {
	...
	if (d != null) {
		...
		if (a.width > 0 && b > 0 && b > a.width * e || a.height > 0 && c > 0
				&& c > a.height * e)
			return true
	}
	return false
...
mxGraph.prototype.getChildCells = function(a, b, c) {
	...
	a = this.model.getChildCells(a, b != null ? b : false, c != null
					? c
					: false);
	b = [];
	for (c = 0; c < a.length; c++)
...
mxGraph.prototype.getEdges = function(a, b, c, d, e, f) {
	for (var c = c != null ? c : true, d = d != null ? d : true, e = e != null
			? e
			: true, f = f != null ? f : false, g = [], h = this
			.isCellCollapsed(a), k = this.model.getChildCount(a), i = 0; i < k; i++) {
		var l = this.model.getChildAt(a, i);
		if (h || !this.isCellVisible(l))
			g = g.concat(this.model.getEdges(l, c, d))
	}
	g = g.concat(this.model.getEdges(a, c, d));
	h = [];
	for (i = 0; i < g.length; i++) {
		l = this.view.getState(g[i]);
		k = l != null ? l.getVisibleTerminal(true) : this.view
				.getVisibleTerminal(g[i], true);
		l = l != null ? l.getVisibleTerminal(false) : this.view
				.getVisibleTerminal(g[i], false);
		(e && k == l || k != l
				&& (c && l == a && (b == null || this.isValidAncestor(k, b, f)) || d
						&& k == a
						&& (b == null || this.isValidAncestor(l, b, f))))
				&& h.push(g[i])
	}
	return h
};
...
mxGraph.prototype.getOpposites = function(a, b, c, d) {
	...
	if (a != null)
		for (var g = 0; g < a.length; g++) {
			var h = this.view.getState(a[g]), k = h != null ? h
					.getVisibleTerminal(true) : this.view.getVisibleTerminal(
					a[g], true), h = h != null
					? h.getVisibleTerminal(false)
					: this.view.getVisibleTerminal(a[g], false);
			if (k == b && h != null && h != b && d) {
...
mxGraph.prototype.getEdgesBetween = function(a, b, c) {
	for (var c = c != null ? c : false, d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
		var g = this.view.getState(d[f]), h = g != null ? g
				.getVisibleTerminal(true) : this.view.getVisibleTerminal(d[f],
				true), g = g != null ? g.getVisibleTerminal(false) : this.view
				.getVisibleTerminal(d[f], false);
...
mxGraph.prototype.getPointForEvent = function(a, b) {
	var c = mxUtils.convertPoint(this.container, mxEvent.getClientX(a), mxEvent
					.getClientY(a)), d = this.view.scale, e = this.view.translate, f = b != false
			? this.gridSize / 2
			: 0;
...
mxGraph.prototype.getCells = function(a, b, c, d, e, f) {
	...
	if (c > 0 || d > 0) {
		...
		if (e != null)
			for (var k = this.model.getChildCount(e), i = 0; i < k; i++) {
				var l = this.model.getChildAt(e, i), m = this.view.getState(l);
				this.isCellVisible(l)
						&& m != null
						&& (m.x >= a && m.y >= b && m.x + m.width <= g
								&& m.y + m.height <= h ? f.push(l) : this
								.getCells(a, b, c, d, l, f))
			}
	}
	return f
};
	...
	if (d || e) {
		...
		if (c != null)
			for (var g = this.model.getChildCount(c), h = 0; h < g; h++) {
				...
				this.isCellVisible(k) && i != null && (!d || i.x >= a)
						&& (!e || i.y >= b) && f.push(k)
			}
	}
	return f
	...
	if (a != null) {
		for (var e = this.getModel(), f = e.getChildCount(a), g = null, h = 0, k = 0; k < f; k++) {
			...
			if (this.model.isVertex(i) && this.isCellVisible(i)) {
				for (var l = this.getConnections(i, b ? a : null), m = 0, n = 0, o = 0; o < l.length; o++)
					this.view.getVisibleTerminal(l[o], true) == i ? m++ : n++;
				...
				if (d > 0)
					for (f = 0; f < d; f++) {
						var g = this.model.getEdgeAt(a, f), h = this.model
								.getTerminal(g, true) == a;
						(!b || h)
								&& this.traverse(this.model.getTerminal(g, !h),
										b, c, g, e)
					}
			}
		}
...
mxGraph.prototype.selectCell = function(a, b, c) {
	...
	var d = e != null ? this.model.getParent(e) : this.getDefaultParent(), f = this.model
			.getChildCount(d);
	if (e == null && f > 0) {
		a = this.model.getChildAt(d, 0);
		this.setSelectionCell(a)
	} else if ((e == null || b) && this.view.getState(d) != null
			&& this.model.getGeometry(d) != null)
...
mxGraph.prototype.selectCells = function(a, b, c) {
	...
	this.setSelectionCells(this.model.filterDescendants(mxUtils.bind(this,
					function(c) {
						return this.view.getState(c) != null
								&& this.model.getChildCount(c) == 0
								&& (this.model.isVertex(c) && a || this.model
										.isEdge(c)
										&& b)
					}), c))
};
mxGraph.prototype.selectCellForEvent = function(a, b) {
	...
	this.isToggleEvent(b) ? c ? this.removeSelectionCell(a) : this
			.addSelectionCell(a) : (!c || this.getSelectionCount() != 1)
			&& this.setSelectionCell(a)
};
...
mxGraph.prototype.createHandler = function(a) {
	...
	if (a != null)
		if (this.model.isEdge(a.cell)) {
			...
			b = this.isLoop(a) || b == mxEdgeStyle.ElbowConnector
...
mxGraph.prototype.fireMouseEvent = function(a, b, c) {
	...
	if (mxClient.IS_TOUCH && this.doubleTapEnabled && a == mxEvent.MOUSE_DOWN) {
		...
		if (d - this.lastTouchTime < this.doubleTapTimeout
	...
	if (mxClient.IS_IE && document.compatMode == "CSS1Compat") {
		if (this.lastMouseX != null
				&& Math.abs(this.lastMouseX - b.getX()) > this.doubleTapTolerance
				|| this.lastMouseY != null
				&& Math.abs(this.lastMouseY - b.getY()) > this.doubleTapTolerance)
			d = true;
...
mxCellOverlay.prototype.getBounds = function(a) {
	...
	if (b) {
		...
		d = new mxPoint;
		d.x = this.align == mxConstants.ALIGN_LEFT
				? a.x
				: this.align == mxConstants.ALIGN_CENTER
						? a.x + a.width / 2
						: a.x + a.width;
		d.y = this.verticalAlign == mxConstants.ALIGN_TOP
				? a.y
				: this.verticalAlign == mxConstants.ALIGN_MIDDLE ? a.y
						+ a.height / 2 : a.y + a.height
	}
	return new mxRectangle(d.x - (e * this.defaultOverlap - this.offset.x) * c,
			d.y - (f * this.defaultOverlap - this.offset.y) * c, e * c, f * c)
};
...
mxOutline.prototype.init = function(a) {
	...
	this.outline.graphModelChanged = mxUtils.bind(this, function(a) {
				!this.suspended && this.outline != null
	...
	mxEvent.addListener(this.sizer.node, mxClient.IS_TOUCH
					? "touchstart"
					: "mousedown", mxUtils.bind(this, function(a) {
...
mxOutline.prototype.createSizer = function() {
	if (this.sizerImage != null) {
		var a = new mxImageShape(new mxRectangle(0, 0, this.sizerImage.width,
						this.sizerImage.height), this.sizerImage.src);
		a.dialect = this.outline.dialect
	} else {
		a = new mxRectangleShape(new mxRectangle(0, 0, this.sizerSize,
						this.sizerSize), mxConstants.OUTLINE_HANDLE_FILLCOLOR,
	...
	if (this.source != null) {
		...
		if (e > 0) {
			...
			this.bounds = new mxRectangle((c.x - b.x - this.source.panDx) / g,
					...
					h.clientHeight / f);
			this.bounds.x = this.bounds.x + this.source.container.scrollLeft
					* d.scale / e;
			this.bounds.y = this.bounds.y + this.source.container.scrollTop
					* d.scale / e;
			...
			if (c.x != d.x || c.y != d.y || c.width != d.width
					|| c.height != d.height) {
				this.sizer.bounds = d;
				this.sizer.node.style.visibility != "hidden"
						&& this.sizer.redraw()
			}
...
mxOutline.prototype.mouseMove = function(a, b) {
	if (this.active) {
		...
		if (this.zoom) {
			...
			e = new mxRectangle(this.bounds.x, this.bounds.y, Math.max(1,
							this.bounds.width + c), Math.max(1,
							this.bounds.height + d));
			this.selectionBorder.bounds = e;
			this.selectionBorder.redraw()
		} else {
			var f = this.outline.getView().scale, e = new mxRectangle(
					this.bounds.x + c, this.bounds.y + d, this.bounds.width,
					this.bounds.height);
			this.selectionBorder.bounds = e;
			this.selectionBorder.redraw();
		...
		c = this.sizer.bounds;
		this.sizer.bounds = new mxRectangle(e.x + e.width - c.width / 2, e.y
						+ e.height - c.height / 2, c.width, c.height);
...
mxOutline.prototype.mouseUp = function(a, b) {
	if (this.active) {
		...
		if (Math.abs(c) > 0 || Math.abs(d) > 0) {
			if (this.zoom) {
				var d = this.selectionBorder.bounds.width, e = this.source
						.getView().scale;
...
mxMultiplicity.prototype.check = function(a, b, c, d, e, f) {
	...
	if (this.source && this.checkTerminal(a, c, b) || !this.source
		...
		if (this.countError != null
				&& (this.source && (this.max == 0 || e >= this.max) || !this.source
						&& (this.max == 0 || f >= this.max)))
			g = g + (this.countError + "\n");
		this.validNeighbors != null
				&& (this.typeError != null && this.validNeighbors.length > 0)
				&& (this.checkNeighbors(a, b, c, d) || (g = g
						+ (this.typeError + "\n")))
	}
	return g.length > 0 ? g : null
};
mxMultiplicity.prototype.checkNeighbors = function(a, b, c, d) {
	for (var b = a.model.getValue(c), d = a.model.getValue(d), c = !this.validNeighborsAllowed, e = this.validNeighbors, f = 0; f < e.length; f++)
...
mxLayoutManager.prototype.beforeUndo = function(a) {
	...
	if (this.isBubbling())
		for (var c = b.getParents(a); c.length > 0;) {
			a = a.concat(c);
			c = b.getParents(c)
		}
...
mxSpaceManager.prototype.cellResized = function(a) {
	...
	if (e != null && f != null) {
		...
		if (g != null && h != null) {
			var k = c.translate, i = c.scale, c = e.x - f.origin.x - k.x * i, f = e.y
					- f.origin.y - k.y * i, k = e.x + e.width, l = e.y
					+ e.height, m = e.width - h.width * i + c - h.x * i, n = e.height
					- h.height * i + f - h.y * i, o = 1 - h.width * i / e.width, e = 1
					- h.height * i / e.height;
			d.beginUpdate();
			try {
				for (h = 0; h < g.length; h++)
					g[h] != a
							...
							&& this.shiftCell(g[h], m, n, c, f, k, l, o, e,
...
mxSwimlaneManager.prototype.isCellHorizontal = function(a) {
	if (this.graph.isSwimlane(a)) {
		var b = this.graph.view.getState(a), a = b != null
				? b.style
				: this.graph.getCellStyle(a);
...
mxSwimlaneManager.prototype.resizeSwimlane = function(a, b, c) {
	...
	try {
		...
		for (var g = this.graph.isSwimlane(a)
				? this.graph.getStartSize(a)
				: new mxRectangle, b = b - g.width, c = c - g.height, h = d
				.getChildCount(a), e = 0; e < h; e++)
			this.resizeSwimlane(d.getChildAt(a, e), b, c)
	} finally {
		d.endUpdate()
	}
};
...
function mxTemporaryCellStates(a, b, c) {
	...
	a.setScale(b);
	if (c != null) {
		for (var b = a.createState(new mxCell), d = 0; d < c.length; d++)
...
mxCellStatePreview.prototype.moveState = function(a, b, c, d, e) {
	var d = d != null ? d : true, e = e != null ? e : true, f = mxCellPath
			.create(a.cell), g = this.deltas[f];
	if (g == null) {
		g = new mxPoint(b, c);
		this.deltas[f] = g;
		this.count++
...
mxCellStatePreview.prototype.revalidateState = function(a, b, c, d, e) {
	if (b != null) {
		...
		if ((c != 0 || d != 0) && h != null && h.relative && g.isVertex(b.cell)
				&& (a == null || g.isVertex(a.cell) || this.deltas[f] != null)) {
			b.x = b.x + c;
			b.y = b.y + d;
...
mxGraphHandler.prototype.mouseDown = function(a, b) {
	if (!b.isConsumed() && this.isEnabled() && this.graph.isEnabled()
			&& !this.graph.isForceMarqueeEvent(b.getEvent())
			&& b.getState() != null) {
		...
		if (this.isMoveEnabled()) {
			...
			this.graph.isCellMovable(c)
					&& (!d.isEdge(c) || this.graph.getSelectionCount() > 1
							|| e.points != null && e.points.length > 0
							|| d.getTerminal(c, true) == null
							|| d.getTerminal(c, false) == null
...
mxGraphHandler.prototype.getGuideStates = function() {
	var a = this.graph.getDefaultParent(), b = this.graph.getModel(), c = mxUtils
			.bind(this, function(a) {
						return this.graph.view.getState(a) != null
								&& b.isVertex(a) && b.getGeometry(a) != null
...
mxGraphHandler.prototype.createPreviewShape = function(a) {
	...
	if (this.htmlPreview) {
		...
		a.dialect == mxConstants.DIALECT_SVG ? a.node.setAttribute("style",
				"pointer-events:none;") : a.node.style.background = ""
	}
	return a
};
...
mxGraphHandler.prototype.useGuidesForEvent = function(a) {
	return this.guide != null
			? this.guide.isEnabledForEvent(a.getEvent())
			: true
};
...
mxGraphHandler.prototype.mouseMove = function(a, b) {
	var c = this.graph;
	if (!b.isConsumed() && c.isMouseDown && this.cell != null
			&& this.first != null && this.bounds != null) {
		var d = mxUtils.convertPoint(c.container, b.getX(), b.getY()), e = d.x
				- this.first.x, f = d.y - this.first.y, d = c.tolerance;
		if (this.shape != null || Math.abs(e) > d || Math.abs(f) > d) {
			...
			var g = c.isGridEnabledEvent(b.getEvent()), d = true;
			if (this.guide != null && this.useGuidesForEvent(b)) {
				...
				var h = c.getView().translate, k = c.getView().scale, g = this.bounds.x
						...
						- (c.snap(this.bounds.y / k - h.y) + h.y) * k, f = this
						.snap(new mxPoint(e, f)), e = f.x - g, f = f.y - h;
			this.guide != null && d && this.guide.hide();
			c.isConstrainedEvent(b.getEvent())
					&& (Math.abs(e) > Math.abs(f) ? f = 0 : e = 0);
			this.currentDx = e;
			this.currentDy = f;
			this.updatePreviewShape();
			e = null;
			...
			c.isDropEnabled() && this.highlightEnabled
					&& (e = c.getDropTarget(this.cells, b.getEvent(), d));
			f = e;
			for (g = c.getModel(); f != null && f != this.cells[0];)
				f = g.getParent(f);
			var h = c.isCloneEvent(b.getEvent()) && c.isCellsCloneable()
					&& this.isCloneEnabled(), k = c.getView().getState(e), i = false;
			if (k != null && f == null && (g.getParent(this.cell) != e || h)) {
				...
				this.target = null;
				if (this.connectOnDrop && d != null && this.cells.length == 1
						&& c.getModel().isVertex(d) && c.isCellConnectable(d)) {
					k = c.getView().getState(d);
					if (k != null) {
						this.setHighlightColor(c.getEdgeValidationError(null,
								this.cell, d) == null
			...
			k != null && i ? this.highlight.highlight(k) : this.highlight
					.hide()
		}
		b.consume();
		mxEvent.consume(b.getEvent())
	} else if ((this.isMoveEnabled() || this.isCloneEnabled())
			&& this.updateCursor && !b.isConsumed() && b.getState() != null
			&& !c.isMouseDown) {
...
mxGraphHandler.prototype.updatePreviewShape = function() {
	if (this.shape != null) {
		this.shape.bounds = new mxRectangle(this.bounds.x + this.currentDx
						- this.graph.panDx, this.bounds.y + this.currentDy
						- this.graph.panDy, this.bounds.width,
				this.bounds.height);
		this.shape.redraw()
	}
};
...
mxGraphHandler.prototype.mouseUp = function(a, b) {
	if (!b.isConsumed()) {
		...
		if (this.cell != null && this.first != null && this.shape != null
			...
			if (this.connectOnDrop && this.target == null && g != null
					&& c.getModel().isVertex(g) && c.isCellConnectable(g)
					&& c.isEdgeValid(null, this.cell, g))
				c.connectionHandler.connect(this.cell, g, b.getEvent());
			else {
				g = this.target;
				c.isSplitEnabled()
			...
			this.isSelectEnabled()
					&& (this.delayedSelection && this.cell != null)
...
mxPanningHandler.prototype.init = function() {
	...
	mxEvent.addListener(this.div,
			mxClient.IS_TOUCH ? "touchmove" : "mousemove", mxUtils.bind(this,
					function() {
						this.graph.tooltipHandler.hide()
					}))
};
mxPanningHandler.prototype.isPanningTrigger = function(a) {
	...
	return this.useLeftButtonForPanning
			&& (this.ignoreCell || a.getState() == null)
...
mxPanningHandler.prototype.mouseMove = function(a, b) {
	...
	if (this.active) {
		...
		var e = this.active;
		this.active = Math.abs(c) > this.graph.tolerance
				|| Math.abs(d) > this.graph.tolerance;
		!e
				&& this.active
				&& this.fireEvent(new mxEventObject(mxEvent.PAN_START, "event",
						b))
	}
};
mxPanningHandler.prototype.mouseUp = function(a, b) {
	...
	if (this.active) {
		...
		b.consume()
	} else if (this.popupTrigger && c < this.graph.tolerance
			&& d < this.graph.tolerance) {
		c = this.getCellForPopupEvent(b);
		this.graph.isEnabled() && this.selectOnPopup && c != null
				&& !this.graph.isCellSelected(c) ? this.graph
				.setSelectionCell(c) : this.clearSelectionOnBackground
				&& c == null && this.graph.clearSelection();
		this.graph.tooltipHandler.hide();
...
mxCellMarker.prototype.process = function(a) {
	var b = null;
	if (this.isEnabled()) {
		var b = this.getState(a), c = b != null ? this.isValidState(b) : false, a = this
				.getMarkerColor(a.getEvent(), b, c);
...
mxCellMarker.prototype.intersects = function(a, b) {
	return this.hotspotEnabled ? mxUtils.intersectsHotspot(a, b.getGraphX(), b
			...
			mxConstants.MAX_HOTSPOT_SIZE) : true
};
...
mxConnectionHandler.prototype.createShape = function() {
	...
	if (this.graph.dialect == mxConstants.DIALECT_SVG) {
		...
		var b = mxUtils.bind(this, function(a) {
					a = mxUtils.convertPoint(this.graph.container, mxEvent
									.getClientX(a), mxEvent.getClientY(a));
					return this.graph.view.getState(this.graph.getCellAt(a.x,
							a.y))
				});
...
mxConnectionHandler.prototype.isMoveIconToFrontForState = function(a) {
	return a.text != null && a.text.node.parentNode == this.graph.container
			? true
			: this.moveIconFront
};
...
mxConnectionHandler.prototype.getIconPosition = function(a, b) {
	...
	if (this.graph.isSwimlane(b.cell))
		var f = this.graph.getStartSize(b.cell), d = f.width != 0 ? b.x
				+ f.width * c / 2 : d, e = f.height != 0 ? b.y + f.height * c
				/ 2 : e;
...
mxConnectionHandler.prototype.isStartEvent = function(a) {
	return !this.graph.isForceMarqueeEvent(a.getEvent())
			&& (this.constraintHandler.currentFocus != null
					&& this.constraintHandler.currentConstraint != null || this.previous != null
					&& this.error == null
...
mxConnectionHandler.prototype.mouseDown = function(a, b) {
	...
	if (this.isEnabled() && this.graph.isEnabled() && !b.isConsumed()
		...
		this.previous == null
				&& this.edgeState != null
				&& this.edgeState.cell.geometry.setTerminalPoint(this.graph
								.getPointForEvent(b.getEvent()), true);
		this
...
mxConnectionHandler.prototype.mouseMove = function(a, b) {
	if (this.tapAndHoldValid)
		this.tapAndHoldValid = Math.abs(this.initialTouchX - b.getX()) < this.tapAndHoldTolerance
		...
		if (this.first != null) {
			...
			if (this.selectedIcon != null) {
				...
				if (this.currentState != null && this.targetConnectImage) {
					...
					this.selectedIcon.bounds = new mxRectangle(b.getGraphX()
									+ this.connectIconOffset.x, b.getGraphY()
									+ this.connectIconOffset.y, g, h);
				this.selectedIcon.redraw()
			}
			if (this.edgeState != null) {
				this.edgeState.absolutePoints = [null,
						this.currentState != null ? null : e];
				this.graph.view.updateFixedTerminalPoint(this.edgeState,
						this.previous, true, this.sourceConstraint);
				...
				if (this.sourceConstraint == null && this.previous != null) {
					d = this.getSourcePerimeterPoint(this.previous,
			...
			this.previous == this.currentState
					&& (this.currentState != null && this.icons == null && !this.graph.isMouseDown)
					&& b.consume();
		this.constraintHandler.currentConstraint != null && this.marker.reset();
		if (!this.graph.isMouseDown && this.currentState != null
				&& this.icons != null) {
			c = false;
			f = b.getSource();
...
mxConnectionHandler.prototype.getTargetPerimeterPoint = function(a) {
	...
	if (d != null) {
		var e = this.waypoints != null && this.waypoints.length > 0
				? this.waypoints[this.waypoints.length - 1]
				: new mxPoint(this.previous.getCenterX(), this.previous
								.getCenterY()), a = d(c.getPerimeterBounds(a),
				this.edgeState, e, false);
		a != null && (b = a)
	} else
...
mxConnectionHandler.prototype.addWaypointForEvent = function(a) {
	...
	if (this.waypoints != null || this.mouseDownCounter > 1
			&& (c > this.graph.tolerance || b > this.graph.tolerance)) {
		if (this.waypoints == null)
			this.waypoints = [];
		c = this.graph.view.scale;
		b = new mxPoint(this.graph.snap(a.getGraphX() / c) * c, this.graph
						.snap(a.getGraphY() / c)
						* c);
...
mxConnectionHandler.prototype.mouseUp = function(a, b) {
	if (!b.isConsumed() && this.isConnecting()) {
		...
		if (this.error == null) {
			...
			this.previous != null
					&& (this.marker.validState != null && this.previous.cell == this.marker.validState.cell)
...
mxConnectionHandler.prototype.drawPreview = function() {
	...
	this.shape.dialect == mxConstants.DIALECT_SVG ? this.shape.innerNode
			.setAttribute("stroke", b) : this.shape.node.strokecolor = b;
...
mxConnectionHandler.prototype.connect = function(a, b, c, d) {
	if (b != null || this.isCreateTarget() || this.graph.allowDanglingEdges) {
		...
		try {
			...
			if (a != null && b != null && e.getParent(a) == e.getParent(b)
					&& e.getParent(e.getParent(a)) != e.getRoot()) {
				k = e.getParent(a);
				a.geometry != null && a.geometry.relative
						&& (b.geometry != null && b.geometry.relative)
						&& (k = e.getParent(k))
			}
			h = g = null;
			if (this.edgeState != null) {
			...
			if (f != null) {
				this.graph.setConnectionConstraint(f, a, true,
						this.sourceConstraint);
				this.graph.setConnectionConstraint(f, b, false,
				...
				if (this.waypoints != null && this.waypoints.length > 0) {
					...
					for (a = 0; a < this.waypoints.length; a++) {
						...
						i.points
								.push(new mxPoint(n.x / l - m.x, n.y / l - m.y))
					}
				}
				if (b == null) {
...
mxConstraintHandler.prototype.update = function(a, b) {
	if (this.isEnabled()) {
		...
		if (this.currentFocusArea == null
				...
				&& e
				&& this.graph.getModel().getParent(a.getCell()) == this.currentFocus.cell) {
			this.currentFocusArea = null;
			if (a.getState() != this.currentFocus) {
				this.currentFocus = null;
				this.constraints = a.getState() != null && e ? this.graph
						.getAllConnectionConstraints(a.getState(), b) : null;
		...
		if (this.focusIcons != null && this.constraints != null
				&& (a.getState() == null || this.currentFocus == a.getState()))
			for (e = 0; e < this.focusIcons.length; e++)
				if (mxUtils.intersects(this.focusIcons[e].bounds, d)) {
					...
					if (this.focusHighlight == null) {
						c = new mxRectangleShape(c, null, this.highlightColor,
								3);
...
mxRubberband.prototype.mouseDown = function(a, b) {
	if (!b.isConsumed()
			...
			&& (this.graph.isForceMarqueeEvent(b.getEvent()) || b.getState() == null)) {
		...
		if (mxClient.IS_NS && !mxClient.IS_SF && !mxClient.IS_GC) {
			var e = this.graph.container, f = function(a) {
				var a = new mxMouseEvent(a), b = mxUtils.convertPoint(e, a
								.getX(), a.getY());
				a.graphX = b.x;
				a.graphY = b.y;
				return a
...
mxRubberband.prototype.mouseUp = function(a, b) {
	...
	this.reset();
	if (c) {
		this.graph.selectRegion(new mxRectangle(this.x, this.y, this.width,
						this.height), b.getEvent());
		b.consume()
	}
};
...
mxVertexHandler.prototype.createSizerShape = function(a, b, c) {
	...
	a = new mxRectangleShape(a, c || mxConstants.HANDLE_FILLCOLOR,
...
mxVertexHandler.prototype.getHandleForEvent = function(a) {
	if (a.isSource(this.labelShape))
		return mxEvent.LABEL_HANDLE;
	if (this.sizers != null)
		for (var b = this.tolerance, b = this.allowHandleBoundsCheck
				&& (mxClient.IS_IE || b > 0) ? new mxRectangle(a.getGraphX()
						- b, a.getGraphY() - b, 2 * b, 2 * b) : null, c = 0; c < this.sizers.length; c++)
			if (a.isSource(this.sizers[c]) || b != null
					&& this.sizers[c].node.style.visibility != "hidden"
					&& mxUtils.intersects(this.sizers[c].bounds, b))
				return c;
	return null
};
mxVertexHandler.prototype.mouseDown = function(a, b) {
	if (!b.isConsumed() && this.graph.isEnabled()
			&& !this.graph.isForceMarqueeEvent(b.getEvent())
			&& (this.tolerance > 0 || b.getState() == this.state)) {
...
mxVertexHandler.prototype.mouseMove = function(a, b) {
	if (!b.isConsumed() && this.index != null) {
		...
		if (this.index == mxEvent.LABEL_HANDLE) {
			...
			this.bounds = this.union(this.selectionBounds, c.x - this.startX,
					c.y - this.startY, this.index, d, e,
					this.graph.view.translate);
			this.drawPreview();
			b.consume()
		}
	} else
		this.getHandleForEvent(b) != null && b.consume(false)
};
mxVertexHandler.prototype.mouseUp = function(a, b) {
	if (!b.isConsumed() && this.index != null && this.state != null) {
		var c = new mxPoint(b.getGraphX(), b.getGraphY()), d = this.graph
				.getView().scale, e = this.graph.isGridEnabledEvent(b
				.getEvent());
		this.resizeCell(this.state.cell, (c.x - this.startX) / d,
				(c.y - this.startY) / d, this.index, e);
		this.reset();
		b.consume()
	}
};
	...
	if (this.sizers != null) {
		...
		if (this.singleSizer)
			...
			if (this.sizers.length > 1) {
				...
				this.moveSizerTo(this.sizers[8], d + a.absoluteOffset.x, e
								+ a.absoluteOffset.y)
			} else
				this.state.width >= 2 && this.state.height >= 2 ? this
						.moveSizerTo(this.sizers[0], d + a.absoluteOffset.x, e
										+ a.absoluteOffset.y) : this
...
mxVertexHandler.prototype.drawPreview = function() {
	if (this.preview != null) {
		...
		if (this.preview.node.parentNode == this.graph.container) {
			this.preview.bounds.width = Math.max(0, this.preview.bounds.width
							- 1);
			this.preview.bounds.height = Math.max(0, this.preview.bounds.height
							- 1)
		}
		this.preview.redraw()
	}
...
mxEdgeHandler.prototype.init = function() {
	...
	var a = mxClient.IS_TOUCH ? "touchstart" : "mousedown", b = mxClient.IS_TOUCH
			? "touchmove"
			: "mousemove", c = mxClient.IS_TOUCH ? "touchend" : "mouseup";
	...
	mxEvent.addListener(this.shape.node, a, mxUtils.bind(this, function(a) {
						this.addEnabled && this.isAddPointEvent(a) ? this
								.addPoint(this.state, a) : this.graph
								.fireMouseEvent(mxEvent.MOUSE_DOWN,
										new mxMouseEvent(a, this.state))
					}));
	mxEvent.addListener(this.shape.node, b, mxUtils.bind(this, function(a) {
		var b = this.state.cell;
		if (this.index != null) {
			var c = mxUtils.convertPoint(this.graph.container, mxEvent
							.getClientX(a), mxEvent.getClientY(a)), b = this.graph
					.getCellAt(c.x, c.y);
			this.graph.isSwimlane(b)
					&& this.graph.hitsSwimlaneContent(b, c.x, c.y)
					&& (b = null)
		}
		this.graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(a,
						this.graph.getView().getState(b)))
	}));
...
mxEdgeHandler.prototype.createMarker = function() {
	...
	a.getCell = function(a) {
		...
		if (!b.isConnectableCell(d))
			return null;
		var e = b.graph.getModel();
		if (d == b.state.cell || d != null && !b.graph.connectableEdges
				&& e.isEdge(d))
			d = null;
		return d
	};
	a.isValidState = function(a) {
		var d = b.graph.getModel(), d = b.graph.view
				.getTerminalPort(a, b.graph.view.getState(d.getTerminal(
								b.state.cell, !b.isSource)), !b.isSource), d = d != null
				? d.cell
				: null;
	...
	for (var a = this.state.cell, b = [], c = 0; c < this.abspoints.length; c++)
		if (this.isHandleVisible(c)) {
			...
			if ((d = c == 0 || d) || this.graph.isCellBendable(a)) {
				...
				this.initBend(e);
				mxClient.IS_TOUCH
						&& e.node.setAttribute("pointer-events", "none");
				if (this.isHandleEnabled(c))
					if (mxClient.IS_TOUCH) {
						var f = mxUtils.bind(this, function(a) {
									a = mxUtils.convertPoint(
											this.graph.container, mxEvent
													.getClientX(a), mxEvent
													.getClientY(a));
									return this.graph.view.getState(this.graph
											.getCellAt(a.x, a.y))
								});
						mxEvent.redirectMouseEvents(e.node, this.graph, f)
					} else {
						e.node.style.cursor = mxConstants.CURSOR_BEND_HANDLE;
						mxEvent.redirectMouseEvents(e.node, this.graph,
								this.state)
					}
				b.push(e);
				if (!d) {
...
mxEdgeHandler.prototype.createHandleShape = function() {
	if (this.handleImage != null)
		return new mxImageShape(new mxRectangle(0, 0, this.handleImage.width,
						this.handleImage.height), this.handleImage.src);
...
mxEdgeHandler.prototype.getHandleForEvent = function(a) {
	if (this.bends != null)
		for (var b = this.tolerance, b = this.allowHandleBoundsCheck
				&& (mxClient.IS_IE || b > 0) ? new mxRectangle(a.getGraphX()
						- b, a.getGraphY() - b, 2 * b, 2 * b) : null, c = 0; c < this.bends.length; c++)
			if (a.isSource(this.bends[c]) || b != null
					&& this.bends[c].node.style.visibility != "hidden"
					&& mxUtils.intersects(this.bends[c].bounds, b))
				return c;
	if (a.isSource(this.labelShape) || a.isSource(this.state.text))
		if (!mxClient.IS_SF && !mxClient.IS_GC
				|| a.getSource().nodeName != "SELECT")
			return mxEvent.LABEL_HANDLE;
	return null
};
mxEdgeHandler.prototype.mouseDown = function(a, b) {
	var c = null, c = this.getHandleForEvent(b);
	if (c != null && !b.isConsumed() && this.graph.isEnabled()
			&& !this.graph.isForceMarqueeEvent(b.getEvent())) {
...
mxEdgeHandler.prototype.start = function(a, b, c) {
	...
	if (this.isSource || this.isTarget) {
		...
		if (b == null && this.graph.isTerminalPointMovable(a, this.isSource)
				|| b != null
...
mxEdgeHandler.prototype.getPointForEvent = function(a) {
	var b = new mxPoint(a.getGraphX(), a.getGraphY()), c = this
			.getSnapToTerminalTolerance(), d = this.graph.getView(), e = false, f = false;
	...
	if (this.graph.isGridEnabledEvent(a.getEvent())) {
		...
		h = d.translate;
		if (!e)
			b.x = (this.graph.snap(b.x / a - h.x) + h.x) * a;
		if (!f)
...
mxEdgeHandler.prototype.getPreviewPoints = function(a) {
	var b = this.graph.getCellGeometry(this.state.cell), b = b.points != null
			? b.points.slice()
			: null;
	if (!this.isSource && !this.isTarget) {
		...
		this.graph.resetEdgesOnConnect && (b = null);
	return b
};
mxEdgeHandler.prototype.updatePreviewState = function(a, b, c) {
	var d = this.isSource ? c : this.state.getVisibleTerminalState(true), e = this.isTarget
			? c
			: this.state.getVisibleTerminalState(false), f = this.graph
			.getConnectionConstraint(a, d, true), g = this.graph
			.getConnectionConstraint(a, e, false), h = this.constraintHandler.currentConstraint;
	h == null && (h = new mxConnectionConstraint);
	this.isSource ? f = h : this.isTarget && (g = h);
	(!this.isSource || d != null)
			&& a.view.updateFixedTerminalPoint(a, d, true, f);
	(!this.isTarget || e != null)
			&& a.view.updateFixedTerminalPoint(a, e, false, g);
...
mxEdgeHandler.prototype.mouseMove = function(a, b) {
	if (this.index != null && this.marker != null) {
		...
		if (this.isLabel) {
			...
			var d = this.isSource || this.isTarget ? this
					.getPreviewTerminalState(b) : null, e = this
					.clonePreviewState(c, d != null ? d.cell : null);
			this.updatePreviewState(e, c, d);
			this.setPreviewColor(this.error == null
		...
		mxClient.IS_IE && this.getHandleForEvent(b) != null && b.consume(false)
};
...
mxEdgeHandler.prototype.setPreviewColor = function(a) {
	if (this.shape != null && this.shape.node != null)
		this.shape.dialect == mxConstants.DIALECT_SVG ? this.shape.innerNode
				.setAttribute("stroke", a) : this.shape.node.strokecolor = a
};
...
mxEdgeHandler.prototype.addPoint = function(a, b) {
	var c = this.graph.getCellGeometry(a.cell);
	if (c != null) {
		var c = c.clone(), d = mxUtils.convertPoint(this.graph.container,
				mxEvent.getClientX(b), mxEvent.getClientY(b)), e = mxUtils
				.findNearestSegment(a, d.x, d.y), f = this.graph
				.isGridEnabledEvent(b);
...
mxEdgeHandler.prototype.getHandleFillColor = function(a) {
	var a = a == 0, b = this.state.cell, c = this.graph.getModel().getTerminal(
			b, a), d = mxConstants.HANDLE_FILLCOLOR;
	if (c != null && !this.graph.isCellDisconnectable(b, c, a) || c == null
			&& !this.graph.isTerminalPointMovable(b, a))
		d = mxConstants.LOCKED_HANDLE_FILLCOLOR;
	else if (c != null && this.graph.isCellDisconnectable(b, c, a))
...
mxEdgeHandler.prototype.redraw = function() {
	...
	this.label = new mxPoint(this.state.absoluteOffset.x,
			this.state.absoluteOffset.y);
	this.labelShape.bounds = new mxRectangle(this.label.x - b / 2, this.label.y
					- b / 2, b, b);
	this.labelShape.redraw();
	b = this.graph.getLabel(a);
	this.labelShape.node.style.visibility = b != null && b.length > 0
			&& this.graph.isLabelMovable(a) ? "visible" : "hidden";
	if (this.bends != null && this.bends.length > 0) {
		var c = this.abspoints.length - 1, a = this.abspoints[0], b = this.bends[0].bounds;
		this.bends[0].bounds = new mxRectangle(this.abspoints[0].x - b.width
						/ 2, this.abspoints[0].y - b.height / 2, b.width,
				b.height);
		...
		this.bends[f].bounds = new mxRectangle(e - b.width / 2, c - b.height
						/ 2, b.width, b.height);
...
mxEdgeHandler.prototype.redrawInnerBends = function() {
	...
	if (a != null) {
		...
		for (var b = 1; b < this.bends.length - 1; b++)
			if (this.bends[b] != null)
				if (this.abspoints[b] != null) {
					var c = this.abspoints[b].x, d = this.abspoints[b].y, e = this.bends[b].bounds;
					this.bends[b].node.style.visibility = "visible";
					this.bends[b].bounds = new mxRectangle(c - e.width / 2, d
									- e.height / 2, e.width, e.height);
					this.bends[b].redraw();
...
mxEdgeHandler.prototype.drawPreview = function() {
	if (this.isLabel) {
		...
		this.labelShape.bounds = new mxRectangle(this.label.x - a / 2,
				this.label.y - a / 2, a, a);
		this.labelShape.redraw()
	} else {
...
mxElbowEdgeHandler.prototype.getTooltipForNode = function(a) {
	var b = null;
	if (this.bends != null && this.bends[1] != null
...
mxElbowEdgeHandler.prototype.redrawInnerBends = function(a, b) {
	var c = this.graph.getModel().getGeometry(this.state.cell).points, c = c != null
			? c[0]
			: null, c = c == null
			? new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2)
			: new mxPoint(
					this.graph.getView().scale
							* (c.x + this.graph.getView().translate.x + this.state.origin.x),
					this.graph.getView().scale
							* (c.y + this.graph.getView().translate.y + this.state.origin.y)), d = this.bends[1].bounds, e = d.width, d = d.height;
	if (this.handleImage == null)
		d = e = mxConstants.HANDLE_SIZE;
	var f = new mxRectangle(c.x - e / 2, c.y - d / 2, e, d);
	if (this.handleImage == null
			&& this.labelShape.node.style.visibility != "hidden"
			&& mxUtils.intersects(f, this.labelShape.bounds)) {
		e = e + 3;
		d = d + 3;
...
mxEdgeSegmentHandler.prototype.getPreviewPoints = function(a) {
	...
	if (d.length == 1) {
		...
		if (f != null & e != null)
			if (mxUtils.contains(f, d[0].x, d[0].y))
				b[1].y == b[2].y ? d[0].y = c.getRoutingCenterY(e) : d[0].x = c
						.getRoutingCenterX(e);
			else if (mxUtils.contains(e, d[0].x, d[0].y))
				b[1].y == b[0].y ? d[0].y = c.getRoutingCenterY(f) : d[0].x = c
						.getRoutingCenterX(f)
	} else
		d.length == 0 && (d = [a]);
	return d
...
mxEdgeSegmentHandler.prototype.createBends = function() {
	...
	if (this.graph.isCellBendable(this.state.cell)) {
		...
		for (var d = 0; d < c.length - 1; d++) {
			...
			a.push(b);
			b.node.style.cursor = c[d].x - c[d + 1].x == 0
					? "col-resize"
					: "row-resize";
			this.points.push(new mxPoint(0, 0));
			mxClient.IS_TOUCH && b.node.setAttribute("pointer-events", "none")
	...
	if (this.graph.isCellBendable(this.state.cell)) {
		...
		if (d != null && d.length > 1)
			for (var e = 0; e < this.state.absolutePoints.length - 1; e++)
				if (this.bends[e + 1] != null) {
					var a = d[e], b = d[e + 1], f = new mxPoint(a.x
									+ (b.x - a.x) / 2, a.y + (b.y - a.y) / 2);
					this.bends[e + 1].bounds = new mxRectangle(f.x - c / 2, f.y
									- c / 2, c, c);
...
mxKeyHandler.prototype.getFunction = function(a) {
	return a != null ? this.isControlDown(a) ? mxEvent.isShiftDown(a)
...
mxTooltipHandler.prototype.mouseMove = function(a, b) {
	if (b.getX() != this.lastX || b.getY() != this.lastY) {
		this.reset(b, true);
		(this.isHideOnHover() || b.getState() != this.state || b.getSource() != this.node
				&& (!this.stateSource || b.getState() != null
...
mxTooltipHandler.prototype.reset = function(a, b) {
	this.resetTimer();
	if (b && this.isEnabled() && a.getState() != null
		...
		this.thread = window.setTimeout(mxUtils.bind(this, function() {
							if (!this.graph.isEditing()
									&& !this.graph.panningHandler
											.isMenuShowing()) {
								this.show(this.graph.getTooltip(c, d, e, f), e,
										f);
								this.state = c;
								this.node = d;
								this.stateSource = g
...
mxTooltipHandler.prototype.destroy = function() {
	this.graph.removeMouseListener(this);
	mxEvent.release(this.div);
	this.div != null && this.div.parentNode != null
			&& this.div.parentNode.removeChild(this.div);
	this.div = null
};
	...
	if (this.state != null && this.shape != null) {
		this.graph.model.isEdge(this.state.cell)
				...
				: this.shape.bounds = new mxRectangle(this.state.x
								- this.spacing, this.state.y - this.spacing,
						this.state.width + 2 * this.spacing, this.state.height
								+ 2 * this.spacing);
		this.state.shape != null
				&& this.shape.setCursor(this.state.shape.getCursor());
		var a = !this.graph.model.isEdge(this.state.cell)
		...
		if (this.shape.dialect == mxConstants.DIALECT_SVG) {
			...
			if (a != 0) {
				...
				this.shape.node.setAttribute("transform", "rotate(" + a + " "
								+ b + " " + c + ")")
			}
		} else {
			this.shape.node.style.background = "";
			if (a != 0)
				this.shape.node.rotation = a
		}
		this.shape.redraw()
	}
};
...
mxDefaultPopupMenu.prototype.addItems = function(a, b, c, d, e, f, g) {
	for (var h = false; f != null;) {
		if (f.nodeName == "add") {
			...
			if (k == null || e[k]) {
				var k = f.getAttribute("as"), k = mxResources.get(k) || k, i = mxUtils
						.eval(mxUtils.getTextContent(f)), l = f
						.getAttribute("action"), m = f.getAttribute("icon"), n = f
...
mxDefaultToolbar.prototype.init = function(a) {
	if (a != null) {
		...
		this.toolbar.addListener(mxEvent.SELECT, mxUtils.bind(this, function(a,
								c) {
							var d = c.getProperty("function");
							this.editor.insertFunction = d != null ? mxUtils
									.bind(this, function() {
...
mxDefaultToolbar.prototype.addPrototype = function(a, b, c, d, e, f) {
	var g = function() {
		return typeof c == "function" ? c() : c != null ? c.clone() : null
				...
				typeof e == "function" ? e(this.editor, g(), a, b) : this.drop(
						g(), a, b);
				this.toolbar.resetMode();
				mxEvent.consume(a)
...
mxDefaultToolbar.prototype.drop = function(a, b, c) {
	...
	if (c == null || e.isEdge(c) || !this.connectOnDrop
			|| !d.isCellConnectable(c)) {
		for (; c != null && !d.isValidDropTarget(c, [a], b);)
			c = e.getParent(c);
		this.insert(a, b, c)
	} else
		this.connect(a, b, c)
...
mxDefaultToolbar.prototype.connect = function(a, b, c) {
	...
	if (c != null && b.isCellConnectable(a) && b.isEdgeValid(null, c, a)) {
		...
		try {
			...
			var h = this.spacing * b.gridSize, k = d.getDirectedEdgeCount(c,
					true)
					* 20;
			this.editor.horizontalFlow ? g.x = g.x
					+ ((g.width + f.width) / 2 + h + k) : g.y = g.y
					+ ((g.height + f.height) / 2 + h + k);
			a.setGeometry(g);
			var i = d.getParent(c);
			b.addCell(a, i);
			b.constrainChild(a);
...
mxEditor.prototype.addActions = function() {
	...
	this.addAction("zoom", function(a) {
				var b = a.graph.getView().scale * 100, b = parseFloat(mxUtils
	...
	this.addAction("toggleTasks", function(a) {
				a.tasks != null ? a.tasks.setVisible(!a.tasks.isVisible()) : a
						.showTasks()
			});
	this.addAction("toggleHelp", function(a) {
				a.help != null ? a.help.setVisible(!a.help.isVisible()) : a
						.showHelp()
			});
	this.addAction("toggleOutline", function(a) {
				a.outline == null ? a.showOutline() : a.outline
...
mxEditor.prototype.createSession = function() {
	return this.connect(this.urlInit, this.urlPoll, this.urlNotify, mxUtils
					.bind(this, function(a) {
								this.fireEvent(new mxEventObject(
										mxEvent.SESSION, "session", a))
							}))
};
...
mxEditor.prototype.execute = function(a, b, c) {
	...
	if (d != null)
		...
		mxUtils.error("Cannot find action " + a, 280, true)
};
...
mxEditor.prototype.createLayoutManager = function(a) {
	...
	b.getLayout = function(b) {
		...
		if (f.getParent(b) != null)
			if (c.layoutSwimlanes && a.isSwimlane(b)) {
				if (c.swimlaneLayout == null)
					c.swimlaneLayout = c.createSwimlaneLayout();
				e = c.swimlaneLayout
			} else if (c.layoutDiagram
					&& (a.isValidRoot(b) || f.getParent(f.getParent(b)) == null)) {
				if (c.diagramLayout == null)
					c.diagramLayout = c.createDiagramLayout();
				e = c.diagramLayout
			}
		return e
	};
...
mxEditor.prototype.installInsertHandler = function(a) {
	...
	a.addMouseListener({
				mouseDown : function(a, d) {
					if (b.insertFunction != null && !d.isPopupTrigger()
							&& (b.forcedInserting || d.getState() == null)) {
...
mxEditor.prototype.getTitle = function() {
	for (var a = "", b = this.graph, c = b.getCurrentRoot(); c != null
			&& b.getModel().getParent(b.getModel().getParent(c)) != null;) {
...
mxEditor.prototype.groupCells = function() {
	var a = this.groupBorderSize != null
...
mxEditor.prototype.writeGraphModel = function(a) {
	var a = a != null ? a : this.linefeed, b = (new mxCodec).encode(this.graph
			.getModel());
...
mxEditor.prototype.connect = function(a, b, c, d) {
	...
	if (!mxClient.IS_LOCAL) {
		...
		e.addListener(mxEvent.RECEIVE, mxUtils.bind(this, function(a, b) {
							b.getProperty("node").getAttribute("namespace") != null
									&& this.resetHistory()
						}));
...
mxEditor.prototype.createProperties = function(a) {
	...
	if (mxUtils.isNode(c)) {
		...
		for (var i = b.getStyle(a), l = d.addText("Style", i || ""), m = c.attributes, n = [], c = 0; c < m.length; c++)
			n[c] = d.addTextarea(m[c].nodeName, m[c].nodeValue,
					m[c].nodeName == "label" ? 4 : 2);
		c = mxUtils.bind(this, function() {
					this.hideProperties();
					b.beginUpdate();
					try {
						...
						l.value.length > 0 ? b.setStyle(a, l.value) : b
								.setStyle(a, null);
						for (var c = 0; c < m.length; c++) {
							var d = new mxCellAttributeChange(a, m[c].nodeName,
									n[c].value);
							b.execute(d)
						}
						this.graph.isAutoSizeCell(a)
								&& this.graph.updateCellSize(a)
					} finally {
						b.endUpdate()
					}
				});
...
mxEditor.prototype.showHelp = function() {
	if (this.help == null) {
		...
		var b = document.body.clientWidth, c = document.body.clientHeight
				|| document.documentElement.clientHeight, d = new mxWindow(
				mxResources.get(this.helpResource) || this.helpResource, a,
				(b - this.helpWidth) / 2, (c - this.helpHeight) / 3,
...
mxEditor.prototype.showOutline = function() {
	if (this.outline == null) {
		...
		var b = new mxWindow(mxResources.get(this.outlineResource)
						|| this.outlineResource, a, 600, 480, 200, 200, false), c = new mxOutline(
				this.graph, a);
		b.setClosable(true);
		b.setResizable(true);
		b.destroyOnClose = false;
...
mxEditor.prototype.createEdge = function() {
	...
	if (this.defaultEdge != null)
		a = this.graph.getModel().cloneCell(this.defaultEdge);
	else {
		a = new mxCell("");
		a.setEdge(true);
...
mxEditor.prototype.consumeCycleAttribute = function(a) {
	return this.cycleAttributeValues != null
			&& this.cycleAttributeValues.length > 0 && this.graph.isSwimlane(a)
...
mxEditor.prototype.addVertex = function(a, b, c, d) {
	for (var e = this.graph.getModel(); a != null
			&& !this.graph.isValidDropTarget(a);)
		a = e.getParent(a);
	var a = a != null ? a : this.graph.getSwimlaneAt(c, d), f = this.graph
			.getView().scale, g = e.getGeometry(b), h = e.getGeometry(a);
	if (this.graph.isSwimlane(b) && !this.graph.swimlaneNesting)
		a = null;
	else {
		if (a == null && this.swimlaneRequired)
			return null;
		if (a != null && h != null) {
			...
			if (k != null) {
				...
				if (this.graph.isConstrainedMoving) {
					var h = g.width, i = g.height, l = k.x + k.width;
					c + h > l && (c = c - (c + h - l));
					l = k.y + k.height;
					d + i > l && (d = d - (d + i - l))
				}
...
mxCodec.prototype.getElementById = function(a, b) {
	return mxUtils.findNodeByAttribute(this.document.documentElement, b != null
					? b
					: "id", a)
};
...
mxCodec.prototype.encode = function(a) {
	...
	if (a != null && a.constructor != null) {
		...
		c != null ? b = c.encode(this, a) : mxUtils.isNode(a)
				? b = mxClient.IS_IE ? a.cloneNode(true) : this.document
						.importNode(a, true)
...
mxCodec.prototype.encodeCell = function(a, b, c) {
	...
	if (c == null || c)
		for (var c = a.getChildCount(), d = 0; d < c; d++)
			this.encodeCell(a.getChildAt(d), b)
};
mxCodec.prototype.isCellCodec = function(a) {
	return a != null && typeof a.isCellCodec == "function"
			? a.isCellCodec()
			: false
};
mxCodec.prototype.decodeCell = function(a, b) {
	...
	if (a != null && a.nodeType == mxConstants.NODETYPE_ELEMENT) {
		...
		if (!this.isCellCodec(c))
			for (var d = a.firstChild; d != null && !this.isCellCodec(c);) {
...
mxObjectCodec.prototype.isExcluded = function(a, b) {
	return b == mxObjectIdentity.FIELD_NAME
			|| mxUtils.indexOf(this.exclude, b) >= 0
};
...
mxObjectCodec.prototype.encode = function(a, b) {
	var c = a.document.createElement(this.getName()), b = this.beforeEncode(a,
			b, c);
...
mxObjectCodec.prototype.writeAttribute = function(a, b, c, d, e) {
	typeof d != "object" ? this.writePrimitiveAttribute(a, b, c, d, e) : this
...
mxObjectCodec.prototype.writePrimitiveAttribute = function(a, b, c, d, e) {
	...
	if (c == null) {
		...
		typeof d == "function"
				? b.appendChild(a.document.createTextNode(d))
				: a.setAttribute(b, "value", d);
		e.appendChild(b)
	} else
		typeof d != "function" && a.setAttribute(e, c, d)
};
...
mxCodecRegistry.register(function() {
	...
	a.isExcluded = function(a, c, d, e) {
		return mxObjectCodec.prototype.isExcluded.apply(this, arguments) || e
				&& c == "value" && d.nodeType == mxConstants.NODETYPE_ELEMENT
	};
	a.afterEncode = function(a, c, d) {
		if (c.value != null && c.value.nodeType == mxConstants.NODETYPE_ELEMENT) {
			var e = d, d = mxClient.IS_IE
					? c.value.cloneNode(true)
					: a.document.importNode(c.value, true);
			d.appendChild(e);
			a = e.getAttribute("id");
			d.setAttribute("id", a);
...
mxCodecRegistry.register(function() {
			var a = new mxObjectCodec(new mxRootChange, ["model", "previous",
							"root"]);
			a.afterEncode = function(a, c, d) {
...
mxCodecRegistry.register(function() {
			...
			a.isReference = function(a, c, d, e) {
				return c == "child" && (a.previous != null || !e)
						? true
						: mxUtils.indexOf(this.idrefs, c) >= 0
			};
			a.afterEncode = function(a, c, d) {
				this.isReference(c, "child", c.child, true) ? d.setAttribute(
...
var mxGenericChangeCodec = function(a, b) {
	...
	c.afterDecode = function(a, c, f) {
		if (mxUtils.isNode(f.cell))
			f.cell = a.decodeCell(f.cell, false);
		f.previous = f[b];
		return f
	};
	return c
...
mxCodecRegistry.register(mxGenericChangeCodec(new mxCellAttributeChange,
		"value"));
mxCodecRegistry.register(function() {
	return new mxObjectCodec(new mxGraph, ["graphListeners", "eventListeners",
					"view", "container", "cellRenderer", "editor", "selection"])
}());
mxCodecRegistry.register(function() {
	...
	a.encodeCell = function(a, c, d) {
		...
		if (g == null || f != null) {
			...
			g == e.getRoot() ? i = "layer" : g == null ? i = "graph" : e
					.isEdge(d) ? i = "edge" : h > 0 && k != null
					? i = "group"
					: e.isVertex(d) && (i = "vertex");
			if (i != null) {
...
mxCodecRegistry.register(function() {
	...
	a.getStringValue = function(a, c) {
		var d = typeof c;
		d == "function" ? c = mxStyleRegistry.getName(style[j]) : d == "object"
				&& (c = null);
		return c
	};
	a.decode = function(a, c, d) {
		...
		for (c = c.firstChild; c != null;) {
			if (!this.processInclude(a, c, d) && c.nodeName == "add") {
				e = c.getAttribute("as");
				if (e != null) {
					var f = c.getAttribute("extend"), g = f != null ? mxUtils
							.clone(d.styles[f]) : null;
					if (g == null) {
						f != null
								&& mxLog
										.warn("mxStylesheetCodec.decode: stylesheet "
												+ f + " not found to extend");
						g = {}
					}
				...
				if (c.nodeType == mxConstants.NODETYPE_ELEMENT
					...
					if (c.nodeName == "separator")
						...
						var f = c.getAttribute("as"), f = mxResources.get(f)
								...
								.getAttribute("action"), i = c
								.getAttribute("mode"), l = c
								.getAttribute("template"), m = c
								.getAttribute("toggle") != "0", n = mxUtils
								.getTextContent(c), o = null;
						if (k != null)
							o = d.addItem(f, g, k, h);
						else if (i != null)
							var p = mxUtils.eval(n), o = d.addMode(f, g, i, h,
									p);
							...
							if (h.length > 0)
								if (g == null) {
									...
									var q = null, t = d.addPrototype(f, g,
											function() {
									...
									for (f = 0; f < h.length; f++) {
										...
										if (m.nodeName == "separator")
											...
											d.addOption(q, g, n || l).cellStyle = m
													.getAttribute("style")
										}
									}
								}
...
mxCodecRegistry.register(function() {
	var a = new mxObjectCodec(new mxEditor, ["modified", "lastSnapshot",
	...
	a.decodeUi = function(a, c, d) {
		for (a = c.firstChild; a != null;) {
			if (a.nodeName == "add") {
				var c = a.getAttribute("as"), e = a.getAttribute("element"), f = a
						.getAttribute("style"), g = null;
				if (e != null) {
					g = document.getElementById(e);
					if (g != null && f != null)
						g.style.cssText = g.style.cssText + (";" + f)
				} else {
					var e = parseInt(a.getAttribute("x")), h = parseInt(a
							.getAttribute("y")), k = a.getAttribute("width"), i = a
							.getAttribute("height"), g = document
							.createElement("div");
					g.style.cssText = f;
					(new mxWindow(mxResources.get(c) || c, g, e, h, k, i,
							false, true)).setVisible(true)
				}
				c == "graph" ? d.setGraphContainer(g) : c == "toolbar" ? d
						.setToolbarContainer(g) : c == "title" ? d
						.setTitleContainer(g) : c == "status" ? d
						.setStatusContainer(g) : c == "map"
						&& d.setMapContainer(g)
			} else
				a.nodeName == "resource" ? mxResources.add(a
						.getAttribute("basename")) : a.nodeName == "stylesheet"
	...
	a.decodeTemplates = function(a, c, d) {
		...
		for (var c = mxUtils.getChildNodes(c), e = 0; e < c.length; e++) {
			for (var f = c[e].getAttribute("as"), g = c[e].firstChild; g != null
					&& g.nodeType != 1;)
				g = g.nextSibling;
