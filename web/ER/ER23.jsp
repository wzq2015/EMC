     ...
     <tr>
           ...
           <div id="reportPara" style="overflow:auto;width:100%;height:100px;">
             <table>
               <tr>
                 ...
                 <td width=50% nowarp>
                   <EF:EFInput blockId="" ename="reportFileName" row="" />
                 </td>
               </tr>
               <tr>
                 <td width=50% align='right'>
       ...
       <td width=50% valign="top">
         <div id = "ef_region_para" title="报表生成参数" style="overflow:scroll" efRegionShowClear=true> 
           <div id = "ef_para_list" style="overflow:auto;width:100%;height:100px;">
           </div>
         </div>
       </td>
     </tr>
...
<div id = "ef_region_excel" title="EXCEL报表查看" style="overflow:scroll"> 
