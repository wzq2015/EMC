...
<head>
	...
	<script type="text/javascript" src="./ER/ER11.js"></script>
	
</head>
<body class="bodyBackground">

<form id="ER11" method="POST" action="<%=actionUrl%>" >
...
<EF:EFGrid blockId="result" autoDraw="no" readonly="false" >	
  ...
  <EF:EFColumn ename="reportUdn" cname="名称" width="100" fix="yes"  />
  <EF:EFColumn ename="reportUdnRow" cname="行号" width="30" fix="yes"  />
  <EF:EFColumn ename="reportUdnCol" cname="列号" width="30" fix="yes"  />
  <EF:EFColumn ename="reportUdnValue" cname="值" width="100" />
