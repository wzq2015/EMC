 ...
 * EEMD15
 */
public class EEMD15 extends DaoEPBase {
    ...
    */
	public void fromMap(Map map) {
          setTrustId(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("trustId")), trustId));
          setProjectName(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("projectName")), projectName));
          setRepType(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("repType")), repType));
          setJxglapplyId(NumberUtils.toInteger(StringUtils.toString(map.get("jxglapplyId")), jxglapplyId));
    ...
    */
	public Map toMap() {
        Map map = new HashMap();
	    map.put("trustId",StringUtils.toString(trustId, eiMetadata.getMeta("trustId")));
	    map.put("projectName",StringUtils.toString(projectName, eiMetadata.getMeta("projectName")));
	    map.put("repType",StringUtils.toString(repType, eiMetadata.getMeta("repType")));
	    map.put("jxglapplyId",StringUtils.toString(jxglapplyId, eiMetadata.getMeta("jxglapplyId")));
