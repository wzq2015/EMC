 ...
 * EEMD01
 */
public class EEMD01 extends DaoEPBase {
    ...
    */
	public void fromMap(Map map) {
          setFormEname(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formEname")), formEname));
          setFormCname(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formCname")), formCname));
          setFormLoadPath(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formLoadPath")), formLoadPath));
          setFormType(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formType")), formType));
          setModuleEname1(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("moduleEname1")), moduleEname1));
          setModuleEname2(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("moduleEname2")), moduleEname2));
          setInitLoadServiceEname(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("initLoadServiceEname")), initLoadServiceEname));
          setIsGrade(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("isGrade")), isGrade));
          setIsAuth(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("isAuth")), isAuth));
          setFormParam(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formParam")), formParam));
          setFormStyle(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("formStyle")), formStyle));
    ...
    */
	public Map toMap() {
        Map map = new HashMap();
	    map.put("formEname",StringUtils.toString(formEname, eiMetadata.getMeta("formEname")));
	    map.put("formCname",StringUtils.toString(formCname, eiMetadata.getMeta("formCname")));
	    map.put("formLoadPath",StringUtils.toString(formLoadPath, eiMetadata.getMeta("formLoadPath")));
	    map.put("formType",StringUtils.toString(formType, eiMetadata.getMeta("formType")));
	    map.put("moduleEname1",StringUtils.toString(moduleEname1, eiMetadata.getMeta("moduleEname1")));
	    map.put("moduleEname2",StringUtils.toString(moduleEname2, eiMetadata.getMeta("moduleEname2")));
	    map.put("initLoadServiceEname",StringUtils.toString(initLoadServiceEname, eiMetadata.getMeta("initLoadServiceEname")));
	    map.put("isGrade",StringUtils.toString(isGrade, eiMetadata.getMeta("isGrade")));
	    map.put("isAuth",StringUtils.toString(isAuth, eiMetadata.getMeta("isAuth")));
	    map.put("formParam",StringUtils.toString(formParam, eiMetadata.getMeta("formParam")));
	    map.put("formStyle",StringUtils.toString(formStyle, eiMetadata.getMeta("formStyle")));
