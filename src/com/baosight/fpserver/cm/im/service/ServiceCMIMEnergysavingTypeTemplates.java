...
//			TOperationLog log = OperationLogHelper.GenerateOperationLog(2, "��ӽ�������" + energysavingType.getF_energysavingTypeName());
...
//			TOperationLog log = OperationLogHelper.GenerateOperationLog(2, "�޸Ľ�������" + energysavingType.getF_energysavingTypeName());
//			this.dao.insert("tOperationLog.insert", log);
		}catch(Exception e){
			outInfo.set("errorcode", "-1");
		}
...
//			TOperationLog log = OperationLogHelper.GenerateOperationLog(2, "�޸Ľ������㹫ʽ");
//			this.dao.insert("tOperationLog.insert", log);
		}catch(Exception e){
			outInfo.set("errorcode", "-1");
		}
...
//			TOperationLog log = OperationLogHelper.GenerateOperationLog(2, "ɾ���������");
//			this.dao.insert("tOperationLog.insert", log);
		}catch(Exception e){
			outInfo.set("errorcode", "-1");
		}
